...
<?php if (! $__env->hasRenderedOnce('abac047a-2153-4a42-8ca7-787396b81abe')): $__env->markAsRenderedOnce('abac047a-2153-4a42-8ca7-787396b81abe');
$__env->startPush('scripts'); ?>
    ...
    <script type="module">
        window.app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "<?php echo app('translator')->get('superadmin::app.components.modal.confirm.title'); ?>",
                    message = "<?php echo app('translator')->get('superadmin::app.components.modal.confirm.message'); ?>",
                    options = {
                        btnDisagree: "<?php echo app('translator')->get('superadmin::app.components.modal.confirm.disagree-btn'); ?>",
                        btnAgree: "<?php echo app('translator')->get('superadmin::app.components.modal.confirm.agree-btn'); ?>",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
...
<?php $__env->stopPush(); endif; ?><?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\SuperAdmin\src\Providers/../Resources/views/components/modal/confirm.blade.php ENDPATH**/ ?>