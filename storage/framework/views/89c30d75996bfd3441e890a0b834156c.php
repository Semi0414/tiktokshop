...
<?php endif; ?>
    ...
    >
        ...
        <?php if($supportsHtmlCartForm && core()->getConfigData('sales.checkout.shopping_cart.cart_page')): ?>
            <form
                class="cart-add-form"
                method="post"
            ...
            >
                ...
                <?php echo $__env->make('shop::products.view.product-main-inner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </form>
        <?php else: ?>
            <?php echo $__env->make('shop::products.view.product-main-inner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Shop\src/resources/views/products/view.blade.php ENDPATH**/ ?>