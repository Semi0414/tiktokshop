        ...
        <div style="max-width: 640px; margin-left: auto; margin-right: auto;">
            <div style="padding: 30px;">
                ...
                <div style="margin-bottom: 65px;">
                    <a href="<?php echo e(route('shop.tiktok-store.index')); ?>">
                        ...
                        <?php else: ?>
                            <img
                                src="<?php echo e(bagisto_asset('images/logo.svg', 'admin')); ?>"
                                alt="<?php echo e(config('app.name')); ?>"
                ...
                <p style="font-size: 16px;color: #202B3C;line-height: 24px;">
                    <?php echo app('translator')->get('superadmin::app.emails.thanks', [
...
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/SuperAdmin/src/Providers/../Resources/views/emails/layout.blade.php ENDPATH**/ ?>