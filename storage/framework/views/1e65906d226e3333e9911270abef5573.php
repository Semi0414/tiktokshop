...
<?php if (! $__env->hasRenderedOnce('aad2eb11-5b35-44e0-9308-b57155e0a6c5')): $__env->markAsRenderedOnce('aad2eb11-5b35-44e0-9308-b57155e0a6c5'); ?>
    <style>
    ...
    <div class="w-1/2 min-w-0 max-w-full overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-2xl max-sm:w-full dark:border-slate-700 dark:bg-slate-900">
        ...
        <form id="seller-verify-password-form" class="space-y-4 px-5 py-5" action="#" method="post" autocomplete="off">
            ...
            <div class="flex flex-col-reverse gap-2 pt-1 sm:flex-row sm:flex-wrap sm:justify-end">
                ...
                >
                    <?php echo e(__('admin::app.account.verify-password.cancel')); ?>
                ...
                >
                    <?php echo e(__('admin::app.account.verify-password.submit-password')); ?>
...
<?php if (! $__env->hasRenderedOnce('seller-verify-password-gate')): $__env->markAsRenderedOnce('seller-verify-password-gate');
$__env->startPush('scripts'); ?>
    <script>
        (function initSellerPasswordGate() {
            const verifyUrl = <?php echo json_encode(route('admin.account.verify-password'), 15, 512) ?>;
            const messages = {
                required: <?php echo json_encode(__('admin::app.account.verify-password.required'), 15, 512) ?>,
                generic: <?php echo json_encode(__('admin::app.account.verify-password.invalid'), 15, 512) ?>,
            };
...
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Admin\src/resources/views/components/seller/verify-password-modal.blade.php ENDPATH**/ ?>