...
<?php $component->withAttributes(['active' => 'shop_order','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('admin::app.seller-panel.tabs.shop-order')])]); ?>
        ...
        <div class="seller-filter-card mb-4 flex flex-wrap items-center gap-2">
            ...
            <a href="<?php echo e($chipUrl('pending')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'pending' ? $chipActive : $chipInactive); ?>">
                <?php echo app('translator')->get('admin::app.seller-panel.orders.pending'); ?>
            </a>
            <a href="<?php echo e($chipUrl('purchased')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'purchased' ? $chipActive : $chipInactive); ?>">
                <?php echo app('translator')->get('admin::app.seller-panel.orders.purchased'); ?>
            </a>
        </div>
                ...
                <table class="min-w-[720px] w-full divide-y divide-gray-200 dark:divide-gray-800">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-left text-xs font-semibold text-gray-600 dark:text-gray-300"><?php echo app('translator')->get('admin::app.seller.shop-order.col-age-hours'); ?></th>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('4c7d9013-efc2-4ff5-b486-a8054fcb6dba')): $__env->markAsRenderedOnce('4c7d9013-efc2-4ff5-b486-a8054fcb6dba');
...
<?php endif; ?><?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Admin\src/resources/views/sales/orders/index.blade.php ENDPATH**/ ?>