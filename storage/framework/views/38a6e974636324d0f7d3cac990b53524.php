...
<?php if (! $__env->hasRenderedOnce('21c84fd5-c50c-4934-bd8c-3a32856a57fc')): $__env->markAsRenderedOnce('21c84fd5-c50c-4934-bd8c-3a32856a57fc');
    ...
    >
        ...
        >
            <template v-if="isLoading">
                <?php if (isset($component)) { $__componentOriginalaabeb5592fc7d986339ae42af39e2494 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaabeb5592fc7d986339ae42af39e2494 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'superadmin::components.shimmer.datagrid.toolbar.pagination','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('superadmin::shimmer.datagrid.toolbar.pagination'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalaabeb5592fc7d986339ae42af39e2494)): ?>
<?php $attributes = $__attributesOriginalaabeb5592fc7d986339ae42af39e2494; ?>
<?php unset($__attributesOriginalaabeb5592fc7d986339ae42af39e2494); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaabeb5592fc7d986339ae42af39e2494)): ?>
<?php $component = $__componentOriginalaabeb5592fc7d986339ae42af39e2494; ?>
<?php unset($__componentOriginalaabeb5592fc7d986339ae42af39e2494); ?>
<?php endif; ?>
            </template>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'superadmin::components.dropdown.menu.item','data' => ['vFor' => 'perPageOption in available.meta.per_page_options','@click' => 'changePerPageOption(perPageOption)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <p class="whitespace-nowrap text-gray-600 dark:text-gray-300 max-sm:hidden">
                        <?php echo app('translator')->get('superadmin::app.components.datagrid.toolbar.per-page'); ?>
                    </p>

                    <input
                        type="text"
                        :id="'superadmin-datagrid-current-page-' + (available.id ?? 'grid')"
                        :name="'datagrid_current_page_' + (available.id ?? 'grid')"
                    ...
                    <div class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                        <span>
                            <?php echo app('translator')->get('superadmin::app.components.datagrid.toolbar.of'); ?>
                        </span>
    ...
    <script type="module">
        window.app.component('v-datagrid-pagination', {
...
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\SuperAdmin\src\Providers/../Resources/views/components/datagrid/toolbar/pagination.blade.php ENDPATH**/ ?>