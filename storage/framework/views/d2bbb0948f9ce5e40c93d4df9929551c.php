    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const initialOrders = <?php echo json_encode($dashboardOrders, 15, 512) ?>;
                const stats = <?php echo json_encode($dashboardStats, 15, 512) ?>;
                const bulkUrl = <?php echo json_encode($bulkUrl, 15, 512) ?>;
                const approveUrlTemplate = <?php echo json_encode($approveUrlTemplate, 15, 512) ?>;
                const rejectUrlTemplate = <?php echo json_encode($rejectUrlTemplate, 15, 512) ?>;
                const viewUrlTemplate = <?php echo json_encode($viewUrlTemplate, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/SuperAdmin/src/Providers/../Resources/views/sellers/orders/dashboard.blade.php ENDPATH**/ ?>