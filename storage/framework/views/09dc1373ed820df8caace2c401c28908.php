<?php if (isset($component)) { $__componentOriginal27286a31db6c17fb5b3bcc8d8a5af73c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27286a31db6c17fb5b3bcc8d8a5af73c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'superadmin::components.layouts.anonymous','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('superadmin::layouts.anonymous'); ?>
...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('superadmin::app.users.sessions.title'); ?>
     <?php $__env->endSlot(); ?>
            ...
            <div class="sa-wrapper">
                <div class="sa-header">
                    ...
                    <div class="sa-warning">
                        ...
                        <?php echo e(__('Authorized personnel only. All access is monitored.')); ?>

                    </div>
                </div>

                <div class="sa-card">
                    <form method="POST" action="<?php echo e(route('superadmin.session.store')); ?>" id="sa-login-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div id="sa-panel-email" class="sa-panel active" role="tabpanel">
                            <div class="sa-field">
                                <label class="sa-label" for="sa-email"><span class="sa-label-dot"></span><?php echo app('translator')->get('superadmin::app.users.sessions.email'); ?></label>
                                <div class="sa-input-wrap">
                                    ...
                                    <input
                                        class="sa-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> sa-input-error <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="sa-flash" style="margin-top:8px;margin-bottom:0;"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="sa-panel-phone" class="sa-panel" role="tabpanel">
                            <div class="sa-field">
                                ...
                                <p class="sa-hint"><?php echo e(__('Super admin sign-in uses email. Open the Email tab and use your registered admin email.')); ?></p>
                            </div>
                        </div>

                        <div class="sa-field">
                            <label class="sa-label" for="sa-password"><span class="sa-label-dot"></span><?php echo app('translator')->get('superadmin::app.users.sessions.password'); ?></label>
                            <div class="sa-input-wrap">
                                ...
                                <input
                                    class="sa-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> sa-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    placeholder="••••••••••••"
                                />
                                <button class="sa-pw-toggle" type="button" id="sa-pw-toggle" aria-label="<?php echo e(__('Show password')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sa-forgot-row">
                            <a href="<?php echo e(route('superadmin.forget_password.create')); ?>" class="sa-link"><?php echo app('translator')->get('superadmin::app.users.sessions.forget-password-link'); ?></a>
                        </div>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="sa-flash" style="margin-top:8px;"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <button class="sa-btn" type="submit"><?php echo app('translator')->get('superadmin::app.users.sessions.submit-btn'); ?></button>
                    </form>
                </div>
                ...
                <p class="sa-footer" style="margin-top:12px;color:#444;">
                    <?php echo app('translator')->get('superadmin::app.users.sessions.powered-by-description', [
...
<?php endif; ?>
<?php if (isset($__attributesOriginal27286a31db6c17fb5b3bcc8d8a5af73c)): ?>
<?php $attributes = $__attributesOriginal27286a31db6c17fb5b3bcc8d8a5af73c; ?>
<?php unset($__attributesOriginal27286a31db6c17fb5b3bcc8d8a5af73c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal27286a31db6c17fb5b3bcc8d8a5af73c)): ?>
<?php $component = $__componentOriginal27286a31db6c17fb5b3bcc8d8a5af73c; ?>
<?php unset($__componentOriginal27286a31db6c17fb5b3bcc8d8a5af73c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\SuperAdmin\src\Providers/../Resources/views/users/sessions/create.blade.php ENDPATH**/ ?>