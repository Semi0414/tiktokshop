    ...
    <div class="product-body">
        ...
        <div class="product-footer">
            ...
            <button
                ...
                data-product-id="<?php echo e($pid); ?>"
                data-product-type="<?php echo e($product->product_type ?? 'simple'); ?>"
                data-variant-id="<?php echo e($product->default_variant_id ?? ''); ?>"
                data-product-url="<?php echo e($product->product_url); ?>"
                data-can-quick-add="<?php echo e(! empty($product->can_quick_add) ? '1' : '0'); ?>"
            >+ <?php echo e(__('Add')); ?></button>
        </div>
    </div>
</article>
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/Shop/src/resources/views/tik-store/partials/product-card.blade.php ENDPATH**/ ?>