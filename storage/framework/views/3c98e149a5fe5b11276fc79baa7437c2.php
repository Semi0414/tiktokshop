...
<?php endif; ?>
    ...
    <div class="flex justify-between bg-[#F1EADF] px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
        ...
        <p class="text-sm text-zinc-600 max-md:text-center">
            ...
            <?php else: ?>
                <?php echo trans('shop::app.components.layouts.footer.footer-text', [
                    'current_year' => date('Y'),
...
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Shop\src/resources/views/components/layouts/footer/index.blade.php ENDPATH**/ ?>