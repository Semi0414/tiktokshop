...
<?php if (! $__env->hasRenderedOnce('833bd551-334f-42c9-8f34-83fb0bfa862b')): $__env->markAsRenderedOnce('833bd551-334f-42c9-8f34-83fb0bfa862b');
...
<?php if (! $__env->hasRenderedOnce('9ca25c39-95a2-4062-8bc7-6fc6526337a4')): $__env->markAsRenderedOnce('9ca25c39-95a2-4062-8bc7-6fc6526337a4');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'after:content-[\' \'] relative bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'cardImageUrl',':srcset' => 'cardImageSrcset',':sizes' => 'cardImageSizesAttr',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'after:content-[\' \'] relative bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'cardImageUrl',':srcset' => 'cardImageSrcset',':sizes' => 'cardImageSizesAttr',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name']); ?>
...
<?php endif; ?>
            ...
            <div class="-mt-9 grid min-h-[200px] max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:min-h-[170px] max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px]">

                <?php echo view_render_event('bagisto.shop.components.products.card.name.before'); ?>


                <p class="product-card-title text-base font-medium max-md:mb-1.5 max-md:max-w-56 max-md:leading-6 max-sm:max-w-[192px] max-sm:text-sm max-sm:leading-4">
                    {{ product.name }}
                </p>
                ...
                <div class="action-items mt-auto flex items-center justify-between opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
        ...
        >
            <div class="group relative max-h-[258px] max-w-[250px] overflow-hidden">
                ...
                <a :href="`<?php echo e(route('shop.product_or_category.index', '')); ?>/${product.url_key}`">
                    <?php if (isset($component)) { $__componentOriginal3657c70d06ebc8c078f4ecac2ea1a848 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3657c70d06ebc8c078f4ecac2ea1a848 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'after:content-[\' \'] relative min-w-[250px] bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'cardImageUrl',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('shop::media.images.lazy'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'after:content-[\' \'] relative min-w-[250px] bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'cardImageUrl',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3657c70d06ebc8c078f4ecac2ea1a848)): ?>
<?php $attributes = $__attributesOriginal3657c70d06ebc8c078f4ecac2ea1a848; ?>
...
<?php endif; ?>
    ...
    <script type="module">
        app.component('v-product-card', {
            ...
            computed: {
                cardImageUrl() {
                    const size = this.imageSize || 'medium';

                    const key = `${size}_image_url`;

                    return this.product?.base_image?.[key] || this.product?.base_image?.medium_image_url;
                },
                ...
                cardImageSrcset() {
                    ...
                    if (this.imageSize === 'small') {
                        return `${this.product.base_image.small_image_url} 150w`;
                    }

                    return `${this.product.base_image.small_image_url} 150w, ${this.product.base_image.medium_image_url} 300w`;
                },

                cardImageSizesAttr() {
                    if (this.imageSize === 'small') {
                        return '(max-width: 768px) 120px, 150px';
                    }

                    return '(max-width: 768px) 150px, (max-width: 1200px) 300px, 600px';
                },
            },
            ...
            methods: {
                addToWishlist() {
                    if (this.isCustomer) {
                        this.$axios.post(`<?php echo e(route('shop.api.customers.account.wishlist.store')); ?>`, {
                            ...
                            window.location.href = "<?php echo e(route('shop.customer.session.index')); ?>?redirect_url=" + encodeURIComponent(window.location.href);
                        }
                },
                ...
                addToCart() {
                    if (! this.isCustomer) {
                        ...
                        window.location.href = "<?php echo e(route('shop.customer.session.index')); ?>?redirect_url=" + redirectUrl;
                    ...
                    if (
                        ...
                        && this.product.default_variant_id
                    ) {
                        payload.selected_configurable_option = this.product.default_variant_id;
                    }
...
<?php $__env->stopPush(); endif; ?>
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Shop\src/resources/views/components/products/card.blade.php ENDPATH**/ ?>