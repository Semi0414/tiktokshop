<?php $__env->startComponent('shop::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo trans('shop::app.emails.orders.canceled.greeting', [
...
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/Shop/src/resources/views/emails/orders/canceled.blade.php ENDPATH**/ ?>