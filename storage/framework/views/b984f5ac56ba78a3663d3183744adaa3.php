<?php $__env->startComponent('superadmin::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            <?php echo app('translator')->get('superadmin::app.emails.orders.created.title'); ?>
        </span> <br>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo app('translator')->get('superadmin::app.emails.dear', ['admin_name' => core()->getAdminEmailDetails()['name']]); ?>,👋
        </p>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo trans('superadmin::app.emails.orders.created.greeting', [
                'order_id' => '<a href="' . route('superadmin.sales.orders.view', $order->id) . '" style="color: #2969FF;">#' . $order->increment_id . '</a>',
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        <?php echo app('translator')->get('superadmin::app.emails.orders.created.summary'); ?>
    </div>
    ...
    <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
        <?php if($order->shipping_address): ?>
            <div style="line-height: 25px;">
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    <?php echo app('translator')->get('superadmin::app.emails.orders.shipping-address'); ?>
                </div>
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    <?php echo app('translator')->get('superadmin::app.emails.orders.contact'); ?> : <?php echo e($order->billing_address->phone); ?>

                </div>

                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    <?php echo app('translator')->get('superadmin::app.emails.orders.shipping'); ?>
                </div>
        ...
        <?php if($order->billing_address): ?>
            <div style="line-height: 25px;">
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    <?php echo app('translator')->get('superadmin::app.emails.orders.billing-address'); ?>
                </div>
                ...
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    <?php echo app('translator')->get('superadmin::app.emails.orders.payment'); ?>
                </div>
                ...
                <tr style="color: #121A26;border-top: 1px solid #CBD5E1;border-bottom: 1px solid #CBD5E1;">
                    <?php $__currentLoopData = ['sku', 'name', 'price', 'qty']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <th style="text-align: left;padding: 15px">
                            <?php echo app('translator')->get('superadmin::app.emails.orders.' . $item); ?>
                        </th>
                        ...
                        <td style="display: flex;flex-direction: column;text-align: left;padding: 15px">
                            ...
                            <?php elseif(core()->getConfigData('sales.taxes.sales.display_prices') == 'both'): ?>
                                ...
                                <span style="font-size: 12px; white-space: nowrap">
                                    <?php echo app('translator')->get('superadmin::app.emails.orders.excl-tax'); ?>
    ...
    <div style="display: grid;justify-content: end;font-size: 16px;color: #384860;line-height: 30px;padding-top: 20px;padding-bottom: 20px;">
        <?php if(core()->getConfigData('sales.taxes.sales.display_subtotal') == 'including_tax'): ?>
            <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    <?php echo app('translator')->get('superadmin::app.emails.orders.subtotal'); ?>
                </span>
        ...
        <?php elseif(core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both'): ?>
            <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    <?php echo app('translator')->get('superadmin::app.emails.orders.subtotal-excl-tax'); ?>
                </span>
            ...
            <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    <?php echo app('translator')->get('superadmin::app.emails.orders.subtotal-incl-tax'); ?>
                </span>
        ...
        <?php if($order->shipping_address): ?>
            <?php if(core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax'): ?>
                <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <span>
                        <?php echo app('translator')->get('superadmin::app.emails.orders.shipping-handling'); ?>
                    </span>
            ...
            <?php elseif(core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both'): ?>
                <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <span>
                        <?php echo app('translator')->get('superadmin::app.emails.orders.shipping-handling-excl-tax'); ?>
                    </span>
                ...
                <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <span>
                        <?php echo app('translator')->get('superadmin::app.emails.orders.shipping-handling-incl-tax'); ?>
                    </span>
        ...
        <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));">
            <span>
                <?php echo app('translator')->get('superadmin::app.emails.orders.tax'); ?>
            </span>
        ...
        <?php if($order->discount_amount > 0): ?>
            <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    <?php echo app('translator')->get('superadmin::app.emails.orders.discount'); ?>
                </span>
        ...
        <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));font-weight: bold">
            <span>
                <?php echo app('translator')->get('superadmin::app.emails.orders.grand-total'); ?>
            </span>
...
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/SuperAdmin/src/Providers/../Resources/views/emails/orders/created.blade.php ENDPATH**/ ?>