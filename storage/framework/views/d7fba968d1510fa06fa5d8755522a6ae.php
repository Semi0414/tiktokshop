...
<?php if (! $__env->hasRenderedOnce('cc64c2cb-5d59-4079-b942-db22a8ce4b54')): $__env->markAsRenderedOnce('cc64c2cb-5d59-4079-b942-db22a8ce4b54');
...
<?php $component->withAttributes(['v-slot' => '{ meta, errors, handleSubmit }','as' => 'div']); ?>
                <?php echo view_render_event('bagisto.shop.checkout.login.before'); ?>


                <!-- Login form -->
                <form @submit="handleSubmit($event, login)">
                    <?php echo view_render_event('bagisto.shop.checkout.login.form_controls.before'); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'primary-button max-w-none flex-auto rounded-sm px-11 py-3 max-md:rounded-lg max-md:py-1.5','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('shop::app.checkout.login.title')),':loading' => 'isStoring',':disabled' => 'isStoring']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php echo view_render_event('bagisto.shop.checkout.login.form_controls.after'); ?>
...
<?php endif; ?>
            ...
            <?php echo view_render_event('bagisto.shop.checkout.login.after'); ?>
...
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/Shop/src/resources/views/checkout/login.blade.php ENDPATH**/ ?>