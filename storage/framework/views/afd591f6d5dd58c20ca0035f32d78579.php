...
<?php if (! $__env->hasRenderedOnce('a0ac8692-12d6-44ff-8662-9cf539c5a293')): $__env->markAsRenderedOnce('a0ac8692-12d6-44ff-8662-9cf539c5a293');
                ...
                >
                    ...
                    >
                        <a
                            ...
                            :aria-label="category.display_name || category.name"
                        >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => [':src' => 'category.logo?.small_image_url || category.logo_url || fallback',':srcset' => '`
                                    ${(category.logo?.small_image_url || category.logo_url || fallback)} 60w,
                                    ${(category.logo?.medium_image_url || category.logo_url || fallback)} 110w,
                                    ${(category.logo?.large_image_url || category.logo_url || fallback)} 300w
                                `','sizes' => '(max-width: 640px) 60px, 110px','width' => '110','height' => '110','class' => 'w-full rounded-full max-sm:h-[60px] max-sm:w-[60px]',':alt' => 'category.display_name || category.name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([':src' => 'category.logo?.small_image_url || category.logo_url || fallback',':srcset' => '`
                                    ${(category.logo?.small_image_url || category.logo_url || fallback)} 60w,
                                    ${(category.logo?.medium_image_url || category.logo_url || fallback)} 110w,
                                    ${(category.logo?.large_image_url || category.logo_url || fallback)} 300w
                                `','sizes' => '(max-width: 640px) 60px, 110px','width' => '110','height' => '110','class' => 'w-full rounded-full max-sm:h-[60px] max-sm:w-[60px]',':alt' => 'category.display_name || category.name']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        >
                            <p
                                ...
                                v-text="category.display_name || category.name"
                            >
                            </p>
                        </a>
                    </div>
        ...
        app.component('v-categories-carousel', {
            ...
            data() {
                return {
                    ...
                    fallback: "<?php echo e(bagisto_asset('images/small-product-placeholder.webp')); ?>"
                };
            },
...
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Shop\src/resources/views/components/categories/carousel.blade.php ENDPATH**/ ?>