    ...
    <header class="w-full min-w-0">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex min-w-0 flex-wrap items-center gap-2.5">
                ...
                <span class="label-<?php echo e($order->status); ?> shrink-0 text-sm">
    ...
    <div class="mt-5 flex flex-col gap-4">
        <div class="flex flex-wrap items-center gap-1.5">
            ...
            <?php if($order->status === 'pending'): ?>
                <form
                    method="POST"
                    ref="approveOrderForm"
                    action="<?php echo e(route('admin.sales.orders.approve', $order->id)); ?>"
                >
                    <?php echo csrf_field(); ?>
                </form>
                ...
                <button
                    ...
                    @click="$emitter.emit('open-confirm-modal', {
                        message: '<?php echo app('translator')->get('admin::app.sales.orders.view.approve-order-msg'); ?>',
                        agree: () => {
                ...
                >
                    ...
                    <span><?php echo app('translator')->get('admin::app.sales.orders.view.approve-order'); ?></span>
                </button>
            <?php endif; ?>
                ...
                <div class="box-shadow overflow-hidden rounded bg-white dark:bg-gray-900">
                    <div class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 px-4 py-3 dark:border-gray-800">
                        <h2 class="m-0 text-base font-semibold text-gray-800 dark:text-white">
                            <?php echo app('translator')->get('admin::app.sales.orders.view.items-with-count', ['count' => count($order->items)]); ?>
                        </h2>
...
<?php endif; ?>
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/Admin/src/resources/views/sales/orders/view.blade.php ENDPATH**/ ?>