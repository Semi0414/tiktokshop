...
<?php endif; ?>
            ...
            <?php if(! $supportsHtmlCartForm): ?>
                <?php if($isProductCustomizable ?? false): ?>
                    <p role="alert" class="mt-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
                        <?php echo e(__('This product has customization options. Please finish your purchase using the storefront tools that support them.')); ?>

                    </p>
                <?php else: ?>
                    <p role="alert" class="mt-6 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-800">
                        <?php echo e(__('This product type cannot be ordered from this simplified product page.')); ?>
            ...
            <?php if($cartFormOk && $supportsHtmlCartForm && $product->isSaleable()): ?>
                <div class="mt-8 flex max-w-[470px] flex-wrap items-center gap-4 max-sm:mt-4">
                    ...
                    <button
                        ...
                        <?php if(! $product->isSaleable()): echo 'disabled'; endif; ?>
                    >
            ...
            <?php elseif($cartFormOk && $supportsHtmlCartForm && ! $product->isSaleable()): ?>
                <p class="mt-8 text-base font-medium text-red-600">
                    <?php echo e(__('This product cannot be ordered right now.')); ?>
...
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Shop\src/resources/views/products/view/product-main-inner.blade.php ENDPATH**/ ?>