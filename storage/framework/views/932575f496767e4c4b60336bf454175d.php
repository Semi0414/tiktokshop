...
<v-reporting-sales-total-refunds>
    <?php if (isset($component)) { $__componentOriginale0ff60115f9246dcb7cbad25db7ff40b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale0ff60115f9246dcb7cbad25db7ff40b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'superadmin::components.shimmer.reporting.sales.total-refunds','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('superadmin::shimmer.reporting.sales.total-refunds'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginale0ff60115f9246dcb7cbad25db7ff40b)): ?>
<?php $attributes = $__attributesOriginale0ff60115f9246dcb7cbad25db7ff40b; ?>
<?php unset($__attributesOriginale0ff60115f9246dcb7cbad25db7ff40b); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale0ff60115f9246dcb7cbad25db7ff40b)): ?>
<?php $component = $__componentOriginale0ff60115f9246dcb7cbad25db7ff40b; ?>
<?php unset($__componentOriginale0ff60115f9246dcb7cbad25db7ff40b); ?>
<?php endif; ?>
</v-reporting-sales-total-refunds>

<?php if (! $__env->hasRenderedOnce('c2c0927e-ea6d-425d-ab8a-06a26eb35f76')): $__env->markAsRenderedOnce('c2c0927e-ea6d-425d-ab8a-06a26eb35f76');
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        <?php echo app('translator')->get('superadmin::app.reporting.sales.index.refunds'); ?>
                    </p>

                    <a
                        href="<?php echo e(route('superadmin.reporting.sales.view', ['type' => 'refunds'])); ?>"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        <?php echo app('translator')->get('superadmin::app.reporting.sales.index.refunds-over-time'); ?>
                    </p>
...
<?php endif; ?>
    ...
    <script type="module">
        window.app.component('v-reporting-sales-total-refunds', {
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/SuperAdmin/src/Providers/../Resources/views/reporting/sales/total-refunds.blade.php ENDPATH**/ ?>