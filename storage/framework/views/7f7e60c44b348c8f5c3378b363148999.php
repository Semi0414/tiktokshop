...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('admin::app.seller-panel.tabs.store-products'); ?>
     <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.seller.panel','data' => ['active' => 'store_products','breadcrumb' => [__('admin::app.components.layouts.sidebar.product-management'), __('admin::app.seller-panel.tabs.store-products')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'store_products','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('admin::app.components.layouts.sidebar.product-management'), __('admin::app.seller-panel.tabs.store-products')])]); ?>
        <div class="mb-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            <p class="text-sm text-gray-600 dark:text-gray-300">
                <?php echo app('translator')->get('admin::app.seller-panel.store-products.total-in-store', ['count' => $storeProductsTotalCount ?? 0]); ?>
            </p>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                <?php echo app('translator')->get('admin::app.seller-panel.product-warehouse.level', ['level' => \Webkul\User\Support\SellerCommissionPercentRules::normalizeLevel($seller->seller_level ?? null)]); ?>
            </p>
        </div>

        <form
            method="get"
            action="<?php echo e(route('admin.seller.store-products.index')); ?>"
        ...
        >
            <div class="grid gap-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                <div>
                    ...
                    <input
                        ...
                        value="<?php echo e(request('seller_product_name')); ?>"
                ...
                <div>
                    ...
                    <input
                        ...
                        value="<?php echo e(request('seller_product_id')); ?>"
                        inputmode="numeric"
                        class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                    />
                </div>
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.filters.category'); ?></label>
                    <select name="seller_product_category" class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                        <option value=""><?php echo app('translator')->get('admin::app.seller-panel.filters.all'); ?></option>
                        <?php $__currentLoopData = $categoryFilterOptions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->category_id); ?>" <?php if((string) request('seller_product_category', '') === (string) $cat->category_id): echo 'selected'; endif; ?>>
                                <?php echo e($cat->name); ?>
                ...
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.filters.product-status'); ?></label>
                    <select name="seller_product_status" class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                        <option value="" <?php if(request('seller_product_status', '') === ''): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.seller-panel.filters.all'); ?></option>
                        <option value="1" <?php if(request('seller_product_status') === '1'): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.catalog.products.index.datagrid.active'); ?></option>
                        <option value="0" <?php if(request('seller_product_status') === '0'): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.catalog.products.index.datagrid.disable'); ?></option>
                    </select>
                </div>
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.store-products.recommended-filter'); ?></label>
                    <select name="seller_product_recommended" class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                        <option value="" <?php if(request('seller_product_recommended', '') === ''): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.seller-panel.filters.all'); ?></option>
                        <option value="1" <?php if(request('seller_product_recommended') === '1'): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.seller-panel.store-products.recommended-yes'); ?></option>
                        <option value="0" <?php if(request('seller_product_recommended') === '0'): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.seller-panel.store-products.recommended-no'); ?></option>
                    </select>
                </div>
            </div>
            <div class="mt-3 flex gap-2">
                ...
                <a href="<?php echo e(route('admin.seller.store-products.index')); ?>" class="seller-btn-secondary"><?php echo app('translator')->get('admin::app.seller-panel.filters.reset'); ?></a>
            </div>
        </form>
            ...
            <div class="w-[50%] max-w-none rounded-lg border border-gray-200 bg-white p-5 shadow-xl max-md:w-full dark:border-gray-700 dark:bg-gray-900">
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-sm font-semibold text-gray-800 dark:text-white">
                        <?php echo app('translator')->get('admin::app.seller-panel.store-products.edit-modal-title'); ?>
                    </p>
                ...
                <div class="mb-4 flex items-center gap-2">
                    ...
                    <label for="seller-store-native-recommended" class="text-sm text-gray-800 dark:text-gray-200">
                        <?php echo app('translator')->get('admin::app.seller-panel.store-products.recommended'); ?>
                    </label>
                </div>
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" id="seller-store-native-cancel" class="seller-btn-secondary text-xs"><?php echo app('translator')->get('admin::app.acl.cancel'); ?></button>
                    <button type="button" id="seller-store-native-save" class="seller-btn-primary text-xs"><?php echo app('translator')->get('admin::app.account.edit.save-btn'); ?></button>
                </div>
            </div>
        </div>
        ...
        >
            <div class="w-1/2 min-w-0 max-w-full overflow-hidden rounded-2xl border border-amber-200/90 bg-white shadow-2xl max-sm:w-full dark:border-amber-900/50 dark:bg-slate-900">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h2 id="seller-store-remove-blocked-title" class="text-lg font-semibold text-white">
                                <?php echo app('translator')->get('admin::app.seller-panel.store-products.remove-not-allowed-title'); ?>
                            </h2>
                            <p class="mt-1 text-sm text-amber-50">
                                <?php echo app('translator')->get('admin::app.seller-panel.store-products.remove-not-allowed-description', [
                ...
                <div class="flex justify-end border-t border-gray-100 px-5 py-4 dark:border-gray-800">
                    ...
                    >
                        <?php echo app('translator')->get('admin::app.seller-panel.store-products.remove-not-allowed-dismiss'); ?>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div id="seller-store-product-grid">
            ...
            <div class="mb-3 flex flex-wrap items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800/50">
                <button
                    ...
                    data-bulk-update-url="<?php echo e(route('admin.seller.store-products.bulk-update')); ?>"
                    data-commission-readonly="<?php echo e(!empty($commissionRule['readonly']) ? '1' : '0'); ?>"
                    data-commission-min="<?php echo e((float) ($commissionRule['min'] ?? 0)); ?>"
                    data-commission-max="<?php echo e((float) ($commissionRule['max'] ?? 100)); ?>"
                    data-commission-default="<?php echo e((float) ($commissionRule['default'] ?? 15)); ?>"
                    onclick="
                        (function (btn) {
                ...
                <form id="store-products-bulk-remove-form" method="post" action="<?php echo e(route('admin.seller.store-products.mass-destroy')); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div class="overflow-x-auto rounded-xl border border-gray-200 bg-white p-3 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        <?php $__empty_1 = true; $__currentLoopData = $storeRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-3 py-3">
                                    <input
                                        type="checkbox"
                                        class="store-products-row-checkbox h-4 w-4 rounded border-gray-300"
                                        value="<?php echo e((int) ($row->ssp_id ?? 0)); ?>"
                                        data-commission="<?php echo e(number_format((float) ($row->commission_percent ?? 0), 2, '.', '')); ?>"
                                        data-recommended="<?php echo e((int) ($row->is_recommended ?? 0)); ?>"
                                        data-status="<?php echo e((int) ($row->status ?? 0) === 1 ? '1' : '0'); ?>"
                                    />
                                </td>
                                ...
                                <td class="px-3 py-3 text-right text-sm font-semibold text-blue-700 dark:text-blue-400">
                                    <?php echo e(isset($row->price) ? core()->formatPrice((float) $row->price) : '—'); ?>

                                </td>
                                <td class="px-3 py-3 text-right text-sm font-semibold text-orange-700 dark:text-orange-300">
                                    <?php echo e(isset($row->commission_percent) ? number_format((float) $row->commission_percent, 2) . '%' : '—'); ?>

                                </td>
                                <td class="px-3 py-3 text-sm">
                                    <?php if((int) ($row->is_recommended ?? 0) === 1): ?>
                                ...
                                <td class="px-3 py-3 text-sm">
                                    <div class="flex items-center gap-2">
                                        <button
                                            ...
                                            data-modal-url="<?php echo e(route('admin.seller.store-products.modal-data', ['sellerStoreProduct' => (int) ($row->ssp_id ?? 0)])); ?>"
                                            data-product-name="<?php echo e($row->name ?? ''); ?>"
                                            data-product-sku="<?php echo e($row->sku ?? ''); ?>"
                                            data-commission="<?php echo e(number_format((float) ($row->commission_percent ?? 0), 2, '.', '')); ?>"
                                            data-recommended="<?php echo e((int) ($row->is_recommended ?? 0)); ?>"
                                            data-status="<?php echo e((int) ($row->status ?? 0) === 1 ? '1' : '0'); ?>"
                                            onclick="
                                        ...
                                        <form method="post" action="<?php echo e(route('admin.seller.store-products.destroy', ['sellerStoreProduct' => (int) ($row->ssp_id ?? 0)])); ?>" onsubmit="return window.handleStoreProductRemoveSubmit && window.handleStoreProductRemoveSubmit(event);">
                                            <?php echo csrf_field(); ?>
                ...
                <div class="mt-3 flex items-center justify-between gap-3 text-xs text-gray-600 dark:text-gray-300">
                    <span>
                        Showing <?php echo e($storeMeta['from'] ?? 0); ?> to <?php echo e($storeMeta['to'] ?? 0); ?> of <?php echo e($storeMeta['total'] ?? 0); ?>

                    </span>
                    <div>
                        <?php echo e(($debugPaginator ?? null)?->links()); ?>
...
<?php if (! $__env->hasRenderedOnce('c95d9525-dfed-41c3-a983-aa2e3fecad14')): $__env->markAsRenderedOnce('c95d9525-dfed-41c3-a983-aa2e3fecad14');
$__env->startPush('scripts'); ?>
    ...
    <script>
        (function initStoreProductsLikeWarehouse() {
            const config = <?php echo json_encode($storeProductsFrontendConfig, 15, 512) ?>;
...
<?php /**PATH C:\Users\Woosols\Downloads\tiktokshop-main\packages\Webkul\Admin\src/resources/views/seller/store-products/index.blade.php ENDPATH**/ ?>