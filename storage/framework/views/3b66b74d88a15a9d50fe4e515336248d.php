...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('superadmin::app.marketing.communications.templates.index.title'); ?>
     <?php $__env->endSlot(); ?>
    ...
    <div class="flex justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            <?php if(bouncer()->hasPermission('marketing.communications.email_templates.create')): ?>
                <a href="<?php echo e(route('superadmin.marketing.communications.email_templates.create')); ?>">
                    <div class="primary-button">
                        <?php echo app('translator')->get('superadmin::app.marketing.communications.templates.index.create-btn'); ?>
                    </div>
                </a>
            <?php endif; ?>
        </div>
    ...
    <?php echo view_render_event('bagisto.admin.marketing.communications.templates.list.before'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'superadmin::components.datagrid.ssr','data' => ['datagridPayload' => $datagridPayload,'src' => route('superadmin.marketing.communications.email_templates.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['datagrid-payload' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($datagridPayload),'src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('superadmin.marketing.communications.email_templates.index'))]); ?>
...
<?php endif; ?>
    ...
    <?php echo view_render_event('bagisto.admin.marketing.communications.templates.list.after'); ?>
...
<?php endif; ?>
<?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/SuperAdmin/src/Providers/../Resources/views/marketing/communications/templates/index.blade.php ENDPATH**/ ?>