<div class="flex flex-wrap gap-1.5">
    ...
    <?php if($restCount >= 1): ?>
        <a href="<?php echo e(route('superadmin.sales.orders.view', $order->id)); ?>">
            <div class="flex h-[65px] w-[65px] items-center rounded bg-gray-50 dark:bg-gray-800">
                <p class="px-1.5 py-1.5 text-center text-xs font-bold text-gray-600 dark:text-gray-300">
                    <?php echo app('translator')->get('superadmin::app.sales.orders.index.datagrid.product-count', ['count' => $restCount]); ?>
                </p>
            </div>
        </a>
    <?php endif; ?>
</div><?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/SuperAdmin/src/Providers/../Resources/views/sales/orders/items.blade.php ENDPATH**/ ?>