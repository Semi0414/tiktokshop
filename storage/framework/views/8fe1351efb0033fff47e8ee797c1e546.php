...
<?php $component->withAttributes([]); ?>
    <!-- Page Title -->
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('admin::app.seller-panel.tabs.shop-order'); ?>
     <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.seller.panel','data' => ['active' => 'shop_order','breadcrumb' => [__('admin::app.seller-panel.tabs.shop-order')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => 'shop_order','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('admin::app.seller-panel.tabs.shop-order')])]); ?>
        <?php
        ...
        <div class="seller-filter-card mb-4 flex flex-wrap items-center gap-2">
            <a href="<?php echo e($chipUrl('all')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'all' ? $chipActive : $chipInactive); ?>">
                <?php echo app('translator')->get('admin::app.seller-panel.orders.all'); ?>
            </a>
            <a href="<?php echo e($chipUrl('pending')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'pending' ? $chipActive : $chipInactive); ?>">
                <?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.pending'); ?>
            </a>
            <a href="<?php echo e($chipUrl('processing')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'processing' ? $chipActive : $chipInactive); ?>">
                <?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.processing'); ?>
            </a>
            <a href="<?php echo e($chipUrl('completed')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'completed' ? $chipActive : $chipInactive); ?>">
                <?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.completed'); ?>
            </a>
            <a href="<?php echo e($chipUrl('rejected')); ?>" class="<?php echo e($chipClass); ?> <?php echo e($scope === 'rejected' ? $chipActive : $chipInactive); ?>">
                Rejected
            </a>
        </div>

        
        <form method="get" action="<?php echo e(route('admin.sales.orders.index')); ?>" class="seller-filter-card mb-4" id="seller-order-filters">
            <input type="hidden" name="seller_order_scope" value="<?php echo e($scope); ?>" />

            <div class="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.filters.order-no'); ?></label>
                    <input
                        type="text"
                        name="seller_increment_id"
                        value="<?php echo e(request('seller_increment_id')); ?>"
                        class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                    />
                </div>
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.filters.payment-status'); ?></label>
                    <select name="seller_payment_method" class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                        <?php $__currentLoopData = $paymentMethodOptions ?? [['value' => '', 'label' => __('admin::app.seller-panel.filters.all')]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($opt['value']); ?>" <?php if(request('seller_payment_method', '') === (string) ($opt['value'] ?? '')): echo 'selected'; endif; ?>>
                ...
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.filters.logistics-status'); ?></label>
                    <select name="seller_logistics_status" class="w-full rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                        <option value="all" <?php if(! request('seller_logistics_status') || request('seller_logistics_status') === 'all'): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.seller-panel.filters.all'); ?></option>
                        <option value="<?php echo e(\Webkul\Sales\Models\Order::STATUS_PENDING); ?>" <?php if(request('seller_logistics_status') === \Webkul\Sales\Models\Order::STATUS_PENDING): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.pending'); ?></option>
                        <option value="<?php echo e(\Webkul\Sales\Models\Order::STATUS_PENDING_PAYMENT); ?>" <?php if(request('seller_logistics_status') === \Webkul\Sales\Models\Order::STATUS_PENDING_PAYMENT): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.pending-payment'); ?></option>
                        <option value="<?php echo e(\Webkul\Sales\Models\Order::STATUS_PROCESSING); ?>" <?php if(request('seller_logistics_status') === \Webkul\Sales\Models\Order::STATUS_PROCESSING): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.processing'); ?></option>
                        <option value="<?php echo e(\Webkul\Sales\Models\Order::STATUS_COMPLETED); ?>" <?php if(request('seller_logistics_status') === \Webkul\Sales\Models\Order::STATUS_COMPLETED): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.completed'); ?></option>
                        <option value="<?php echo e(\Webkul\Sales\Models\Order::STATUS_CLOSED); ?>" <?php if(request('seller_logistics_status') === \Webkul\Sales\Models\Order::STATUS_CLOSED): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.closed'); ?></option>
                        <option value="<?php echo e(\Webkul\Sales\Models\Order::STATUS_CANCELED); ?>" <?php if(request('seller_logistics_status') === \Webkul\Sales\Models\Order::STATUS_CANCELED): echo 'selected'; endif; ?>><?php echo app('translator')->get('admin::app.sales.orders.index.datagrid.canceled'); ?></option>
                    </select>
                </div>
                <div>
                    <label class="mb-1 block text-xs font-medium text-gray-500"><?php echo app('translator')->get('admin::app.seller-panel.filters.order-time'); ?></label>
                    <div class="flex min-w-0 flex-col gap-2 sm:flex-row">
                        <input type="date" name="seller_date_from" value="<?php echo e(request('seller_date_from')); ?>" class="min-w-0 w-full rounded-md border border-gray-200 px-2 py-2 text-xs dark:border-gray-700 dark:bg-gray-900 dark:text-white" />
                        <input type="date" name="seller_date_to" value="<?php echo e(request('seller_date_to')); ?>" class="min-w-0 w-full rounded-md border border-gray-200 px-2 py-2 text-xs dark:border-gray-700 dark:bg-gray-900 dark:text-white" />
                    </div>
                </div>
            </div>
            <div class="mt-3 flex gap-2">
                ...
                <a href="<?php echo e(route('admin.sales.orders.index')); ?>" class="seller-btn-secondary"><?php echo app('translator')->get('admin::app.seller-panel.filters.reset'); ?></a>
            </div>
        </form>
        <!-- <div class="mb-3 flex justify-end max-sm:justify-stretch">
            ...
            >
                <?php echo app('translator')->get('admin::app.seller-panel.orders.bulk-purchase'); ?>
            </button>
        </div>  -->
                ...
                <table class="min-w-[720px] w-full divide-y divide-gray-200 dark:divide-gray-800">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            ...
                            <th data-sort-column="created_at" class="seller-sortable px-3 py-2 text-left text-xs font-semibold text-gray-600 dark:text-gray-300"><?php echo app('translator')->get('admin::app.seller.shop-order.col-age-hours'); ?></th>
    ...
    >
        <div class="ssopw-card">
            <h2 id="seller-shop-order-pw-title" class="ssopw-title">
                <?php echo app('translator')->get('admin::app.account.verify-password.title'); ?>
            </h2>
            <p class="ssopw-desc">
                <?php echo app('translator')->get('admin::app.account.verify-password.description'); ?>
            </p>
            <label for="seller-shop-order-pw-input" class="ssopw-label">
                <?php echo app('translator')->get('admin::app.account.verify-password.placeholder'); ?>
            </label>
            <input
                type="password"
            ...
            <div class="ssopw-actions">
                ...
                >
                    <?php echo app('translator')->get('admin::app.account.verify-password.cancel'); ?>
                </button>
                <button
                    type="button"
                ...
                >
                    <?php echo app('translator')->get('admin::app.account.verify-password.submit-password'); ?>
                </button>
            </div>
        </div>
    </div>

    <?php if (! $__env->hasRenderedOnce('4ccd5e71-363f-4b9d-bf36-77df603c7511')): $__env->markAsRenderedOnce('4ccd5e71-363f-4b9d-bf36-77df603c7511');
$__env->startPush('scripts'); ?>
        <script>
            (function registerSellerShopOrderPasswordForce() {
                const sellerMakeOrderUrlTemplate = <?php echo json_encode(route('admin.seller.shop-order.make-order', ['order' => 0]), 512) ?>;
                const sellerBulkMakeOrderUrl = <?php echo json_encode(route('admin.seller.shop-order.bulk-make-order'), 15, 512) ?>;
                ...
                async function onPwConfirm() {
                    ...
                    if (!pwd) {
                        showPwError(<?php echo json_encode(__('admin::app.account.verify-password.required'), 15, 512) ?>);
                        return;
                    }
                    state.busy = true;
                    if (okBtn) {
                ...
                window.sellerBulkPurchaseFromHeader = function () {
                    ...
                    const indices = typeof window.getSellerSelectedOrderIds === 'function'
                        ...
                        : [];
                    if (!indices.length) {
                        sellerFlash('warning', <?php echo json_encode(__('admin::app.seller-panel.orders.bulk-purchase-no-selection'), 15, 512) ?>);
                        return;
                    }
            ...
            (function attachSellerOrdersTable() {
                ...
                async function loadTableData() {
                    ...
                    try {
                        ...
                        const actionLabels = {
                            view: <?php echo json_encode(__('admin::app.acl.view'), 15, 512) ?>,
                            make: <?php echo json_encode(__('admin::app.seller.shop-order.make-order'), 15, 512) ?>,
                            makeDisabled: <?php echo json_encode(__('admin::app.seller.shop-order.make-order-disabled-hint'), 15, 512) ?>,
                        };
...
<?php endif; ?><?php /**PATH /Users/hhtraders/tiktokshop/packages/Webkul/Admin/src/resources/views/sales/orders/index.blade.php ENDPATH**/ ?>