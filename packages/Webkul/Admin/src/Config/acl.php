...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Wallet / Seller Pages (Seller Dashboard)
    |--------------------------------------------------------------------------
    */
    [
        'key' => 'wallet',
        'name' => 'admin::app.acl.wallet',
    ...
    [
        ...
        'name' => 'admin::app.acl.financial-statement',
    ...
    [
        'key' => 'fund_record',
        'name' => 'admin::app.acl.fund-record',
    ...
    [
        ...
        'name' => 'admin::app.acl.product-management',
    ...
    [
        'key' => 'product_management.catalog_products',
    ...
    [
        ...
        'name' => 'admin::app.acl.purchase-history',
    ...
    [
        ...
        'name' => 'admin::app.acl.store-upgrade',
    ...
    [
        'key' => 'seller_level',
        'name' => 'admin::app.acl.seller-level',
    ...
    [
        'key' => 'marketing-tools',
        'name' => 'admin::app.acl.marketing-tools',
        'route' => 'admin.store-upgrade.index',
        'sort' => 5,
    ],
