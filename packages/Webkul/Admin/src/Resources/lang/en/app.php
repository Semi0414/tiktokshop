...
return [
    ...
    'account' => [
        ...
        'edit' => [
            ...
            'store-registration-title' => 'Store registration',
            'shop-logo' => 'Shop logo',
            'shop-name' => 'Shop name',
            ...
            'document-front' => 'ID front',
            'document-back' => 'ID back',
            'document-selfie' => 'ID selfie',
        ],
    ],
    ...
    'settings' => [
        ...
        'users' => [
            ...
            'approval-pending-warning' => 'Your seller application is still pending approval. You cannot log in until an administrator approves it.',
            'approval-suspended-warning' => 'Your seller account has been suspended. Please contact support.',
            'approval-rejected-warning' => 'Your seller application was not approved. You cannot access the seller panel.',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'product-warehouse-browse' => 'Browse warehouse',
    ...
    'acl' => [
        'addresses' => 'Addresses',
        'all-catalog-products' => 'Product Warehouse',
        'attribute-families' => 'Attribute Families',
        'attributes' => 'Attributes',
        'campaigns' => 'Campaigns',
        'cancel' => 'Cancel',
    ...
    'seller' => [
        'financial-statement' => [
            'subtitle' => 'Summary of your shop orders and revenue',
            'shop-orders' => 'Shop orders',
            'completed-revenue' => 'Completed revenue',
            'pending-revenue' => 'Pending / processing revenue',
        ],
        'fund-record' => [
            ...
            'remarks' => 'Remarks',
            'empty' => 'No fund movements yet.',
            'card-total-pending-income' => 'Total pending income',
            'pending-income-hint' => 'Estimated from orders that are not completed yet and commission not yet released.',
            'breakdown-pending-order' => 'Pending orders',
            'breakdown-in-progress' => 'In progress (processing)',
            'breakdown-pending-commission' => 'Expected commission',
            'card-overall-total-income' => 'Overall total income',
            'card-total-profit-earned' => 'Total profit earned',
            'card-total-orders' => 'Total orders',
            'card-total-pending-orders' => 'Total pending orders',
            'card-total-in-progress-orders' => 'Total in-progress orders',
            'credit-label' => 'Credit (in)',
            'debit-label' => 'Debit (out)',
            'col-order-type' => 'Order Type',
            'col-serial' => 'Serial Number',
            'col-amount-change' => 'Amount of Change',
            'col-before' => 'Before Change',
            'col-after' => 'After Change',
            'col-time' => 'Change Time',
            'type-order-revenue' => 'Order Revenue',
            'type-order-revenue-approval' => 'Order revenue (approved release)',
            'type-procurement' => 'Product Procurement',
            'type-product-purchase' => 'Product purchase (order)',
            'type-rejection-refund' => 'Order rejected (purchase refunded)',
            'filter-deposit' => 'Deposits',
            'filter-withdraw' => 'Withdrawals',
            'filter-purchase' => 'Product purchases',
            'filter-commission' => 'Order revenue',
        ],
        'wallet' => [
            'balance' => 'Balance',
            ...
            'col-type' => 'Type',
            'col-status' => 'Status',
            'col-amount' => 'Deposit Amount',
            'col-balance-after' => 'Balance after',
            'col-remarks' => 'Remarks',
            'col-time' => 'Create Time',
            'choose-deposit-method' => 'Choose a deposit method',
            'choose-withdraw-method' => 'Choose a withdraw method',
            'back' => 'Back',
            'receipt' => 'Upload receipt',
            'network' => 'Network',
            'destination-address' => 'Destination address',
            'address-label' => 'Address name / network',
            'bank-name' => 'Bank name',
            'account-number' => 'Account number',
            'amount-usdt' => 'Amount (USDT)',
            'type-deposit' => 'Deposit',
            'type-withdraw' => 'Withdraw',
            'type-withdraw-refund' => 'Withdrawal rejected (refund)',
            'invalid-deposit-method' => 'Invalid or inactive deposit method.',
            'invalid-withdraw-method' => 'Invalid or inactive withdraw method.',
            'deposit-request-desc' => 'Deposit request (:method)',
            'deposit-request-success' => 'Deposit request submitted. It will be reviewed shortly.',
            'withdraw-request-desc' => 'Withdraw request (:method)',
            'withdraw-request-success' => 'Withdraw request submitted. It will be reviewed shortly.',
            'withdraw-not-approved' => 'Withdrawal is only available when your seller account is approved.',
            'withdraw-account-inactive' => 'Withdrawal is only available when your seller account is active.',
            'withdraw-credit-not-100' => 'Withdrawal requires a credit score of 100%. Please contact customer care.',
            'withdraw-insufficient-balance' => 'Your wallet balance is not enough for this withdrawal. Please recharge.',
            'deposit-address-not-configured' => 'No deposit address has been configured for this method yet. Please contact support.',
            'deposit-bank-instructions' => 'Please contact your receptionist to complete your bank deposit. They will provide the account details and confirm your payment.',
            'deposit-bank-not-online' => 'Bank deposits are arranged in person. Please speak with your receptionist.',
        ],
        'shop-order' => [
            ...
            'account-inactive' => 'Your seller account must be active before you can place this order. Ask the administrator to set your account to active.',
            'credit-not-100-contact' => 'Your credit score must be 100%. Please contact our customer care center.',
            'insufficient-balance-recharge' => 'Your wallet balance is not enough for this order. Please recharge.',
            'purchase-desc' => 'Purchase for order #:increment',
            'make-order-success' => 'Order updated. Amount deducted from your wallet.',
            'commission-desc' => 'Commission for order #:increment',
            'bulk-make-order' => 'Bulk Make Order',
            'bulk-make-order-success' => 'Selected orders updated. Amounts deducted from your wallet.',
            'bulk-invalid-selection' => 'Some selected orders are invalid or no longer available.',
            'forbidden-order' => 'You cannot act on this order.',
    ...
    'seller-panel' => [
        ...
        'products' => [
            'batch-on-shelves' => 'Batch on shelves',
            'bulk-removal' => 'Bulk removal',
            'batch-modification' => 'Batch Modification',
            'batch-delete' => 'Batch delete',
        ],
        'dashboard' => [
            'period-range' => 'Reporting period: :from – :to',
            'total-products' => 'Total Products',
            'price' => 'Price',
            'shop-overview' => 'Shop Overview',
            'visitor-statistics' => 'Visitor Statistics',
            'today-statistics' => 'Today’s Statistics',
            'top-best-selling' => 'TOP 10 Best-Selling Items',
            'order-statistics' => 'Order Statistics',
            'total-profit' => 'Total Profit',
            'estimated-profit' => 'Estimated Profit',
            'seller-credit-score' => 'Seller Credit Score',
            'store-follow' => 'Store Follow',
            'overall-rating' => 'Overall Rating',
            'todays-visitors' => 'Today’s Visitors',
            'last-7-days' => 'Last 7 Days',
            'last-30-days' => 'Last 30 Days',
            'todays-order' => 'Today’s Orders',
            'todays-sales' => 'Today’s Sales',
            'sales-volume' => 'Sales Volume',
            'in-process' => 'In Process',
            'cancel-order' => 'Cancel Order',
            'completed' => 'Completed',
            'verified' => 'Verified',
            'visitors-not-tracked' => 'Visitor counts are not tracked per seller.',
        ],
        'sidebar' => [
            'referral-code' => 'Referral code',
            'visit-store' => 'Visit Store',
            'seller-level' => 'Level',
            'seller-level-line' => 'Seller Level: :level',
        ],
        'store-products' => [
            'total-in-store' => 'Products in your store: :count',
            'commission-percent' => 'Commission %',
            'recommended' => 'Recommended',
            'edit-commission' => 'Edit commission',
            'toggle-recommended' => 'Toggle recommended',
            'remove-from-store' => 'Remove from store',
            'mass-remove' => 'Remove from store',
            'commission-updated' => 'Commission updated.',
            'recommended-limit' => 'You can mark at most 100 products as recommended.',
            'recommended-updated' => 'Recommended flag updated.',
            'removed' => 'Product removed from your store.',
            'mass-removed' => ':count product(s) removed from your store.',
            'edit-commission-title' => 'Edit commission',
            'edit-commission-readonly' => 'Your seller level fixes commission at 15%.',
            'bulk-edit' => 'Bulk edit',
            'bulk-edit-modal-title' => 'Bulk edit selected products',
            'bulk-edit-modal-hint' => 'Apply the same commission and recommended setting to all selected products.',
            'bulk-edit-confirm' => 'Apply',
            'bulk-updated' => ':count product(s) updated.',
            'store-product-saved' => 'Store product updated.',
            'edit-modal-title' => 'Edit store product',
            'edit-modal-loading' => 'Loading…',
            'edit-modal-error' => 'Could not load product data.',
            ...
            'remove-not-allowed-title' => 'Product removal not allowed',
            'remove-not-allowed-subtitle' => ':days-day delist restriction',
            'remove-not-allowed-description' => 'You cannot delist or remove products from your store during the first :required days. Your seller account is currently :current days old, so this action is blocked.',
            'remove-not-allowed-footnote' => 'No products will be removed from your store.',
            ...
            'remove-not-allowed-dismiss' => 'Understood',
            'remove-confirm-single' => 'Remove this product from your store?',
        ],
        'product-warehouse' => [
            'add-to-store' => 'Add to store',
            'total-products' => 'Total warehouse products: :count',
            'level' => 'Your seller level: :level',
            'commission-title' => 'Commission percentage',
            'commission-hint' => 'Set the commission for products you add from this list (one value applies to the whole batch). Beginner level is fixed at 15%.',
            'save-commission' => 'Save commission',
            'commission-saved' => 'Commission percentage saved.',
            'commission-out-of-range' => 'Commission must be between :min% and :max% for your level.',
            'set-commission-first' => 'Set a valid commission percentage in the panel above, then add products.',
            'attach-success' => 'Added :added product(s) to your store. :skipped skipped (already in store or invalid).',
            'add-inactive-hint' => 'Enable the product and set it as visible individually to add it to your store from here.',
            'bulk-add-to-store' => 'Add to store',
            'bulk-add-modal-title' => 'Add selected products to your store',
            'bulk-add-seller-profit-label' => 'Seller profit (%)',
            'bulk-add-modal-hint' => 'Enter the seller profit (commission) percentage for this batch. Default is 15%. Allowed range depends on your seller level.',
            'bulk-add-range-hint' => 'Allowed range for your level: :min% – :max%.',
            'bulk-add-beginner-fixed' => 'Your level is Beginner: commission is fixed at 15%.',
            'bulk-add-invalid-range' => 'Enter a commission percentage within your allowed range.',
            'bulk-add-confirm' => 'Add to store',
        ],
        'purchase-history' => [
            'title' => 'Purchase History',
            'subtitle' => 'Orders linked to your seller account',
            'order-no' => 'Order No.',
            'total' => 'Order total',
            'status' => 'Status',
        ],
