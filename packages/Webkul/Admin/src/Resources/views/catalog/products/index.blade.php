<x-admin::layouts>
    ...
    <x-admin::seller.panel active="catalog_products" :breadcrumb="[__('admin::app.components.layouts.sidebar.product-management'), __('admin::app.seller-panel.tabs.product-warehouse')]">
        <form method="get" action="{{ route('admin.catalog.products.index') }}" class="seller-filter-card mb-4" id="seller-product-filters">
            ...
            <div class="mt-3 flex gap-2">
                ...
                <a href="{{ route('admin.catalog.products.index') }}" class="seller-btn-secondary">@lang('admin::app.seller-panel.filters.reset')</a>
            </div>
        </form>

        @php
            $sellerProductScroll = "document.getElementById('seller-product-grid')?.scrollIntoView({ behavior: 'smooth', block: 'start' })";
        @endphp
        <div class="mb-3 flex flex-wrap gap-2">
            <button type="button" class="seller-btn-primary text-xs" onclick="{{ $sellerProductScroll }}">@lang('admin::app.seller-panel.products.batch-on-shelves')</button>
            <button type="button" class="rounded-md bg-rose-100 px-3 py-1.5 text-xs font-semibold text-rose-700" onclick="{{ $sellerProductScroll }}">@lang('admin::app.seller-panel.products.bulk-removal')</button>
            <button type="button" class="seller-btn-primary text-xs" onclick="{{ $sellerProductScroll }}">@lang('admin::app.seller-panel.products.batch-modification')</button>
            <button type="button" class="rounded-md bg-rose-100 px-3 py-1.5 text-xs font-semibold text-rose-700" onclick="{{ $sellerProductScroll }}">@lang('admin::app.seller-panel.products.batch-delete')</button>
        </div>
