        ...
        <div class="sl-page-inner">
            ...
            <div class="sl-wrapper">
                <div class="sl-brand">
                    ...
                    <div class="sl-title">@lang('admin::app.users.sessions.title')</div>
                    <div class="sl-subtitle">{{ __('Access your seller dashboard') }}</div>
                </div>

                <div class="sl-card">
                    <form method="POST" action="{{ route('admin.session.store') }}" id="sl-login-form">
                        @csrf
                        ...
                        <div id="sl-panel-email" class="sl-panel active" role="tabpanel">
                            <div class="sl-field">
                                <label class="sl-label" for="sl-email">@lang('admin::app.users.sessions.email')</label>
                                <div class="sl-input-wrap">
                                    ...
                                    <input
                                        class="sl-input @error('email') sl-input-error @enderror"
                                        type="email"
                                        name="email"
                                        id="sl-email"
                                        value="{{ old('email') }}"
                                ...
                                @error('email')
                                    <p class="sl-flash" style="margin-top:8px;margin-bottom:0;">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div id="sl-panel-phone" class="sl-panel" role="tabpanel">
                            <div class="sl-field">
                                ...
                                <p class="sl-hint">{{ __('Seller sign-in uses your account email. Switch to the Email tab to log in, or enter the email linked to your seller account.') }}</p>
                            </div>
                        </div>

                        <div class="sl-field">
                            <label class="sl-label" for="sl-password">@lang('admin::app.users.sessions.password')</label>
                            <div class="sl-input-wrap">
                                ...
                                <input
                                    class="sl-input @error('password') sl-input-error @enderror"
                                    type="password"
                                    name="password"
                                    id="sl-password"
                                    required
                                ...
                                />
                                <button class="sl-pw-toggle" type="button" id="sl-pw-toggle" aria-label="{{ __('Show password') }}">
                        ...
                        <div class="sl-forgot-row">
                            <a href="{{ route('admin.forget_password.create') }}" class="sl-link">@lang('admin::app.users.sessions.forget-password-link')</a>
                        </div>
                        ...
                        @if (core()->getConfigData('customer.captcha.credentials.status'))
                            <div class="sl-field">
                                ...
                                @error('g-recaptcha-response')
                                    <p class="sl-flash" style="margin-top:8px;">{{ $message }}</p>
                                @enderror
                            </div>
                        @endif

                        <button class="sl-btn" type="submit">@lang('admin::app.users.sessions.submit-btn')</button>
                    </form>

                    <div class="sl-divider">
                        <div class="sl-divider-line"></div>
                        <span class="sl-divider-text">{{ __('Need help?') }}</span>
                        <div class="sl-divider-line"></div>
                    </div>

                    <div class="sl-register">
                        <a href="{{ url('/') }}" class="sl-link">{{ __('← Back to store') }}</a>
                    </div>
                </div>
