...
<head>
    ...
    <link
        rel="preload"
        as="image"
        href="{{ url('images/tiktok-logo.png') }}"
    >
...
<body class="h-full dark:bg-gray-950">
    ...
    >
        ...
        >
            ...
            <div class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col transition-all duration-300 pt-3 px-2 sm:px-4 lg:pt-3 lg:px-4 lg:ltr:pl-[286px] lg:group-[.sidebar-collapsed]/container:ltr:pl-[85px] lg:rtl:pr-[286px] lg:group-[.sidebar-collapsed]/container:rtl:pr-[85px] {{ \Webkul\Admin\Support\SellerPanel::hideDefaultSubmenuTabs() ? 'bg-[#F4F6F9] dark:bg-gray-950' : 'bg-white dark:bg-gray-950' }}">
