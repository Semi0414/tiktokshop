...
class ReviewDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
         ...
         */
        $sellerNickname = request()->input('seller_review_nickname');
        if ($sellerNickname !== null && $sellerNickname !== '') {
            $queryBuilder->where('product_reviews.name', 'like', '%'.addcslashes((string) $sellerNickname, '%_\\').'%');
        }

        $sellerReviewStatus = request()->input('seller_review_status');
        if ($sellerReviewStatus !== null && $sellerReviewStatus !== '' && $sellerReviewStatus !== 'all') {
            $queryBuilder->where('product_reviews.status', $sellerReviewStatus);
        }
