...
class RegistrationController extends Controller
{
    ...
    public function store(RegistrationRequest $registrationRequest)
    {
        ...
        $seller = Admin::query()
            ->where('referral_code', $registrationRequest->input('referral_code'))
            ->first();
        ...
        CustomerAddress::create([
            ...
            'address1' => $registrationRequest->input('shipping_address1'),
            'address2' => $registrationRequest->input('shipping_address2'),
            'city' => $registrationRequest->input('shipping_city'),
            'state' => $registrationRequest->input('shipping_state'),
            'country' => $registrationRequest->input('shipping_country'),
            'postcode' => $registrationRequest->input('shipping_postcode'),
        ...
        if (core()->getConfigData('customer.settings.email.verification')) {
            session()->flash('success', trans('shop::app.customers.signup-form.success-verify-pending'));
        } else {
            session()->flash('success', trans('shop::app.customers.signup-form.success-pending'));
        }
