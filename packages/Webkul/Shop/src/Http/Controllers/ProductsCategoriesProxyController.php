...
class ProductsCategoriesProxyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        /**
         * Disambiguate duplicate url_key / same-title products: TikStore links pass ?pid={id}.
         * Without this, findBySlug can resolve the wrong row when multiple products share a slug.
         */
