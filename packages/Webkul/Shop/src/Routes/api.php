...
use Webkul\Shop\Http\Controllers\API\SellerSearchController;
...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::controller(SellerSearchController::class)->prefix('sellers')->group(function () {
        Route::get('search', 'index')->name('shop.api.sellers.search');
    });
