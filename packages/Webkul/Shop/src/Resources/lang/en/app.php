...
return [
    'customers' => [
        ...
        'signup-form' => [
            ...
            'password' => 'Password',
            'referral-code' => 'Seller referral code',
            'referral-code-hint' => 'Enter the referral code provided by your seller. Registration is linked to that seller.',
            'referral-invalid' => 'This referral code is not valid. Check with your seller and try again.',
            'phone' => 'Mobile number',
            'shipping-section' => 'Shipping address',
            'shipping-address1' => 'Address line 1',
            'shipping-address2' => 'Address line 2 (optional)',
            'shipping-city' => 'City',
            'shipping-state' => 'State / Region',
            ...
            'success-pending' => 'Registration submitted. Your account is pending approval. You can sign in after an administrator activates your account.',
            'success-verify' => 'Account created successfully, an e-mail has been sent for verification.',
            'success-verify-pending' => 'Registration submitted. Please verify your email using the link we sent. Your account is pending approval until an administrator activates it.',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                ...
                'search' => [
                    'empty' => 'No matching products or stores.',
                    'loading' => 'Searching…',
                    'products' => 'Products',
                    'stores' => 'Stores',
            ...
            'footer' => [
                ...
                'footer-text' => '© :current_year <a href=":app_url" class="text-navyBlue hover:underline">:app_name</a>. All rights reserved.',
                'locale' => 'Locale',
    ...
    'categories' => [
        ...
        'view' => [
            ...
            'load-more' => 'Load More',
            'browse-category-fallback' => 'Browse category',
        ],
    ],
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'product-id-mismatch' => 'The product identifier does not match. Please refresh the page and try again.',
    ...
    'seller-preview' => [
        'invalid-link' => 'This store preview link is invalid, expired, or the seller is not available.',
    ],
];
