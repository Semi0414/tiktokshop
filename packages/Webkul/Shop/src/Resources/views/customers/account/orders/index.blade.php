                                ...
                                <a :href="record.actions[0].url">
                                    <div class="flex justify-between">
                                        <div class="text-sm font-semibold">
                                            ...
                                            <p
                                                v-if="record.seller_store_name || record.seller_id"
                                                class="mt-1 text-xs text-neutral-600"
                                            >
                                                <span v-if="record.seller_store_name">@{{ record.seller_store_name }}</span>
                                                <span v-if="record.seller_id" class="text-neutral-500">
                                                    <template v-if="record.seller_store_name"> · </template>
                                                    @lang('shop::app.customers.account.orders.seller-id-label') #@{{ record.seller_id }}
                                                </span>
                                            </p>
                                        </div>
