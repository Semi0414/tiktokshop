...
>
    ...
    <div class="bl-auth">
        ...
        <div class="bl-wrapper">
            <div class="bl-top">
                <a href="{{ route(\Webkul\Shop\Support\ShopRoutes::publicEntryRouteName()) }}" class="bl-logo" style="text-decoration:none;color:inherit;">
                ...
                <div class="bl-signup-link">
                    ...
                    <a href="{{ route('shop.customers.register.index') }}">@lang('shop::app.customers.login-form.create-your-account')</a>
                </div>
            </div>

            <div class="bl-card">
                <div class="bl-heading">@lang('shop::app.customers.login-form.page-title')</div>
                <div class="bl-subheading">@lang('shop::app.customers.login-form.form-login-text')</div>

                <form method="POST" action="{{ route('shop.customer.session.create') }}" id="bl-login-form">
                    @csrf
                    ...
                    <div id="bl-panel-email" class="bl-panel active" role="tabpanel">
                        <div class="bl-field">
                            <label class="bl-label" for="bl-email">@lang('shop::app.customers.login-form.email')</label>
                            <div class="bl-input-wrap">
                                ...
                                <input
                                    class="bl-input @error('email') bl-input-error @enderror"
                                    type="email"
                                    name="email"
                                    id="bl-email"
                                    value="{{ old('email') }}"
                            ...
                            @error('email')
                                <p class="bl-flash" style="margin-top:6px;margin-bottom:0;">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div id="bl-panel-phone" class="bl-panel" role="tabpanel">
                        <div class="bl-field">
                            <label class="bl-label" for="bl-phone">@lang('shop::app.customers.signup-form.phone')</label>
                            <div class="bl-input-wrap">
                    ...
                    <div class="bl-field">
                        <label class="bl-label" for="bl-password">@lang('shop::app.customers.login-form.password')</label>
                        <div class="bl-input-wrap">
                            ...
                            <input
                                class="bl-input bl-input-pw @error('password') bl-input-error @enderror"
                                type="password"
                                name="password"
                                id="bl-password"
                                required
                            ...
                            />
                            <button class="bl-pw-toggle" type="button" id="bl-pw-toggle" aria-label="@lang('shop::app.customers.login-form.show-password')">
                    ...
                    <div class="bl-forgot-row">
                        <a href="{{ route('shop.customers.forgot_password.create') }}" class="bl-link">@lang('shop::app.customers.login-form.forgot-pass')</a>
                    </div>
                    ...
                    <div class="bl-privacy">
                        <input
                            ...
                            required
                        />
                        <label for="privacy_accepted">{{ __('I accept the privacy policy.') }}</label>
                    </div>
                    @error('privacy_accepted')
                        <p class="bl-flash">{{ $message }}</p>
                    @enderror
                    ...
                    <button class="bl-btn" type="submit" style="margin-top:20px;">@lang('shop::app.customers.login-form.button-title')</button>
                ...
                <div class="bl-divider">
                    ...
                    <span class="bl-divider-text">{{ __('or continue with') }}</span>
                    <div class="bl-divider-line"></div>
                </div>
