...
class Customer extends Authenticatable implements CustomerContract
{
    ...
    /**
     * Seller whose referral code was used at signup (buyer is scoped to this seller's storefront).
     */
    public function referralSeller(): BelongsTo
    {
        return $this->belongsTo(Admin::class, 'referral_seller_id');
    }
