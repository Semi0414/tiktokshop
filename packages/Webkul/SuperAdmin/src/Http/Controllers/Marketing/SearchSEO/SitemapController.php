...
use Webkul\SuperAdmin\DataGrids\Marketing\SearchSEO\SitemapDataGrid;
...
class SitemapController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::marketing.search-seo.sitemaps.index', [], SitemapDataGrid::class);
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.marketing.search-seo.sitemaps.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.marketing.search-seo.sitemaps.index.edit.success'),
        ]);
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return response()->json([
                'message' => trans('superadmin::app.marketing.search-seo.sitemaps.index.edit.delete-success'),
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'message' => trans('superadmin::app.marketing.search-seo.sitemaps.delete-failed', ['name' => 'superadmin::app.marketing.search-seo.sitemaps.index.sitemap']),
            ], 500);
        }
    }
}
