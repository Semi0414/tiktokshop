...
namespace Webkul\SuperAdmin\Http\Controllers\Marketing\SearchSEO;
...
use Webkul\SuperAdmin\DataGrids\Marketing\SearchSEO\SearchSynonymDataGrid;
...
class SearchSynonymController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::marketing.search-seo.search-synonyms.index', [], SearchSynonymDataGrid::class);
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.marketing.search-seo.search-synonyms.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.marketing.search-seo.search-synonyms.index.edit.success'),
        ]);
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'message' => trans('superadmin::app.marketing.search-seo.search-synonyms.index.edit.delete-success'),
            ], 200);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('superadmin::app.marketing.search-seo.search-synonyms.delete-failed'),
        ], 500);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.marketing.search-seo.search-synonyms.index.datagrid.mass-delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
