...
use Webkul\SuperAdmin\DataGrids\Marketing\SearchSEO\SearchTermDataGrid;
...
class SearchTermController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::marketing.search-seo.search-terms.index', [], SearchTermDataGrid::class);
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.marketing.search-seo.search-terms.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.marketing.search-seo.search-terms.index.edit.success'),
        ]);
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'message' => trans('superadmin::app.marketing.search-seo.search-terms.index.edit.delete-success'),
            ], 200);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('superadmin::app.marketing.search-seo.search-terms.delete-failed'),
        ], 500);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.marketing.search-seo.search-terms.index.datagrid.mass-delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
