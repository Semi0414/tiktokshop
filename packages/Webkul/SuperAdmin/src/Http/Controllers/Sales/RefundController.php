...
use Webkul\SuperAdmin\DataGrids\Sales\OrderRefundDataGrid;
...
class RefundController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::sales.refunds.index', [], OrderRefundDataGrid::class);
    }
    ...
    public function create(int $orderId)
    {
        ...
        return view('superadmin::sales.refunds.create', compact('order'));
    }
    ...
    public function store(int $orderId)
    {
        ...
        if (! $order->canRefund()) {
            session()->flash('error', trans('superadmin::app.sales.refunds.create.creation-error'));
        ...
        try {
            ...
            if (! $totals) {
                throw new InvalidRefundQuantityException(trans('superadmin::app.sales.refunds.create.invalid-qty'));
            }
        ...
        if (! $refundAmount) {
            session()->flash('error', trans('superadmin::app.sales.refunds.create.invalid-refund-amount-error'));

            return redirect()->back();
        }

        if ($refundAmount > $maxRefundAmount) {
            session()->flash('error', trans('superadmin::app.sales.refunds.create.refund-limit-error', [
        ...
        session()->flash('success', trans('superadmin::app.sales.refunds.create.create-success'));
    ...
    public function view($id)
    {
        ...
        return view('superadmin::sales.refunds.view', compact('refund'));
    }
}
