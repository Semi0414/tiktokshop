...
use Webkul\SuperAdmin\DataGrids\Sales\OrderShipmentDataGrid;
...
class ShipmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::sales.shipments.index', [], OrderShipmentDataGrid::class);
    }
    ...
    public function create(int $orderId)
    {
        ...
        if (! $order->channel || ! $order->canShip()) {
            session()->flash('error', trans('superadmin::app.sales.shipments.create.creation-error'));

            return redirect()->back();
        }

        return view('superadmin::sales.shipments.create', compact('order'));
    }
    ...
    public function store(int $orderId)
    {
        ...
        if (! $order->canShip()) {
            session()->flash('error', trans('superadmin::app.sales.shipments.create.order-error'));
        ...
        if (! $this->isInventoryValidate($data)) {
            session()->flash('error', trans('superadmin::app.sales.shipments.create.quantity-invalid'));
        ...
        session()->flash('success', trans('superadmin::app.sales.shipments.create.success'));
    ...
    public function view(int $id)
    {
        ...
        return view('superadmin::sales.shipments.view', compact('shipment'));
    }
}
