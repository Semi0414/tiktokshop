...
use Webkul\SuperAdmin\DataGrids\Catalog\AttributeFamilyDataGrid;
...
class AttributeFamilyController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::catalog.families.index', [], AttributeFamilyDataGrid::class);
    }
    ...
    public function create()
    {
        ...
        return view('superadmin::catalog.families.create', compact('attributeFamily', 'customAttributes'));
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('superadmin::app.catalog.families.create-success'));

        return redirect()->route('superadmin.catalog.families.index');
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('superadmin::catalog.families.edit', compact('attributeFamily', 'customAttributes'));
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('superadmin::app.catalog.families.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($this->attributeFamilyRepository->count() == 1) {
            return new JsonResponse([
                'message' => trans('superadmin::app.catalog.families.last-delete-error'),
            ], 400);
        }

        if ($attributeFamily->products()->count()) {
            return new JsonResponse([
                'message' => trans('superadmin::app.catalog.families.attribute-product-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.catalog.families.delete-success'),
            ]);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.catalog.families.delete-failed', ['name' => 'superadmin::app.catalog.families.family']),
        ], 500);
    }
}
