...
use Webkul\SuperAdmin\DataGrids\Catalog\AttributeDataGrid;
...
class AttributeController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::catalog.attributes.index', [], AttributeDataGrid::class);
    }
    ...
    public function create()
    {
        ...
        return view('superadmin::catalog.attributes.create', compact('locales', 'attributeTypes', 'swatchTypes', 'validations'));
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('superadmin::app.catalog.attributes.create-success'));

        return redirect()->route('superadmin.catalog.attributes.index');
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('superadmin::catalog.attributes.edit', compact('attribute', 'locales', 'attributeTypes', 'swatchTypes', 'validations'));
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('superadmin::app.catalog.attributes.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if (! $attribute->is_user_defined) {
            return response()->json([
                'message' => trans('superadmin::app.catalog.attributes.user-define-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.catalog.attributes.delete-success'),
            ]);
        } catch (\Exception $e) {
        }

        return new JsonResponse([
            'message' => trans('superadmin::app.catalog.attributes.delete-failed'),
        ], 500);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.catalog.attributes.index.datagrid.mass-delete-success'),
            ]);
