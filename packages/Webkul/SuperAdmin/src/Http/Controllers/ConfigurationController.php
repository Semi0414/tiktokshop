...
use Webkul\SuperAdmin\Http\Requests\ConfigurationForm;
...
class ConfigurationController extends Controller
{
    ...
    public function index(): View
    {
        if (
            ...
            return view('superadmin::configuration.edit');
        }

        return view('superadmin::configuration.index');
    }
    ...
    public function store(ConfigurationForm $request): RedirectResponse
    {
        ...
        if (isset($data['sales']['carriers'])) {
            ...
            if (! $atLeastOneCarrierEnabled) {
                session()->flash('error', trans('superadmin::app.configuration.index.enable-at-least-one-shipping'));
            ...
            if (! $atLeastOnePaymentMethodEnabled) {
                session()->flash('error', trans('superadmin::app.configuration.index.enable-at-least-one-payment'));
        ...
        session()->flash('success', trans('superadmin::app.configuration.index.save-message'));
