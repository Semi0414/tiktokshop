...
class AccountController extends Controller
{
    ...
    public function edit()
    {
        ...
        return view('superadmin::account.edit', compact('user'));
    }
    ...
    public function update()
    {
        ...
        if (! Hash::check($data['current_password'], $user->password)) {
            session()->flash('warning', trans('superadmin::app.account.edit.invalid-password'));
        ...
        session()->flash('success', trans('superadmin::app.account.edit.update-success'));
