...
namespace Webkul\SuperAdmin\Http\Controllers\DataGrid;
...
class SavedFilterController extends Controller
{
    ...
    public function store()
    {
        ...
        return response()->json([
            'data' => $savedFilter,
            'message' => trans('superadmin::app.components.datagrid.toolbar.filter.saved-success'),
        ]);
    }
    ...
    public function update(int $id)
    {
        ...
        return response()->json([
            'data' => $updatedFilter,
            'message' => trans('superadmin::app.components.datagrid.toolbar.filter.updated-success'),
        ]);
    }
    ...
    public function destroy(int $id)
    {
        ...
        if (! $success) {
            return response()->json([
                'message' => trans('superadmin::app.components.datagrid.toolbar.filter.delete-error'),
            ]);
        }

        return response()->json([
            'message' => trans('superadmin::app.components.datagrid.toolbar.filter.delete-success'),
        ]);
    }
}
