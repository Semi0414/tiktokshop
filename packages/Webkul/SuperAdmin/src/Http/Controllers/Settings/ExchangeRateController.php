...
use Webkul\SuperAdmin\DataGrids\Settings\ExchangeRatesDataGrid;
...
class ExchangeRateController extends Controller
{
    ...
    public function index(): View|JsonResponse
    {
        ...
        return $this->superadminListing('superadmin::settings.exchange-rates.index', compact('currencies'), ExchangeRatesDataGrid::class);
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.settings.exchange-rates.index.create-success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.settings.exchange-rates.index.update-success'),
        ]);
    }
    ...
    public function updateRates()
    {
        try {
            ...
            session()->flash('success', trans('superadmin::app.settings.exchange-rates.index.update-success'));
        } catch (\Exception $e) {
            session()->flash('error', $e->getMessage());
        }

        return redirect()->route('superadmin.settings.exchange_rates.index');
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.exchange-rates.index.delete-success'),
            ], 200);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return new JsonResponse([
            'message' => trans('superadmin::app.settings.exchange-rates.index.delete-error'),
        ], 500);
    }
}
