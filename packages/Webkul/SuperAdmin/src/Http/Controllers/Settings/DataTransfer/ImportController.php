...
namespace Webkul\SuperAdmin\Http\Controllers\Settings\DataTransfer;
...
use Webkul\SuperAdmin\DataGrids\Settings\DataTransfer\ImportDataGrid;
...
class ImportController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::settings.data-transfer.imports.index', [], ImportDataGrid::class);
    }
    ...
    {
        return view('superadmin::settings.data-transfer.imports.create', [
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('superadmin::app.settings.data-transfer.imports.create-success'));

        return redirect()->route('superadmin.settings.data_transfer.imports.import', $import->id);
    }
    ...
    {
        return view('superadmin::settings.data-transfer.imports.edit', [
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('superadmin::app.settings.data-transfer.imports.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.data-transfer.imports.delete-success'),
            ]);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('superadmin::app.settings.data-transfer.imports.delete-failed'),
        ], 500);
    }
    ...
    public function import(int $id)
    {
        ...
        return view('superadmin::settings.data-transfer.imports.import', compact('import', 'isValid', 'stats'));
    }
    ...
    public function start(int $id): JsonResponse
    {
        ...
        if (! $import->processed_rows_count) {
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.data-transfer.imports.nothing-to-import'),
            ], 400);
        }
        ...
        if (! $this->importHelper->isValid()) {
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.data-transfer.imports.not-valid'),
            ], 400);
        }
        ...
        if (
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.data-transfer.imports.setup-queue-error'),
            ], 400);
        }
