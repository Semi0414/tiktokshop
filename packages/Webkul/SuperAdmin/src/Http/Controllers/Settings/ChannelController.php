...
use Webkul\SuperAdmin\DataGrids\Settings\ChannelDataGrid;
...
class ChannelController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->superadminListing('superadmin::settings.channels.index', [], ChannelDataGrid::class);
    }
    ...
    {
        return view('superadmin::settings.channels.create');
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('superadmin::app.settings.channels.create.create-success'));

        return redirect()->route('superadmin.settings.channels.index');
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('superadmin::settings.channels.edit', compact('channel'));
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('superadmin::app.settings.channels.edit.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($channel->code == config('app.channel')) {
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.channels.index.last-delete-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('superadmin::app.settings.channels.index.delete-success'),
            ], 200);
        } catch (\Exception $e) {
        }

        return new JsonResponse([
            'message' => trans('superadmin::app.settings.channels.index.delete-failed'),
        ], 500);
    }
