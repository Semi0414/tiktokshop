...
namespace Webkul\SuperAdmin\Helpers;

use Illuminate\Database\Eloquent\Collection as EloquentCollection;
use Illuminate\Support\Carbon;
use Webkul\Product\Models\Product as ProductModel;
use Webkul\SuperAdmin\Helpers\Reporting\Cart;
use Webkul\SuperAdmin\Helpers\Reporting\Customer;
use Webkul\SuperAdmin\Helpers\Reporting\Product;
use Webkul\SuperAdmin\Helpers\Reporting\Sale;
use Webkul\SuperAdmin\Helpers\Reporting\Visitor;
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'label',
                        'label' => trans('superadmin::app.reporting.sales.index.interval'),
                    ], [
                        'key' => 'count',
                        'label' => trans('superadmin::app.reporting.sales.index.orders'),
                    ], [
                        'key' => 'formatted_total',
                        'label' => trans('superadmin::app.reporting.sales.index.total'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'id',
                        'label' => trans('superadmin::app.reporting.sales.index.id'),
                    ], [
                        'key' => 'name',
                        'label' => trans('superadmin::app.reporting.sales.index.name'),
                    ], [
                        'key' => 'count',
                        'label' => trans('superadmin::app.reporting.sales.index.count'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'title',
                        'label' => trans('superadmin::app.reporting.sales.index.payment-method'),
                    ], [
                        'key' => 'total',
                        'label' => trans('superadmin::app.reporting.sales.index.orders'),
                    ], [
        ...
        if ($type == 'table') {
            return [
                'columns' => [
                    [
                        'key' => 'label',
                        'label' => trans('superadmin::app.reporting.customers.index.interval'),
                    ], [
                        'key' => 'total',
                        'label' => trans('superadmin::app.reporting.customers.index.customers'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'full_name',
                        'label' => trans('superadmin::app.reporting.customers.index.name'),
                    ], [
                        'key' => 'email',
                        'label' => trans('superadmin::app.reporting.customers.index.email'),
                    ], [
                        'key' => 'formatted_total',
                        'label' => trans('superadmin::app.reporting.customers.index.total'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'orders',
                        'label' => trans('superadmin::app.reporting.customers.index.orders'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'reviews',
                        'label' => trans('superadmin::app.reporting.customers.index.reviews'),
                    ],
                ],
        ...
        if ($type == 'table') {
            return [
                'columns' => [
                    [
                        'key' => 'label',
                        'label' => trans('superadmin::app.reporting.products.index.interval'),
                    ], [
                        'key' => 'total',
                        'label' => trans('superadmin::app.reporting.products.index.quantities'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'total',
                        'label' => trans('superadmin::app.reporting.products.index.total'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'id',
                        'label' => trans('superadmin::app.reporting.products.index.id'),
                    ], [
                        'key' => 'name',
                        'label' => trans('superadmin::app.reporting.products.index.name'),
                    ], [
                        'key' => 'formatted_price',
                        'label' => trans('superadmin::app.reporting.products.index.price'),
                    ], [
                        'key' => 'formatted_revenue',
                        'label' => trans('superadmin::app.reporting.products.index.revenue'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'reviews',
                        'label' => trans('superadmin::app.reporting.products.index.reviews'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'visits',
                        'label' => trans('superadmin::app.reporting.products.index.visits'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'term',
                        'label' => trans('superadmin::app.reporting.products.index.search-term'),
                    ], [
                        'key' => 'results',
                        'label' => trans('superadmin::app.reporting.products.index.results'),
                    ], [
                        'key' => 'uses',
                        'label' => trans('superadmin::app.reporting.products.index.uses'),
                    ], [
                        'key' => 'channel_id',
                        'label' => trans('superadmin::app.reporting.products.index.channel'),
                    ], [
                        'key' => 'locale',
                        'label' => trans('superadmin::app.reporting.products.index.locale'),
                    ],
                ],
