...
class BookingDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('superadmin::app.sales.booking.index.datagrid.id'),
            'type' => 'string',
            'searchable' => false,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'order_id',
            'label' => trans('superadmin::app.sales.booking.index.datagrid.order-id'),
            'type' => 'string',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'qty',
            'label' => trans('superadmin::app.sales.booking.index.datagrid.qty'),
            'type' => 'string',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'from',
            'label' => trans('superadmin::app.sales.booking.index.datagrid.from'),
            'type' => 'datetime',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'to',
            'label' => trans('superadmin::app.sales.booking.index.datagrid.to'),
            'type' => 'datetime',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'created_at',
            'label' => trans('superadmin::app.sales.booking.index.datagrid.created-date'),
            'type' => 'datetime',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon' => 'icon-view',
            'title' => trans('superadmin::app.sales.booking.index.datagrid.view'),
            'method' => 'GET',
            'url' => function ($row) {
                return route('superadmin.sales.orders.view', $row->order_id);
            },
        ]);
    }
}
