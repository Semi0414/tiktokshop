...
namespace Webkul\SuperAdmin\DataGrids\Customers\View;
...
class OrderDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => [
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.processing'),
                    'value' => Order::STATUS_PROCESSING,
                ],
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.completed'),
                    'value' => Order::STATUS_COMPLETED,
                ],
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.canceled'),
                    'value' => Order::STATUS_CANCELED,
                ],
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.closed'),
                    'value' => Order::STATUS_CLOSED,
                ],
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.pending'),
                    'value' => Order::STATUS_PENDING,
                ],
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.pending-payment'),
                    'value' => Order::STATUS_PENDING_PAYMENT,
                ],
                [
                    'label' => trans('superadmin::app.customers.customers.view.datagrid.orders.fraud'),
            ...
            'closure' => function ($row) {
                switch ($row->status) {
                    case Order::STATUS_PROCESSING:
                        return '<p class="label-processing">'.trans('superadmin::app.customers.customers.view.datagrid.orders.processing').'</p>';

                    case Order::STATUS_COMPLETED:
                        return '<p class="label-active">'.trans('superadmin::app.customers.customers.view.datagrid.orders.completed').'</p>';

                    case Order::STATUS_CANCELED:
                        return '<p class="label-canceled">'.trans('superadmin::app.customers.customers.view.datagrid.orders.canceled').'</p>';

                    case Order::STATUS_CLOSED:
                        return '<p class="label-closed">'.trans('superadmin::app.customers.customers.view.datagrid.orders.closed').'</p>';

                    case Order::STATUS_PENDING:
                        return '<p class="label-pending">'.trans('superadmin::app.customers.customers.view.datagrid.orders.pending').'</p>';

                    case Order::STATUS_PENDING_PAYMENT:
                        return '<p class="label-pending">'.trans('superadmin::app.customers.customers.view.datagrid.orders.pending-payment').'</p>';

                    case Order::STATUS_FRAUD:
                        return '<p class="label-canceled">'.trans('superadmin::app.customers.customers.view.datagrid.orders.fraud').'</p>';
                }
            },
        ]);
