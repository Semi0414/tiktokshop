...
namespace Webkul\SuperAdmin\DataGrids\Theme;
...
class ThemeDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            'index' => 'channel_name',
            'label' => trans('superadmin::app.settings.themes.index.datagrid.channel_name'),
            'type' => 'string',
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'theme_code',
            'label' => trans('superadmin::app.settings.themes.index.datagrid.theme'),
            'type' => 'string',
            'filterable' => true,
            'filterable_type' => 'dropdown',
        ...
        $this->addColumn([
            'index' => 'type',
            'label' => trans('superadmin::app.settings.themes.index.datagrid.type'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            ...
            'label' => trans('superadmin::app.settings.themes.index.datagrid.name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'sort_order',
            'label' => trans('superadmin::app.settings.themes.index.datagrid.sort-order'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'status',
            'label' => trans('superadmin::app.settings.themes.index.datagrid.status'),
            'type' => 'boolean',
            'searchable' => true,
            'filterable' => true,
            'filterable_options' => [
                [
                    'label' => trans('superadmin::app.settings.themes.index.datagrid.active'),
                    'value' => 1,
                ],
                [
                    'label' => trans('superadmin::app.settings.themes.index.datagrid.inactive'),
                    'value' => 0,
                ],
            ],
            'sortable' => true,
            'closure' => function ($value) {
                if ($value->status) {
                    return '<p class="label-active">'.trans('superadmin::app.settings.themes.index.datagrid.active').'</p>';
                }

                return '<p class="label-pending">'.trans('superadmin::app.settings.themes.index.datagrid.inactive').'</p>';
            },
        ]);
    }
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('settings.themes.edit')) {
            $this->addAction([
                'icon' => 'icon-edit',
                'title' => trans('superadmin::app.settings.themes.index.datagrid.view'),
                'method' => 'GET',
                'url' => function ($row) {
                    return route('superadmin.settings.themes.edit', $row->id);
                },
            ]);
        }
        ...
        if (bouncer()->hasPermission('settings.themes.delete')) {
            $this->addAction([
                'icon' => 'icon-delete',
                'title' => trans('superadmin::app.settings.themes.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
                    return route('superadmin.settings.themes.delete', $row->id);
                },
            ]);
        }
    }
    ...
    public function prepareMassActions()
    {
        if (bouncer()->hasPermission('settings.themes.edit')) {
            $this->addMassAction([
                'title' => trans('superadmin::app.settings.themes.index.datagrid.change-status'),
                'url' => route('superadmin.settings.themes.mass_update'),
                'method' => 'POST',
                'options' => [
                    [
                        'label' => trans('superadmin::app.settings.themes.index.datagrid.active'),
        ...
        if (bouncer()->hasPermission('settings.themes.delete')) {
            $this->addMassAction([
                'title' => trans('superadmin::app.settings.themes.index.datagrid.delete'),
                'url' => route('superadmin.settings.themes.mass_delete'),
                'method' => 'POST',
            ]);
        }
    }
