...
namespace Webkul\SuperAdmin\DataGrids\CMS;
...
class CMSPageDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('superadmin::app.cms.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'channel',
            'label' => trans('superadmin::app.cms.index.datagrid.channel'),
            'type' => 'string',
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'page_title',
            'label' => trans('superadmin::app.cms.index.datagrid.page-title'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'url_key',
            'label' => trans('superadmin::app.cms.index.datagrid.url-key'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon' => 'icon-view',
            'title' => trans('superadmin::app.cms.index.datagrid.view'),
            'method' => 'GET',
            'index' => 'url_key',
            'target' => '_blank',
            'url' => function ($row) {
        ...
        if (bouncer()->hasPermission('cms.edit')) {
            $this->addAction([
                'icon' => 'icon-edit',
                'title' => trans('superadmin::app.cms.index.datagrid.edit'),
                'method' => 'GET',
                'url' => function ($row) {
                    return route('superadmin.cms.edit', $row->id);
                },
            ]);
        }
        ...
        if (bouncer()->hasPermission('cms.delete')) {
            $this->addAction([
                'icon' => 'icon-delete',
                'title' => trans('superadmin::app.cms.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
                    return route('superadmin.cms.delete', $row->id);
                },
            ]);
        }
    }
    ...
    public function prepareMassActions()
    {
        if (bouncer()->hasPermission('cms.delete')) {
            $this->addMassAction([
                'title' => trans('superadmin::app.cms.index.datagrid.delete'),
                'method' => 'POST',
                'url' => route('superadmin.cms.mass_delete'),
            ]);
        }
    }
}
