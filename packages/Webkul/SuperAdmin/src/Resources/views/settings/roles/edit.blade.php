<x-superadmin::layouts>
    ...
    <!-- Page Title -->
    <x-slot:title>
        @lang('superadmin::app.settings.roles.edit.title')
    </x-slot>
    ...
    <x-superadmin::form
        method="PUT"
        :action="route('superadmin.settings.roles.update', $role->id)"
    >
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.settings.roles.edit.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.settings.roles.edit.save-btn')
                </button>
            </div>
        </div>
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.settings.roles.edit.access-control')
                    </p>
                    ...
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.roles.edit.general')
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.roles.edit.name')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.roles.edit.name')"
                                :placeholder="trans('superadmin::app.settings.roles.edit.name')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.roles.edit.description')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.roles.edit.description')"
                                :placeholder="trans('superadmin::app.settings.roles.edit.description')"
                            />
    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                ...
                <x-superadmin::form.control-group>
                    <x-superadmin::form.control-group.label class="required">
                        @lang('superadmin::app.settings.roles.edit.permissions')
                    </x-superadmin::form.control-group.label>
                    ...
                    <x-superadmin::form.control-group.control
                        ...
                        :label="trans('superadmin::app.settings.roles.edit.permissions')"
                        :placeholder="trans('superadmin::app.settings.roles.edit.permissions')"
                    >
                        <option value="custom">
                            @lang('superadmin::app.settings.roles.edit.custom')
                        </option>

                        <option value="all">
                            @lang('superadmin::app.settings.roles.edit.all')
                        </option>
                    </x-superadmin::form.control-group.control>
