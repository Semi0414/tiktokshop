<x-superadmin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('superadmin::app.settings.roles.create.title')
    </x-slot>

    {!! view_render_event('bagisto.admin.settings.roles.create.before') !!}

    <x-superadmin::form :action="route('superadmin.settings.roles.store')">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-x-2.5">
                <!-- Back Button -->
                <a
                    href="{{ route('superadmin.settings.roles.index') }}"
                    class="transparent-button hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800"
                >
                    @lang('superadmin::app.settings.roles.create.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.settings.roles.create.save-btn')
                </button>
            </div>
        </div>
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.settings.roles.create.access-control')
                    </p>
                    ...
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.roles.create.general')
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.roles.create.name')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                value="{{ old('name') }}"
                                :label="trans('superadmin::app.settings.roles.create.name')"
                                :placeholder="trans('superadmin::app.settings.roles.create.name')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.roles.create.description')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.roles.create.description')"
                                :placeholder="trans('superadmin::app.settings.roles.create.description')"
                            />
    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                ...
                <x-superadmin::form.control-group>
                    <x-superadmin::form.control-group.label class="required">
                        @lang('superadmin::app.settings.roles.create.permissions')
                    </x-superadmin::form.control-group.label>
                    ...
                    <x-superadmin::form.control-group.control
                        ...
                        id="permission_type"
                        rules="required"
                        :label="trans('superadmin::app.settings.roles.create.permissions')"
                        :placeholder="trans('superadmin::app.settings.roles.create.permissions')"
                        v-model="permission_type"
                    >
                        <option value="custom">
                            @lang('superadmin::app.settings.roles.create.custom')
                        </option>

                        <option value="all">
                            @lang('superadmin::app.settings.roles.create.all')
                        </option>
                    </x-superadmin::form.control-group.control>

                    <x-superadmin::form.control-group.error control-name="permission_type" />
                </x-superadmin::form.control-group>

                <div v-if="permission_type == 'custom'">
                    <x-superadmin::form.control-group.error control-name="permissions" />
        ...
        <script type="module">
            window.app.component('v-access-control', {
