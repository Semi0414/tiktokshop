...
<x-superadmin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('superadmin::app.settings.channels.edit.title')
    </x-slot>
    ...
    <x-superadmin::form  
        :action="route('superadmin.settings.channels.update', ['id' => $channel->id, 'locale' => $locale])"
    ...
    >
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.settings.channels.edit.back-btn')
                </a>
                ...
                <button 
                    ...
                    aria-label="Submit"
                >
                    @lang('superadmin::app.settings.channels.edit.save-btn')
                </button>
            </div>
        </div>
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.settings.channels.edit.general')
                    </p>

                    <!-- Code -->
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.settings.channels.edit.code')
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.code')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.code')"
                            disabled="disabled"
                        />
                    ...
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.settings.channels.edit.name')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.name')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.name')"
                        />

                        <x-superadmin::form.control-group.error :control-name="$locale . '[name]'" />
                    </x-superadmin::form.control-group>

                    <!-- Description -->
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.settings.channels.edit.description')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.description')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.description')"
                        />

                        <x-superadmin::form.control-group.error control-name="$locale . '[description]'" />
                    </x-superadmin::form.control-group>

                    <!-- Inventory Sources -->
                    <div class="mb-4">
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.settings.channels.edit.inventory-sources')
                        </x-superadmin::form.control-group.label>
                        ...
                        @foreach (app('Webkul\Inventory\Repositories\InventorySourceRepository')->findWhere(['status' => 1]) as $inventorySource)
                            <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.settings.channels.edit.inventory-sources')"
                    ...
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.settings.channels.edit.root-category')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.root-category')"
                        >
                    ...
                    <x-superadmin::form.control-group class="!mb-0">
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.settings.channels.edit.hostname')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.hostname')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.hostname-placeholder')"
                        />
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.settings.channels.edit.design')
                    </p>

                    <!-- Theme Selector -->
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.settings.channels.edit.theme')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.theme')"
                        >
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="flex w-2/5 flex-col">
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label>
                                    @lang('superadmin::app.settings.channels.edit.logo')
                                </x-superadmin::form.control-group.label>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.settings.channels.edit.logo-size')
                            </p>
                        </div>
                        ...
                        <div class="flex w-2/5 flex-col">
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label>
                                    @lang('superadmin::app.settings.channels.edit.favicon')
                                </x-superadmin::form.control-group.label>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.settings.channels.edit.favicon-size')
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.settings.channels.edit.seo')
                    </p>
                    ...
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.settings.channels.edit.seo-title')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            id="meta_title"
                            rules="required"
                            :label="trans('superadmin::app.settings.channels.edit.seo-title')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.seo-title')"
                        />

                        <x-superadmin::form.control-group.error :control-name="$locale . '[seo_title]'" />
                    </x-superadmin::form.control-group>

                    <!-- Meta Keywords -->
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.settings.channels.edit.seo-keywords')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.seo-keywords')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.seo-keywords')"
                        />
                    </x-superadmin::form.control-group>
                    ...
                    <x-superadmin::form.control-group class="!mb-0">
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.settings.channels.edit.seo-description')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.settings.channels.edit.seo-description')"
                            :placeholder="trans('superadmin::app.settings.channels.edit.seo-description')"
                        />

                        <x-superadmin::form.control-group.error :control-name="$locale . '[seo_description]'" />
                    </x-superadmin::form.control-group>
                </div>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                <x-superadmin::accordion>
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.channels.edit.currencies-and-locales')
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <div class="mb-4">
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.channels.edit.locales') 
                            </x-superadmin::form.control-group.label>
                            ...
                            @foreach (core()->getAllLocales() as $locale)
                                <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.settings.channels.edit.locales')"
                        ...
                        <x-superadmin::form.control-group class="mb-4">
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.channels.edit.default-locale')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.channels.edit.default-locale')"
                            >
                                @foreach (core()->getAllLocales() as $locale)
                                    <option
                                        value="{{ $locale->id }}"
                        ...
                        <div class="mb-4">
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.settings.channels.edit.currencies')
                            </x-superadmin::form.control-group.label>
                            ...
                            @foreach (core()->getAllCurrencies() as $currency)
                                <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.settings.channels.edit.currencies')"
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label class="required"> 
                                @lang('superadmin::app.settings.channels.edit.default-currency')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.channels.edit.default-currency')"
                            >
                                @foreach (core()->getAllCurrencies() as $currency)
                                    <option
                                        value="{{ $currency->id }}"
                ...
                <x-superadmin::accordion>
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.channels.edit.maintenance-mode')
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.settings.channels.edit.maintenance-mode-text')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.channels.edit.maintenance-mode-text')"
                                :placeholder="trans('superadmin::app.settings.channels.edit.maintenance-mode-text')"
                            />
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="!text-gray-800 dark:!text-white">
                                @lang('superadmin::app.settings.channels.edit.allowed-ips')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.settings.channels.edit.allowed-ips')"
                                :placeholder="trans('superadmin::app.settings.channels.edit.allowed-ips')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.settings.channels.edit.status')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :value="1"
                                :label="trans('superadmin::app.settings.channels.edit.status')"
