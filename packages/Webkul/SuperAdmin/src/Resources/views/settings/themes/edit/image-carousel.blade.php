<v-image-carousel :errors="errors">
    <x-superadmin::shimmer.settings.themes.image-carousel />
</v-image-carousel>
...
@pushOnce('scripts')
    ...
    >
        <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.themes.edit.slider')
                        </p>
                        
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.settings.themes.edit.slider-description')
                        </p>
                    </div>
                    ...
                    >
                        @lang('superadmin::app.settings.themes.edit.slider-add-btn')
                    </div>
                </div>
                        ...
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('superadmin::app.settings.themes.edit.image-title'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('superadmin::app.settings.themes.edit.link'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('superadmin::app.settings.themes.edit.image'): 
                ...
                >
                    <img
                        ...
                        alt="@lang('superadmin::app.settings.themes.edit.slider')"
                    >
            ...
            >
                ...
                >
                    <x-superadmin::modal ref="addSliderModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.themes.edit.update-slider')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <x-superadmin::form.control-group>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    rules="required"
                                    :placeholder="trans('superadmin::app.settings.themes.edit.image-title')"
                                    :label="trans('superadmin::app.settings.themes.edit.image-title')"
                                />
                            ...
                            <x-superadmin::form.control-group>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :placeholder="trans('superadmin::app.settings.themes.edit.link')"
                                />
                            </x-superadmin::form.control-group>

                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.settings.themes.edit.slider-image')
                                </x-superadmin::form.control-group.label>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.settings.themes.edit.image-size')
                            </p>
                        </x-slot>
    ...
    <script type="module">
        window.app.component('v-image-carousel', {
            ...
            methods: {
                saveSliderImage(params, { resetForm ,setErrors }) {
                    ...
                    try {
                        ...
                        if (! sliderImage) {
                            throw new Error("{{ trans('superadmin::app.settings.themes.edit.slider-required') }}");
                        }
