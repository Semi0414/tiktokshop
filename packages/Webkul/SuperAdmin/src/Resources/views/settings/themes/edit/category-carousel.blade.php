<v-category-carousel :errors="errors">
    <x-superadmin::shimmer.settings.themes.category-carousel />
</v-category-carousel>
...
@pushOnce('scripts')
        ...
        <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.themes.edit.category-carousel')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.settings.themes.edit.category-carousel-description')
                        </p>
                    </div>
                </div>
                ...
                <x-superadmin::form.control-group>
                    ...
                    >
                        ...
                        >
                            ...
                            <option value="desc">
                                @lang('superadmin::app.settings.themes.edit.desc')
                            </option>

                            <option value="asc">
                                @lang('superadmin::app.settings.themes.edit.asc')
                            </option>
                        </select>
                    </v-field>

                    <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[options][sort]" />
                </x-superadmin::form.control-group>
                ...
                <x-superadmin::form.control-group>
                    ...
                    <v-field
                        ...
                        placeholder="@lang('superadmin::app.settings.themes.edit.limit')"
                    >
                    </v-field>
                ...
                >
                    <img
                        ...
                        alt="@lang('superadmin::app.settings.themes.edit.category-carousel')"
                    >
            ...
            >
                <form @submit="handleSubmit($event, addFilter)">
                    <x-superadmin::modal ref="categoryFilterModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group>
                                ...
                                <template v-else>
                                    ...
                                    >
                                        @lang('superadmin::app.settings.themes.edit.parent-id-hint')
                                    </p>
                                </template>
    ...
    <script type="module">
        window.app.component('v-category-carousel', {
                        ...
                        available: [
                            {
                                id: 'parent_id',
                                code: 'parent_id',
                                name: '@lang('superadmin::app.settings.themes.edit.parent-id')',
                                type: 'text',
                            },
                            {
                                id: 'name',
                                code: 'name',
                                name: '@lang('superadmin::app.settings.themes.edit.name')',
                                type: 'text',
                            },
                            {
                                id: 'status',
                                code: 'status',
                                name: '@lang('superadmin::app.settings.themes.edit.status')',
                                type: 'select',
                                options: [
                                    {
                                        id: '1',
                                        name: '@lang('superadmin::app.settings.themes.edit.active')',
                                    },
                                    {
                                        id: '0',
                                        name: '@lang('superadmin::app.settings.themes.edit.inactive')',
                                    },
                                ],
                            },
                        ],
