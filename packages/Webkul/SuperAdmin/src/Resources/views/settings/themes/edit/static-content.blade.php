<v-static-content :errors="errors">
    <x-superadmin::shimmer.settings.themes.static-content />
</v-static-content>
...
@pushOnce('scripts')
                ...
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.themes.edit.static-content')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.settings.themes.edit.static-content-description')
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <label
                            ...
                            for="static_image"
                        >
                            @lang('superadmin::app.settings.themes.edit.add-image-btn')
                        </label>
                    ...
                    <div class="tabs">
                        <div class="mb-4 flex gap-4 border-b-2 pt-2 max-sm:hidden">
                            ...
                            <p @click="switchEditor('v-html-editor-theme', 1)">
                                ...
                                >
                                    @lang('superadmin::app.settings.themes.edit.html')
                                </div>
                            </p>
                            ...
                            <p @click="switchEditor('v-css-editor-theme', 0);">
                                ...
                                >
                                    @lang('superadmin::app.settings.themes.edit.css')
                                </div>
                            </p>
                            ...
                            <p @click="switchEditor('v-static-content-previewer', 0);">
                                ...
                                >
                                    @lang('superadmin::app.settings.themes.edit.preview')
                                </div>
                            </p>
                        </div>
                    </div>
    ...
    <script type="module">
        window.app.component('v-static-content', {
                ...
                storeImage($event) {
                    ...
                    if (! validFiles) {
                        this.$emitter.emit('add-flash', {
                            type: 'warning',
                            message: '@lang('superadmin::app.settings.themes.edit.image-upload-message')'
                        });
    ...
    <script type="module">
        window.app.component('v-html-editor-theme', {
            ...
            methods: {
                ...
                storeImage($event) {
                    ...
                    this.$axios.post('{{ route('superadmin.settings.themes.store') }}', formData)
                        .then((response) => {
    ...
    <script type="module">
        window.app.component('v-css-editor-theme', {
    ...
    <!-- Static Content Previewer -->
    <script type="module">
        window.app.component('v-static-content-previewer', {
