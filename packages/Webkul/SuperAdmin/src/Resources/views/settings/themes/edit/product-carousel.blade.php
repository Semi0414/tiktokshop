<v-product-carousel :errors="errors">
    <x-superadmin::shimmer.settings.themes.product-carousel />
</v-product-carousel>
...
@pushOnce('scripts')
        ...
        <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.themes.edit.product-carousel')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.settings.themes.edit.product-carousel-description')
                        </p>
                    </div>
                </div>

                <!-- Title -->
                <x-superadmin::form.control-group class="mb-2.5 pt-4">
                    <x-superadmin::form.control-group.label class="required">
                        @lang('superadmin::app.settings.themes.edit.filter-title')
                    ...
                    <v-field
                        ...
                        rules="required"
                        label="@lang('superadmin::app.settings.themes.edit.filter-title')"
                        placeholder="@lang('superadmin::app.settings.themes.edit.filter-title')"
                    >
                    </v-field>

                    <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[options][title]" />
                </x-superadmin::form.control-group>

                <!-- Sort -->
                <x-superadmin::form.control-group>
                    <x-superadmin::form.control-group.label class="required">
                        @lang('superadmin::app.settings.themes.edit.sort')
                    </x-superadmin::form.control-group.label>
                    ...
                    <v-field
                        ...
                        label="@lang('superadmin::app.settings.themes.edit.sort')"
                    >
                        <select
                            name="{{ $currentLocale->code }}[options][filters][sort]"
                            v-bind="field"
                        ...
                        >
                            <option value="" selected disabled>
                                @lang('superadmin::app.settings.themes.edit.select')
                            </option>
                    ...
                    <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[options][filters][sort]" />
                </x-superadmin::form.control-group>

                <!-- Limit -->
                <x-superadmin::form.control-group>
                    <x-superadmin::form.control-group.label class="required">
                        @lang('superadmin::app.settings.themes.edit.limit')
                    </x-superadmin::form.control-group.label>
                    ...
                    <v-field
                        ...
                        label="@lang('superadmin::app.settings.themes.edit.limit')"
                    >
                        <select
                        ...
                        >
                            <option value="" selected disabled>@lang('superadmin::app.settings.themes.edit.select')</option>
                    ...
                    <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[options][filters][limit]" />
                </x-superadmin::form.control-group>
                ...
                <div class="flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.themes.edit.filters')
                        </p>
                    </div>
                    ...
                    >
                        @lang('superadmin::app.settings.themes.edit.add-filter-btn')
                    </div>
                </div>
                    ...
                    >
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('superadmin::app.settings.themes.edit.key')".replace(':key', filter.key) }}
                                </p>

                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('superadmin::app.settings.themes.edit.value')".replace(':value', filter.value) }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            <p 
                                ...
                                @click="remove(filter)"
                            > 
                                @lang('superadmin::app.settings.themes.edit.delete')
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    <img
                        ...
                        alt="@lang('superadmin::app.settings.themes.edit.product-carousel')"
                    >
            ...
            >
                <form @submit="handleSubmit($event, addFilter)">
                    <x-superadmin::modal ref="productFilterModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.themes.edit.create-filter')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.settings.themes.edit.key-input')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    rules="required"
                                    :label="trans('superadmin::app.settings.themes.edit.key-input')"
                                ...
                                <x-superadmin::form.control-group.error control-name="key" />
                            </x-superadmin::form.control-group>

                            <!-- Value -->
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.settings.themes.edit.value-input')
                                </x-superadmin::form.control-group.label>
                                ...
                                <template v-if="filters.applied.type == 'select'">
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="value"
                                        rules="required"
                                        :label="trans('superadmin::app.settings.themes.edit.value-input')"
                                        :placeholder="trans('superadmin::app.settings.themes.edit.value-input')"
                                    >
                                        <option
                                ...
                                <x-superadmin::form.control-group.error control-name="value" />
                            </x-superadmin::form.control-group>
                        </x-slot>
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                ...
                                :title="trans('superadmin::app.settings.themes.edit.save-btn')"
                            />
                        </x-slot>
                    </x-superadmin::modal>
                </form>
    ...
    <script type="module">
        window.app.component('v-product-carousel', {
                        ...
                        available: [
                            {
                                ...
                                code: 'new',
                                type: 'select',
                                name: '@lang('superadmin::app.settings.themes.edit.new')',
                                options: [
                                    {
                                        'id': 0,
                                        'admin_name': '@lang('superadmin::app.settings.themes.edit.no')',
                                    },
                                    {
                                        'id': 1,
                                        'admin_name': '@lang('superadmin::app.settings.themes.edit.yes')',
                                    },
                                ],
                            },
                            {
                                ...
                                code: 'featured',
                                type: 'select',
                                name: '@lang('superadmin::app.settings.themes.edit.featured')',
                                options: [
                                    {
                                        'id': 0,
                                        'admin_name': '@lang('superadmin::app.settings.themes.edit.no')',
                            ...
                            },
                            {
                                ...
                                code: 'category_id',
                                type: 'text',
                                name: '@lang('superadmin::app.settings.themes.edit.category-id')',
                            },
