<v-services-content :errors="errors">
    <x-superadmin::shimmer.settings.themes.services-content />
</v-services-content>
...
@pushOnce('scripts')
    ...
    >
        <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.themes.edit.services-content.services')
                        </p>
                        
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.settings.themes.edit.services-content.service-info')
                        </p>
                    </div>
                    ...
                    <div class="flex gap-2.5">
                        <div
                            ...
                            @click="add"
                        >
                            @lang('superadmin::app.settings.themes.edit.services-content.add-btn')
                        </div>
                    </div>
                </div>
                    ...
                    >
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                <p class="text-gray-600 dark:text-gray-300">
                                    <div> 
                                        @lang('superadmin::app.settings.themes.edit.services-content.title'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    <div> 
                                        @lang('superadmin::app.settings.themes.edit.services-content.description'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('superadmin::app.settings.themes.edit.services-content.service-icon'): 
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            <div class="flex items-center gap-x-5">
                                ...
                                > 
                                    @lang('superadmin::app.settings.themes.edit.edit')
                                </p>
                                ...
                                > 
                                    @lang('superadmin::app.settings.themes.edit.services-content.delete')
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <img
                        ...
                        alt="@lang('superadmin::app.settings.themes.edit.services-content.services')"
                    >
            ...
            >
                ...
                >
                    <x-superadmin::modal ref="addServiceModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                ...
                                <template v-else>
                                    @lang('superadmin::app.settings.themes.edit.services-content.update-service')
                                </template>
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.settings.themes.edit.services-content.title')"
                                    :placeholder="trans('superadmin::app.settings.themes.edit.services-content.title')"
                                />

                                <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[title]" />
                            </x-superadmin::form.control-group>
                            ...
                            <x-superadmin::form.control-group>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.settings.themes.edit.services-content.description')"
                                    :placeholder="trans('superadmin::app.settings.themes.edit.services-content.description')"
                                />
                            ...
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.settings.themes.edit.services-content.service-icon-class')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.settings.themes.edit.services-content.service-icon-class')"
                                    :placeholder="trans('superadmin::app.settings.themes.edit.services-content.service-icon-class')"
                                />

                                <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[service_icon]" />
                            </x-superadmin::form.control-group>
                        </x-slot>
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                ...
                                :title="trans('superadmin::app.settings.themes.edit.services-content.save-btn')"
                            />
                        </x-slot>
                    </x-superadmin::modal>
                </form>
    ...
    <script type="module">
        window.app.component('v-services-content', {
