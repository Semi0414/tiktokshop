<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.settings.data-transfer.imports.import.title')
    </x-slot>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            ...
            >
                @lang('superadmin::app.settings.data-transfer.imports.import.back-btn')
            </a>

            <!-- Save Button -->
            <a
                href="{{ route('superadmin.settings.data_transfer.imports.edit', $import->id) }}"
                class="primary-button"
            >
                @lang('superadmin::app.settings.data-transfer.imports.import.edit-btn')
            </a>
        </div>
    </div>
            ...
            <div class="box-shadow mt-3.5 grid gap-2.5 p-5 max-xl:flex-wrap">
                ...
                >
                    <p class="flex items-center gap-2">
                        ...
                        @lang('superadmin::app.settings.data-transfer.imports.import.validate-info')
                    </p>
                    ...
                    <button
                        ...
                        @click="validate"
                    >
                        @lang('superadmin::app.settings.data-transfer.imports.import.validate')
                    </button>
                </div>
                ...
                >
                    <p class="flex items-center gap-2">
                        ...
                        @lang('superadmin::app.settings.data-transfer.imports.import.validating-info')
                ...
                >
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            @lang('superadmin::app.settings.data-transfer.imports.import.validation-success-info')
                        </p>
                        ...
                        >
                            ...
                            @lang('superadmin::app.settings.data-transfer.imports.import.validation-failed-info')
                        </p>
                        ...
                        <p class="flex items-center gap-2 dark:text-white">
                            ...
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.data-transfer.imports.import.total-rows-processed')
                            </span>
                        ...
                        <p class="flex items-center gap-2 dark:text-white">
                            ...
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.data-transfer.imports.import.total-invalid-rows')
                            </span>
                        ...
                        <p class="flex items-center gap-2 dark:text-white">
                            ...
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.settings.data-transfer.imports.import.total-errors')
                            </span>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a
                            class="primary-button place-self-start"
                            href="{{ route('superadmin.settings.data_transfer.imports.download_error_report', $import->id) }}"
                            target="_blank"
                            v-if="importResource.error_file_path && importResource.errors_count"
                        >
                            @lang('superadmin::app.settings.data-transfer.imports.import.download-error-report')
                        </a>
                    </div>
                </div>
                ...
                >
                    <p class="flex items-center gap-2">
                        ...
                        @lang('superadmin::app.settings.data-transfer.imports.import.importing-info')
                    </p>
                    ...
                    <p class="flex items-center gap-2">
                        <span class="font-medium text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.data-transfer.imports.import.progress')
                        </span>
                    ...
                    <p class="flex items-center gap-2">
                        <span class="font-medium text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.data-transfer.imports.import.total-batches')
                        </span>
                    ...
                    <p class="flex items-center gap-2">
                        <span class="font-medium text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.data-transfer.imports.import.completed-batches')
                        </span>
                    ...
                    <p class="flex items-center gap-2">
                        <span class="font-medium text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.data-transfer.imports.import.total-created')
                        </span>
                    ...
                    <p class="flex items-center gap-2">
                        <span class="font-medium text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.data-transfer.imports.import.total-updated')
                        </span>
                    ...
                    <p class="flex items-center gap-2">
                        <span class="font-medium text-gray-800 dark:text-white">
                            @lang('superadmin::app.settings.data-transfer.imports.import.total-deleted')
                        </span>
                ...
                >
                    <p class="flex items-center gap-2">
                        ...
                        @lang('superadmin::app.settings.data-transfer.imports.import.linking-info')
                    </p>
                ...
                >
                    ...
                    <p class="flex items-center gap-2">
                        ...
                        @lang('superadmin::app.settings.data-transfer.imports.import.indexing-info')
                    </p>
                ...
                >
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            @lang('superadmin::app.settings.data-transfer.imports.import.imported-info')
                        </p>
            ...
            window.app.component('v-import', {
                ...
                methods: {
                    validate() {
                        ...
                        this.$axios.get("{{ route('superadmin.settings.data_transfer.imports.validate', $import->id) }}")
                            .then((response) => {
                    ...
                    start() {
                        ...
                        this.$axios.get("{{ route('superadmin.settings.data_transfer.imports.start', $import->id) }}")
                            .then((response) => {
                                this.importResource = response.data.import;
                    ...
                    link() {
                        this.$axios.get("{{ route('superadmin.settings.data_transfer.imports.link', $import->id) }}")
                            .then((response) => {
                                this.importResource = response.data.import;
                    ...
                    index() {
                        this.$axios.get("{{ route('superadmin.settings.data_transfer.imports.index_data', $import->id) }}")
                            .then((response) => {
                                this.importResource = response.data.import;
                    ...
                    getStats() {
                        ...
                        this.$axios.get("{{ route('superadmin.settings.data_transfer.imports.stats', $import->id) }}/" + state)
                            .then((response) => {
                                this.importResource = response.data.import;
