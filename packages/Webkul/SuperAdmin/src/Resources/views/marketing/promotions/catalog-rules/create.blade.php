<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.marketing.promotions.catalog-rules.create.title')
    </x-slot>

    {!! view_render_event('bagisto.admin.marketing.promotions.catalog_rules.create.before') !!}

    <x-superadmin::form
        :action="route('superadmin.marketing.promotions.catalog_rules.store')"
    ...
    >
        ...
        <div class="mt-3 flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.marketing.promotions.catalog-rules.create.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.marketing.promotions.catalog-rules.create.save-btn')
                </button>
            </div>
        </div>
    ...
    @pushOnce('scripts')
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.marketing.promotions.catalog-rules.create.general')
                        </p>

                        <!-- Name -->
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.create.name')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                :value="old('name')"
                                :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.name')"
                                :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.create.name')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.marketing.promotions.catalog-rules.create.description')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.description')"
                                :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.create.description')"
                            />
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <div class="flex items-center justify-between gap-4">
                            <p class="text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.create.conditions')
                            </p>
                            ...
                            <x-superadmin::form.control-group class="!mb-0">
                                ...
                                >
                                    <option value="1">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.all-conditions-true')
                                    </option>

                                    <option value="2">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.any-conditions-true')
                                    </option>
                                </x-superadmin::form.control-group.control>
                        ...
                        <div
                            ...
                            @click="addCondition"
                        >
                            @lang('superadmin::app.marketing.promotions.catalog-rules.create.add-condition')
                        </div>
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <div class="grid gap-1.5">
                            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.create.actions')
                            </p>
                            ...
                            <div class="flex gap-4 max-sm:flex-wrap">
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.action-type')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    >
                                        ...
                                        >
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.create.percentage-product-price')
                                        </option>
                                        ...
                                        >
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.create.fixed-amount')
                                        </option>
                                    </x-superadmin::form.control-group.control>
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.discount-amount')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.discount-amount')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label>
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.end-other-rules')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.end-other-rules')"
                                    >
                                        <option
                                            value="0"
                                            {{ ! old('end_other_rules') ? 'selected' : '' }}
                                        >
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.create.no')
                                        </option>
                                        ...
                                        <option
                                            ...
                                            {{ old('end_other_rules') ? 'selected' : '' }}
                                        >
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.create.yes')
                                        </option>
                                    </x-superadmin::form.control-group.control>
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    <x-superadmin::accordion>
                        <x-slot:header>
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.create.settings')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label>
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.create.priority')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.priority')"
                                    :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.create.priority')"
                                />
                            ...
                            <div class="mb-4">
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.create.channels')
                                </x-superadmin::form.control-group.label>
                                ...
                                @foreach(core()->getAllChannels() as $channel)
                                    <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.channels')"
                            ...
                            <div class="mb-4">
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.create.customer-groups')
                                </x-superadmin::form.control-group.label>
                                ...
                                @foreach(app('Webkul\Customer\Repositories\CustomerGroupRepository')->all() as $customerGroup)
                                    <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.customer-groups')"
                            ...
                            <x-superadmin::form.control-group class="!mb-0">
                                <x-superadmin::form.control-group.label>
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.create.status')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    name="status"
                                    value="1"
                                    :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.status')"
                                />
                    ...
                    <x-superadmin::accordion>
                        <x-slot:header>
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.create.marketing-time')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="flex gap-4">
                                ...
                                <x-superadmin::form.control-group class="!mb-0">
                                    <x-superadmin::form.control-group.label>
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.from')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.from')"
                                        :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.create.from')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="!mb-0">
                                    <x-superadmin::form.control-group.label>
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.create.to')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="ends_till"
                                        :value="old('ends_till')"
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.create.to')"
                                        :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.create.to')"
                                    />
        ...
        <script type="module">
            window.app.component('v-catalog-rule-create-form', {
        ...
        >
            <div class="mt-4 flex justify-between gap-4">
                <div class="flex flex-1 gap-4 max-sm:flex-1 max-sm:flex-wrap">
                    ...
                    >
                        <option value="">@lang('superadmin::app.marketing.promotions.catalog-rules.create.choose-condition-to-add')</option>
                        ...
                        <div v-else>
                            ...
                            >
                                <v-field
                                    ...
                                    label="@lang('superadmin::app.marketing.promotions.catalog-rules.create.conditions')"
                ...
                data() {
                    return {
                        ...
                        conditionOperators: {
                            'price': [{
                                    'operator': '==',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.is-equal-to')"
                                }, {
                                    'operator': '!=',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.is-not-equal-to')"
                                }, {
                                    'operator': '>=',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.equals-or-greater-than')"
                                }, {
                                    'operator': '<=',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.equals-or-less-than')"
                                }, {
                                    'operator': '>',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.greater-than')"
                                }, {
                                    'operator': '<',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.less-than')"
                                }],
                            'decimal': [{
                                    'operator': '==',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.is-equal-to')"
                            ...
                            'text': [{
                                    ...
                                    'operator': '{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.contain')"
                                }, {
                                    'operator': '!{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.does-not-contain')"
                                }],
                            'boolean': [{
                                    'operator': '==',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.is-equal-to')"
                            ...
                            'multiselect': [{
                                    'operator': '{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.contains')"
                                }, {
                                    'operator': '!{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.create.does-not-contain')"
                                }],
