<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.title')
    </x-slot>

    {!! view_render_event('bagisto.admin.marketing.promotions.catalog_rules.edit.before', ['catalogRule' => $catalogRule]) !!}

    <x-superadmin::form
        :action="route('superadmin.marketing.promotions.catalog_rules.update', $catalogRule->id)"
        method="PUT"
    ...
    >
        ...
        <div class="mt-3 flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                <!-- Back Button -->
                <a
                    href="{{ route('superadmin.marketing.promotions.catalog_rules.index') }}"
                    class="transparent-button hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800"
                >
                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.save-btn')
                </button>
            </div>
        </div>
        ...
        <v-catalog-rule-edit-form>
            <!-- Shimmer Effect -->
            <x-superadmin::shimmer.marketing.promotions.catalog-rules />
        </v-catalog-rule-edit-form>
    ...
    @pushOnce('scripts')
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.marketing.promotions.catalog-rules.edit.general')
                        </p>

                        <!-- Name -->
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.edit.name')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.name')"
                                :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.edit.name')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.marketing.promotions.catalog-rules.edit.description')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.description')"
                                :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.edit.description')"
                            />
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <div class="flex items-center justify-between gap-4">
                            <p class="text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.edit.conditions')
                            </p>
                            ...
                            <x-superadmin::form.control-group class="!mb-0">
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.promotions.catalog-rules.condition-type')"
                                    :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.condition-type')"
                                >
                                    <option value="1">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.all-conditions-true')
                                    </option>

                                    <option value="2">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.any-conditions-true')
                                    </option>
                                </x-superadmin::form.control-group.control>
                        ...
                        <div
                            ...
                            @click="addCondition"
                        >
                            @lang('superadmin::app.marketing.promotions.catalog-rules.edit.add-condition')
                        </div>
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <div class="grid gap-1.5">
                            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.marketing.promotions.catalog-rules.edit.actions')
                            </p>
                            ...
                            <div class="flex gap-4 max-sm:flex-wrap">
                                <div class="w-full">
                                    ...
                                    <x-superadmin::form.control-group>
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.edit.action-type')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.action-type')"
                                        >
                                            <option
                                                value="by_percent"
                                                {{ $selectedOption == 'by_percent' ? 'selected' : '' }}
                                            >
                                                @lang('superadmin::app.marketing.promotions.catalog-rules.edit.percentage-product-price')
                                            </option>
                                            ...
                                            >
                                                @lang('superadmin::app.marketing.promotions.catalog-rules.edit.fixed-amount')
                                            </option>
                                        </x-superadmin::form.control-group.control>
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.discount-amount')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.discount-amount')"
                                        :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.edit.discount-amount')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label>
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.end-other-rules')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.end-other-rules')"
                                    >
                                        <option
                                            value="0"
                                            {{ ! $selectedOption ? 'selected' : '' }}
                                        >
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.edit.no')
                                        </option>
                                        ...
                                        <option
                                            ...
                                            {{ $selectedOption ? 'selected' : '' }}
                                        >
                                            @lang('superadmin::app.marketing.promotions.catalog-rules.edit.yes')
                                        </option>
                                    </x-superadmin::form.control-group.control>
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    <x-superadmin::accordion>
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.settings')
                                </p>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label>
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.priority')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.priority')"
                                    :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.edit.priority')"
                                />
                            ...
                            <div class="mb-4">
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.channels')
                                </x-superadmin::form.control-group.label>
                                ...
                                @foreach(core()->getAllChannels() as $channel)
                                    <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.channels')"
                            ...
                            <div class="mb-4">
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.customer-groups')
                                </x-superadmin::form.control-group.label>
                                ...
                                @foreach(app('Webkul\Customer\Repositories\CustomerGroupRepository')->all() as $customerGroup)
                                    <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5">
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.customer-groups')"
                            ...
                            <x-superadmin::form.control-group class="!mb-0">
                                <x-superadmin::form.control-group.label>
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.status')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.status')"
                    ...
                    <x-superadmin::accordion>
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.marketing.promotions.catalog-rules.edit.marketing-time')
                                </p>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="flex gap-4">
                                ...
                                <x-superadmin::form.control-group class="!mb-0">
                                    <x-superadmin::form.control-group.label>
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.from')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.from')"
                                        :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.edit.from')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="!mb-0">
                                    <x-superadmin::form.control-group.label>
                                        @lang('superadmin::app.marketing.promotions.catalog-rules.edit.to')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.promotions.catalog-rules.edit.to')"
                                        :placeholder="trans('superadmin::app.marketing.promotions.catalog-rules.edit.to')"
                                    />
        ...
        <script type="module">
            window.app.component('v-catalog-rule-edit-form', {
        ...
        >
            <div class="mt-4 flex justify-between gap-4">
                <div class="flex flex-1 gap-4 max-sm:flex-1 max-sm:flex-wrap">
                    ...
                    >
                        <option value="">@lang('superadmin::app.marketing.promotions.catalog-rules.edit.choose-condition-to-add')</option>
                        ...
                        <div v-else>
                            ...
                            >
                                <v-field
                                    ...
                                    label="@lang('superadmin::app.marketing.promotions.catalog-rules.edit.conditions')"
        ...
        <script type="module">
            window.app.component('v-catalog-rule-condition-item', {
                ...
                data() {
                    return {
                        ...
                        conditionOperators: {
                            'price': [{
                                    'operator': '==',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.is-equal-to')"
                                }, {
                                    'operator': '!=',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.is-not-equal-to')"
                                }, {
                                    'operator': '>=',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.equals-or-greater-than')"
                                }, {
                                    'operator': '<=',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.equals-or-less-than')"
                                }, {
                                    'operator': '>',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.greater-than')"
                                }, {
                                    'operator': '<',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.less-than')"
                                }],
                            'decimal': [{
                                    'operator': '==',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.is-equal-to')"
                            ...
                            'text': [{
                                    ...
                                    'operator': '{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.contain')"
                                }, {
                                    'operator': '!{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.does-not-contain')"
                                }],
                            'boolean': [{
                                    'operator': '==',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.is-equal-to')"
                            ...
                            'multiselect': [{
                                    'operator': '{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.contains')"
                                }, {
                                    'operator': '!{}',
                                    'label': "@lang('superadmin::app.marketing.promotions.catalog-rules.edit.does-not-contain')"
                                }],
