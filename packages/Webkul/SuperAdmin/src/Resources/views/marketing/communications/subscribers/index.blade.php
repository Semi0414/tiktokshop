<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.marketing.communications.subscribers.index.title')
    </x-slot>
    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                <x-superadmin::datagrid.ssr :datagrid-payload="$datagridPayload" :src="route('superadmin.marketing.communications.subscribers.index')"
                    ref="datagrid"
                >
                    <template #body="{
                        isLoading,
                        ...
                        <x-superadmin::modal ref="groupCreateModal">
                            ...
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.marketing.communications.subscribers.index.edit.title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                ...
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.communications.subscribers.index.edit.email')
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.communications.subscribers.index.edit.email')"
                                        disabled
                                    />
                                ...
                                <x-superadmin::form.control-group class="!mb-0">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.communications.subscribers.index.edit.subscribed')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.marketing.communications.subscribers.index.edit.subscribed')"
                                    >
                                        @foreach (['true', 'false'] as $state)
                                            <option
                                                value="{{ $state == 'true' ? 1 : 0 }}"
                                            >
                                                @lang('superadmin::app.marketing.communications.subscribers.index.edit.' . $state)
                                            </option>
                                        @endforeach
                                    </x-superadmin::form.control-group.control>

                                    <x-superadmin::form.control-group.error control-name="is_subscribed" />
                                </x-superadmin::form.control-group>
                            </x-slot>
                            ...
                            <x-slot:footer>
                                ...
                                <x-superadmin::button
                                    ...
                                    :title="trans('superadmin::app.marketing.communications.subscribers.index.edit.save-btn')"
                                    ::loading="isLoading"
                                    ::disabled="isLoading"
                                />
                            </x-slot>
        ...
        <script type="module">
            window.app.component('v-subscribers', {
                ...
                methods: {
                    update(params, { resetForm, setErrors  }) {
                        ...
                        this.$axios.post("{{ route('superadmin.marketing.communications.subscribers.update') }}", formData)
                        .then((response) => {
