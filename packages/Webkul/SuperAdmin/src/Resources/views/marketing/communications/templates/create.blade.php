<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.marketing.communications.templates.create.title')
    </x-slot>

    {!! view_render_event('bagisto.admin.marketing.communications.templates.create.before') !!}

    <!-- Input Form -->
    <x-superadmin::form :action="route('superadmin.marketing.communications.email_templates.store')">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.marketing.communications.templates.create.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.marketing.communications.templates.create.save-btn')
                </button>
            </div>
        </div>
                    ...
                    <div class="mb-2.5">
                        ...
                        <x-superadmin::form.control-group>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                :value="old('content')"
                                :label="trans('superadmin::app.marketing.communications.templates.create.content')"
                                :placeholder="trans('superadmin::app.marketing.communications.templates.create.content')"
                                :tinymce="true"
                            />
                    ...
                    <x-superadmin::accordion>
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.marketing.communications.templates.create.general')
                                </p>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="mb-2.5 w-full">
                                ...
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.communications.templates.create.name')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        rules="required"
                                        :value="old('name')"
                                        :label="trans('superadmin::app.marketing.communications.templates.create.name')"
                                        :placeholder="trans('superadmin::app.marketing.communications.templates.create.name')"
                                    />
                                ...
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.marketing.communications.templates.create.status')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="status"
                                        rules="required"
                                        :label="trans('superadmin::app.marketing.communications.templates.create.status')"
                                    >
                                        <!-- Default Option -->
                                        <option value="">
                                            @lang('superadmin::app.marketing.communications.templates.create.select-status')
                                        </option>
                                        ...
                                        @foreach (['active', 'inactive', 'draft'] as $state)
                                            ...
                                            >
                                                @lang('superadmin::app.marketing.communications.templates.create.' . $state)
                                            </option>
                                        @endforeach
                                    </x-superadmin::form.control-group.control>
