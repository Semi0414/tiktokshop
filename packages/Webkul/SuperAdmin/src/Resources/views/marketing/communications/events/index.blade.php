<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.marketing.communications.events.index.title')
    </x-slot>
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                @if (bouncer()->hasPermission('marketing.communications.events.create'))
                    <div class="primary-button">
                        @lang('superadmin::app.marketing.communications.events.index.create-btn')
                    </div>
                @endif
            </div>
        </div>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            <x-superadmin::datagrid.ssr :datagrid-payload="$datagridPayload" :src="route('superadmin.marketing.communications.events.index')"
                ref="datagrid"
            >
                <template #body="{
                    isLoading,
                                    ...
                                    @if (bouncer()->hasPermission('marketing.communications.events.edit'))
                                        <a @click="id=1; editModal(record.actions.find(action => action.index === 'edit')?.url)">
                                            <span
                                                ...
                                                :title="record.actions.find(action => action.title === '@lang('superadmin::app.marketing.communications.events.index.datagrid.edit')')?.title"
                                            >
                                            </span>
                                        </a>
                                    @endif
                                    ...
                                    @if (bouncer()->hasPermission('marketing.communications.events.delete'))
                                        <a @click="performAction(record.actions.find(action => action.index === 'delete'))">
                                            <span
                                                ...
                                                class="cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-200 dark:hover:bg-gray-800 max-sm:place-self-center"
                                                :title="record.actions.find(action => action.title === '@lang('superadmin::app.marketing.communications.events.index.datagrid.delete')')?.title"
                                            >
                                            </span>
                                        </a>
                                    @endif
            ...
            >
                ...
                >
                    ...
                    <x-superadmin::modal ref="emailEvents">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p
                                ...
                                v-if="selectedEvents"
                            >
                                @lang('superadmin::app.marketing.communications.events.index.create.title')
                            </p>
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.communications.events.index.create.name')
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.communications.events.index.create.name')"
                                    :placeholder="trans('superadmin::app.marketing.communications.events.index.create.name')"
                                />
                            ...
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.communications.events.index.create.description')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.communications.events.index.create.description')"
                                />
                            ...
                            <x-superadmin::form.control-group class="!mb-0">
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.marketing.communications.events.index.create.date')
                                </x-superadmin::form.control-group.label>
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.marketing.communications.events.index.create.date')"
                                    :placeholder="trans('superadmin::app.marketing.communications.events.index.create.date')"
                                />

                                <x-superadmin::form.control-group.error control-name="date" />
                            </x-superadmin::form.control-group>
                        </x-slot>
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                button-type="button"
                                class="primary-button"
                                :title="trans('superadmin::app.marketing.communications.events.index.create.save-btn')"
                                ::loading="isLoading"
                                ::disabled="isLoading"
                            />
                        </x-slot>
            ...
            window.app.component('v-events', {
                ...
                methods: {
                    updateOrCreate(params, { resetForm, setErrors }) {
                        ...
                        this.$axios.post(params.id ? "{{ route('superadmin.marketing.communications.events.update')}}" : "{{ route('superadmin.marketing.communications.events.store') }}", formData)
                            .then((response) => {
