...
<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.cms.edit.title')
    </x-slot>

    <x-superadmin::form
        :action="route('superadmin.cms.update', $page->id)"
        method="PUT"
    ...
    >
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.cms.edit.back-btn')
                </a>
                ...
                @if ($page->translate($currentLocale->code))
                    <a
                        ...
                        target="_blank"
                    >
                        @lang('superadmin::app.cms.edit.preview-btn')
                    </a>
                @endif
                ...
                >
                    @lang('superadmin::app.cms.edit.save-btn')
                </button>
            </div>
        </div>
        ...
        <div class="mt-7 flex items-center justify-between gap-4 max-md:flex-wrap">
          ...
          <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-superadmin::form.control-group class="!mb-0">
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.cms.edit.content')"
                            :placeholder="trans('superadmin::app.cms.edit.content')"
                            :tinymce="true"
                            :prompt="core()->getConfigData('general.magic_ai.content_generation.cms_page_content_prompt')"
                        />

                        <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[html_content]" />
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.cms.edit.seo')
                    </p>
                    ...
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.cms.edit.meta-title')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.cms.edit.meta-title')"
                            :placeholder="trans('superadmin::app.cms.edit.meta-title')"
                        />

                        <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[meta_title]" />
                    </x-superadmin::form.control-group>

                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.cms.edit.url-key')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.cms.edit.url-key')"
                            :placeholder="trans('superadmin::app.cms.edit.url-key')"
                        />

                        <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[url_key]" />
                    </x-superadmin::form.control-group>

                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.cms.edit.meta-keywords')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.cms.edit.meta-keywords')"
                            :placeholder="trans('superadmin::app.cms.edit.meta-keywords')"
                        />

                        <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[meta_keywords]" />
                    </x-superadmin::form.control-group>

                    <x-superadmin::form.control-group class="!mb-0">
                        <x-superadmin::form.control-group.label>
                            @lang('superadmin::app.cms.edit.meta-description')
                        </x-superadmin::form.control-group.label>
                        ...
                        <x-superadmin::form.control-group.control
                            ...
                            :label="trans('superadmin::app.cms.edit.meta-description')"
                            :placeholder="trans('superadmin::app.cms.edit.meta-description')"
                        />

                        <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[meta_description]" />
                    </x-superadmin::form.control-group>
                </div>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                <x-superadmin::accordion>
                    ...
                    <x-slot:content>
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.cms.edit.page-title')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.cms.edit.page-title')"
                                :placeholder="trans('superadmin::app.cms.edit.page-title')"
                            />

                            <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[page_title]" />
                        </x-superadmin::form.control-group>
