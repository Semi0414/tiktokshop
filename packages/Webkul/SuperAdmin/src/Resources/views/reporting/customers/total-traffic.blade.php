...
<v-reporting-customers-total-traffic>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.customers.total-traffic /> 
</v-reporting-customers-total-traffic>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.customers.index.customers-traffic')
                    </p>
                </div>
                ...
                <div class="grid gap-4">
                    <div class="flex justify-between gap-4">
                        ...
                        <div class="grid gap-1">
                            ...
                            <p class="text-xs font-semibold leading-none text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.reporting.customers.index.total-visitors')
                            </p>
                        ...
                        <div class="grid gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.reporting.customers.index.unique-visitors')
                            </p>
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.customers.index.traffic-over-week')
                    </p>
        ...
        window.app.component('v-reporting-customers-total-traffic', {
            ...
            methods: {
                getStats(filters) {
                    ...
                    this.$axios.get("{{ route('superadmin.reporting.customers.stats') }}", {
                            params: filters
                        })
                        .then(response => {
