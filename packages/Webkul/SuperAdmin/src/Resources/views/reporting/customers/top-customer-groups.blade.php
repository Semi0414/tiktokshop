...
<v-reporting-customers-top-customer-groups>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.customers.top-customer-groups />
</v-reporting-customers-top-customer-groups>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.customers.index.top-customer-groups')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.customers.view', ['type' => 'top-customer-groups']) }}"
