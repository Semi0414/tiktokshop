<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.reporting.products.index.title')
    </x-slot>
    ...
    <div class="flex flex-1 flex-col gap-4 max-xl:flex-auto">
        ...
        <div class="flex flex-col justify-between gap-4 flex-1 [&>*]:flex-1 md:flex-row">
            ...
            @include('superadmin::reporting.products.sold-quantities')

            <!-- Products Added to Wishlist Section -->
            @include('superadmin::reporting.products.wishlist-products')
        </div>
        ...
        <div class="flex flex-col justify-between gap-4 flex-1 [&>*]:flex-1 md:flex-row">
            ...
            @include('superadmin::reporting.products.top-selling-by-revenue')

            <!-- Top Selling Products By Quantity Section -->
            @include('superadmin::reporting.products.top-selling-by-quantity')
        </div>

        <!-- Products With Most Reviews and Products With Most Visits Sections Container -->
        <div class="flex flex-col justify-between gap-4 flex-1 [&>*]:flex-1 md:flex-row">
            <!-- Products With Most Reviews Section -->
            @include('superadmin::reporting.products.most-reviews')

            <!-- Products With Most Visits Section -->
            @include('superadmin::reporting.products.most-visits')
        </div>

        <!-- Last Search Terms and Top Search Terms Sections Container -->
        <div class="flex flex-col justify-between gap-4 flex-1 [&>*]:flex-1 md:flex-row">
            <!-- Last Search Terms Section -->
            @include('superadmin::reporting.products.last-search-terms')

            <!-- Top Search Terms Section -->
            @include('superadmin::reporting.products.top-search-terms')
        </div>
    </div>
            ...
            <div class="flex gap-1.5">
                ...
                <x-superadmin::flat-picker.date class="!w-[140px]" ::allow-input="false">
                    <input
                        ...
                        placeholder="@lang('superadmin::app.reporting.products.index.start-date')"
                    />
                ...
                <x-superadmin::flat-picker.date class="!w-[140px]" ::allow-input="false">
                    <input
                        class="flex min-h-[39px] w-full rounded-md border px-3 py-2 text-sm text-gray-600 transition-all hover:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400"
                        v-model="filters.end"
                        placeholder="@lang('superadmin::app.reporting.products.index.end-date')"
                    />
                </x-superadmin::flat-picker.date>
            </div>
        </script>
            ...
            window.app.component('v-reporting-filters', {
                ...
                data() {
                    return {
                        channels: [
                            {
                                name: "@lang('superadmin::app.reporting.products.index.all-channels')",
                                code: ''
                            },
