...
<v-reporting-products-top-search-terms>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.products.top-search-terms />
</v-reporting-products-top-search-terms>
...
@pushOnce('scripts')
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.products.index.top-search-terms')
                    </p>
                </div>
    ...
    <script type="module">
        window.app.component('v-reporting-products-top-search-terms', {
