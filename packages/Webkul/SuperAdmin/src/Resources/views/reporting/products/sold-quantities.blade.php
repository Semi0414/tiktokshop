...
<v-reporting-products-total-sold-quantity>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.products.sold-quantities />
</v-reporting-products-total-sold-quantity>
...
@pushOnce('scripts')
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.products.index.total-sold-quantities')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.products.view', ['type' => 'total-sold-quantities']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.products.index.quantities-sold-over-time')
                    </p>
    ...
    <script type="module">
        window.app.component('v-reporting-products-total-sold-quantity', {
