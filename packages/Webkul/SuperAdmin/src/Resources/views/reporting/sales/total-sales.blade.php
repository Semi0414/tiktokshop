...
<v-reporting-sales-total-sales>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.sales.total-sales />
</v-reporting-sales-total-sales>
            ...
            <div class="box-shadow relative rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.sales.index.total-sales')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.sales.view', ['type' => 'total-sales']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.sales.index.sales-over-time')
                    </p>
