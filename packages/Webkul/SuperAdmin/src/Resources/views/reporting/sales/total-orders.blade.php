...
<v-reporting-sales-total-orders>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.sales.total-orders /> 
</v-reporting-sales-total-orders>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.sales.index.total-orders')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.sales.view', ['type' => 'total-orders']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.sales.index.orders-over-time')
                    </p>
