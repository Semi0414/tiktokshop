...
<v-reporting-sales-average-order-value>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.sales.average-order-value /> 
</v-reporting-sales-average-order-value>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.sales.index.average-sales')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.sales.view', ['type' => 'average-sales']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.sales.index.average-order-value-over-time')
                    </p>
