...
<v-reporting-sales-total-refunds>
    <x-superadmin::shimmer.reporting.sales.total-refunds />
</v-reporting-sales-total-refunds>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.sales.index.refunds')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.sales.view', ['type' => 'refunds']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.sales.index.refunds-over-time')
                    </p>
