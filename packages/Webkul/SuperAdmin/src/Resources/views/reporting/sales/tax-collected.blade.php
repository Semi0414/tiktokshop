...
<v-reporting-sales-tax-collected>
    <!-- Shimmer -->
    <x-superadmin::shimmer.reporting.sales.tax-collected />
</v-reporting-sales-tax-collected>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.sales.index.tax-collected')
                    </p>

                    <a
                        href="{{ route('superadmin.reporting.sales.view', ['type' => 'tax-collected']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.reporting.sales.index.tax-collected-over-time')
                    </p>
                    ...
                    <p class="py-2.5 text-base font-semibold text-gray-600 dark:text-white">
                        @lang('superadmin::app.reporting.sales.index.top-tax-categories')
                    </p>
