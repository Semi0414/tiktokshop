<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.sales.invoices.view.title', ['invoice_id' => $invoice->increment_id ?? $invoice->id])
    </x-slot>
    ...
    <div class="grid">
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                <!-- Back Button -->
                <a
                    href="{{ route('superadmin.sales.invoices.index') }}"
    ...
    <div class="flex items-center justify-between gap-4 mt-7 max-md:flex-wrap">
        <div class="flex flex-wrap items-center gap-x-1 gap-y-2">
            ...
            >
                ...
                @lang('superadmin::app.sales.invoices.view.print')
            </a>
            ...
            <div>
                ...
                >
                    ...
                    @lang('superadmin::app.sales.invoices.view.send-duplicate-invoice')
                </button>

                <x-superadmin::form :action="route('superadmin.sales.invoices.send_duplicate_email', $invoice->id)">
                    <!-- Create Group Modal -->
                    <x-superadmin::modal ref="groupCreateModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                        ...
                        <x-slot:content>
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.sales.invoices.view.email')
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.sales.invoices.view.email')"
                                />
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                ...
                                :title="trans('superadmin::app.sales.invoices.view.send')"
                            />
                        </x-slot>
                    </x-superadmin::modal>
                </x-superadmin::form>
    ...
    <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="flex flex-col flex-1 gap-2 max-xl:flex-auto">
            ...
            <div class="bg-white rounded box-shadow dark:bg-gray-900">
                <p class="p-4 mb-4 text-base font-semibold text-gray-800 dark:text-white">
                    @lang('superadmin::app.sales.invoices.view.invoice-items') ({{ count($invoice->items) }})
                </p>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('superadmin::app.sales.invoices.view.amount-per-unit', [
                                    ...
                                    <div class="flex flex-col place-items-start gap-1.5">
                                        ...
                                        <!--SKU -->
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.sku', ['sku' => $item->getTypeInstance()->getOrderedItem($item)->sku])
                                        </p>

                                        <!-- Quantity -->
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.qty', ['qty' => $item->qty])
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid gap-1 place-content-start">
                                ...
                                <div class="flex flex-col place-items-start items-end gap-1.5">
                                    @if (core()->getConfigData('sales.taxes.sales.display_prices') == 'including_tax')
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.price', ['price' => core()->formatBasePrice($item->base_price_incl_tax)])
                                        </p>
                                    @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.price-excl-tax', ['price' => core()->formatBasePrice($item->base_price)])
                                        </p>

                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.price-incl-tax', ['price' => core()->formatBasePrice($item->base_price_incl_tax)])
                                        </p>
                                    @else
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.price', ['price' => core()->formatBasePrice($item->base_price)])
                                        </p>
                                    @endif

                                    <!-- Item Tax Amount -->
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('superadmin::app.sales.invoices.view.tax', ['tax' => core()->formatBasePrice($item->base_tax_amount)])
                                    </p>

                                    <!-- Item Discount -->
                                    @if ($invoice->base_discount_amount > 0)
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.discount', ['discount' => core()->formatBasePrice($item->base_discount_amount)])
                                        </p>
                                    @endif
                                    ...
                                    @if (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'including_tax')
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.sub-total', ['sub_total' => core()->formatBasePrice($item->base_total_incl_tax)])
                                        </p>
                                    @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.sub-total-excl-tax', ['sub_total' => core()->formatBasePrice($item->base_total)])
                                        </p>

                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.sub-total-incl-tax', ['sub_total' => core()->formatBasePrice($item->base_total_incl_tax)])
                                        </p>
                                    @else
                                        <p class="text-gray-600 dark:text-gray-300">
                                            @lang('superadmin::app.sales.invoices.view.sub-total', ['sub_total' => core()->formatBasePrice($item->base_total)])
                                        </p>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="flex flex-col gap-y-1.5">
                        @if (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                            <p class="font-semibold !leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.sub-total-summary-excl-tax')
                            </p>

                            <p class="font-semibold !leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.sub-total-summary-incl-tax')
                            </p>
                        @else
                            <p class="font-semibold !leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.sub-total-summary')
                            </p>
                        @endif

                        @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                            <p class="!leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.shipping-and-handling-excl-tax')
                            </p>

                            <p class="!leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.shipping-and-handling-incl-tax')
                            </p>
                        @else
                            <p class="!leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.shipping-and-handling')
                            </p>
                        @endif

                        <p class="!leading-5 text-gray-600 dark:text-gray-300">
                            @lang('superadmin::app.sales.invoices.view.summary-tax')
                        </p>

                        @if ($invoice->base_discount_amount > 0)
                            <p class="!leading-5 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.invoices.view.summary-discount')
                            </p>
                        @endif

                        <p class="text-base font-semibold !leading-5 text-gray-800 dark:text-white">
                            @lang('superadmin::app.sales.invoices.view.grand-total')
                        </p>
                    </div>
        ...
        <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
            ...
            <x-superadmin::accordion>
                <x-slot:header>
                    <p class="p-2.5 text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.sales.invoices.view.customer')
                    </p>
                </x-slot>
                ...
                <x-slot:content v-pre>
                    <div class="flex flex-col {{ $order->billing_address ? 'pb-4' : ''}}">
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            @lang('superadmin::app.sales.invoices.view.customer-email', ['email' => $invoice->order->customer_email])
                        </p>
            ...
            <x-superadmin::accordion>
                <x-slot:header>
                    <p class="p-2.5 text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('superadmin::app.sales.invoices.view.order-information')
                    </p>
                </x-slot>
                    ...
                    <div class="flex justify-start w-full gap-5">
                        <div class="flex flex-col gap-y-1.5">
                            @foreach (['order-id', 'order-date', 'order-status', 'invoice-status', 'channel'] as $item)
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('superadmin::app.sales.invoices.view.' . $item)
                                </p>
                            @endforeach
                        </div>
                        ...
                        <div class="flex flex-col gap-y-1.5">
                            ...
                            <p class="font-semibold text-blue-600 transition-all hover:underline">
                                <a href="{{ route('superadmin.sales.orders.view', $order->id) }}">#{{ $order->increment_id }}</a>
                            </p>
