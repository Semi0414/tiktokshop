...
@pushOnce('scripts')
            ...
            <div class="p-4">
                <div class="my-5 flex items-center justify-between">
                    <p class="text-sm dark:text-white">
                        @lang('superadmin::app.sales.orders.create.types.simple.total-amount')
                    </p>
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            <label
                                ...
                                :for="'customizable_options[' + option.id + '][' + index + ']'"
                            >
                                @lang('superadmin::app.sales.orders.create.types.simple.none')
                            </label>
                        </div>
    ...
    <script type="module">
        window.app.component('v-simple-product-customizable-options', {
            ...
            methods: {
                getCustomizableOptions() {
                    ...
                    this.$axios.get("{{ route('superadmin.catalog.products.simple.customizable-options', ':replace') }}".replace(':replace', this.productOptions.product.id))
                        .then(response => {
        ...
        window.app.component('v-simple-product-customizable-option-item', {
