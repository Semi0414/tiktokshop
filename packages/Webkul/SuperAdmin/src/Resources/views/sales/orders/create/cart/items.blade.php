...
>
    ...
    <x-superadmin::shimmer.sales.orders.create.cart.items />
</v-cart-items>
...
@pushOnce('scripts')
        ...
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            <div class="flex justify-between p-4">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('superadmin::app.sales.orders.create.cart.items.title')
                </p>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <template v-else>
                        <p class="flex flex-col gap-1 text-base font-semibold text-gray-800 dark:text-white">
                            <template v-if="displayTax.subtotal == 'including_tax'">
                                @{{ "@lang('superadmin::app.sales.orders.create.cart.items.sub-total', ['sub_total' => 'replace'])".replace('replace', cart.formatted_sub_total_incl_tax) }}
                            </template>
                            ...
                            <template v-else-if="displayTax.subtotal == 'both'">
                                ...
                                <span class="text-xs font-normal">
                                    @lang('superadmin::app.sales.orders.create.cart.items.excl-tax')
                            ...
                            <template v-else>
                                @{{ "@lang('superadmin::app.sales.orders.create.cart.items.sub-total', ['sub_total' => 'replace'])".replace('replace', cart.formatted_sub_total) }}
                            </template>
                        </p>
                    </template>
                    ...
                    >
                        @lang('superadmin::app.sales.orders.create.cart.items.add-product')
                    </button>
                </div>
            </div>
            ...
            >
                ...
                >
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('superadmin::app.sales.orders.create.cart.items.sku', ['sku' => ':replace'])".replace(':replace', item.sku) }}
                                </p>

                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('superadmin::app.sales.orders.create.cart.items.amount-per-unit', ['amount' => ':replaceAmount', 'qty' => ':replaceQty'])".replace(':replaceAmount', item.formatted_price).replace(':replaceQty', item.quantity) }}
                                </p>
                                ...
                                >
                                    ...
                                    >
                                        @lang('superadmin::app.sales.orders.create.cart.items.see-details')
                    ...
                    <div class="flex justify-end gap-2.5">
                        ...
                        >
                            @lang('superadmin::app.sales.orders.create.cart.items.delete')
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('superadmin::app.sales.orders.create.cart.items.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('superadmin::app.sales.orders.create.cart.items.empty-description')
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <x-slot:header>
                    <div class="grid gap-5">
                        <p class="text-xl font-medium dark:text-white">
                            @lang('superadmin::app.sales.orders.create.cart.items.search.title')
                        </p>
                ...
                <x-slot:content class="!p-0">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    <template v-if="! product.images.length">
                                        ...
                                        <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                            @lang('superadmin::app.sales.orders.create.cart.items.search.product-image')
                                        </p>
                                    </template>
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @{{ "@lang('superadmin::app.sales.orders.create.cart.items.search.sku')".replace(':sku', product.sku) }}
                                    </p>

                                    <p class="text-green-600">
                                        @{{ "@lang('superadmin::app.sales.orders.create.cart.items.search.available-qty')".replace(':qty', availbleQty(product)) }}
                                    </p>
                                </div>
                            </div>
                                ...
                                <form @submit="handleSubmit($event, addToCart)">
                                    <div class="grid place-content-start gap-2 text-right">
                                        ...
                                        <x-superadmin::form.control-group class="!mb-0">
                                            <x-superadmin::form.control-group.label class="required justify-end">
                                                @lang('superadmin::app.sales.orders.create.cart.items.search.qty')
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                :label="trans('superadmin::app.sales.orders.create.cart.items.search.qty')"
                                                :placeholder="trans('superadmin::app.sales.orders.create.cart.items.search.qty')"
                                            />

                                            <x-superadmin::form.control-group.error name="qty" />
                                        ...
                                        >
                                            @lang('superadmin::app.sales.orders.create.cart.items.search.add-to-cart')
                                        </button>
                                    </div>
                                </form>
                            </x-superadmin::form>
                    ...
                    >
                        ...
                        <div class="flex flex-col items-center gap-1.5">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('superadmin::app.sales.orders.create.cart.items.search.empty-title')
                            </p>

                            <p class="text-gray-400">
                                @lang('superadmin::app.sales.orders.create.cart.items.search.empty-info')
                            </p>
                        </div>
                    </div>
                </x-slot>
    ...
    <script type="module">
        window.app.component('v-cart-items', {
            ...
            methods: {
                search() {
                    ...
                    this.$axios.get("{{ route('superadmin.catalog.products.search') }}", {
                            params: {
                ...
                removeItem(item) {
                    this.$emitter.emit('open-confirm-modal', {
                        agree: () => {
                            this.$axios.delete("{{ route('superadmin.sales.cart.items.destroy', $cart->id) }}", {
                                data: {
                ...
                updateItem(item, qty) {
                    ...
                    this.$axios.put("{{ route('superadmin.sales.cart.items.update', $cart->id) }}", params)
                        .then(response => {
