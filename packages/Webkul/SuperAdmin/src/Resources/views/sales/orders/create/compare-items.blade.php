...
@pushOnce('scripts')
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.sales.orders.create.compare-items.title')
                    </p>
                </div>
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                @{{ "@lang('superadmin::app.sales.orders.create.compare-items.sku', ['sku' => ':replace'])".replace(':replace', item.product.sku) }}
                            </p>
                            ...
                            <div class="mt-2 flex gap-2.5">
                                ...
                                >
                                    @lang('superadmin::app.sales.orders.create.compare-items.delete')
                                </button>
                                ...
                                >
                                    @lang('superadmin::app.sales.orders.create.compare-items.add-to-cart')
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('superadmin::app.sales.orders.create.compare-items.empty-title')
                        </p>
    
                        <p class="text-gray-400">
                            @lang('superadmin::app.sales.orders.create.compare-items.empty-description')
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script type="module">
        window.app.component('v-compare-items', {
            ...
            methods: {
                get() {
                    ...
                    this.$axios.get("{{ route('superadmin.customers.customers.compare.items', $cart->customer_id) }}")
                        .then(response => {
                ...
                removeItem(item) {
                    this.$emitter.emit('open-confirm-modal', {
                        agree: () => {
                            this.$axios.delete("{{ route('superadmin.customers.customers.compare.items.delete', $cart->customer_id) }}", {
                                data: {
                                    item_id: item.id
                                }
                            })
