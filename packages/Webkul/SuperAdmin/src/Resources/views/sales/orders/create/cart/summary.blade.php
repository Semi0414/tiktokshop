...
@pushOnce('scripts')
        ...
        >
            <div class="flex items-center border-b p-4 dark:border-gray-800">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('superadmin::app.sales.orders.create.cart.summary.title')
                </p>
            </div>
            ...
            <div class="grid w-full justify-end gap-2.5 border-b p-4 dark:border-gray-800">
                <div class="grid gap-4">
                    ...
                    <template v-if="displayTax.subtotal == 'including_tax'">
                        <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.summary.sub-total')
                            </p>
                    ...
                    <template v-else-if="displayTax.subtotal == 'both'">
                        <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.summary.sub-total-excl-tax')
                            </p>
                        ...
                        <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.summary.sub-total-incl-tax')
                            </p>
                    ...
                    >
                        <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                            @lang('superadmin::app.sales.orders.create.cart.summary.tax') (@{{ index }})
                        </p>
                    ...
                    <template v-if="displayTax.shipping == 'including_tax'">
                        <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.summary.shipping-amount')
                            </p>
                    ...
                    <template v-else-if="displayTax.shipping == 'both'">
                        <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.summary.shipping-amount-excl-tax')
                            </p>
                        ...
                        <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.summary.shipping-amount-incl-tax')
                            </p>
                    ...
                    >
                        <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                            @lang('superadmin::app.sales.orders.create.cart.summary.discount-amount')
                        </p>
                    ...
                    <div class="row grid grid-cols-2 grid-rows-1 justify-items-end gap-4 text-right">
                        <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                            @lang('superadmin::app.sales.orders.create.cart.summary.apply-coupon')
                        </p>
                    ...
                    <div class="row grid grid-cols-2 grid-rows-1 justify-between gap-4 text-right">
                        <p class="text-lg font-semibold dark:text-white">
                            @lang('superadmin::app.sales.orders.create.cart.summary.grand-total')
                        </p>
            ...
            >
                ...
                <form @submit="handleSubmit($event, applyCoupon)">
                    ...
                    <!-- Apply coupon modal -->
                    <x-superadmin::modal ref="couponModel">
                        <!-- Modal Header -->
                        ...
                        <x-slot:content>
                            <x-superadmin::form.control-group class="!mb-0">
                                <x-superadmin::form.control-group.control
                                    ...
                                    name="code"
                                    rules="required"
                                    :placeholder="trans('superadmin::app.sales.orders.create.cart.summary.enter-your-code')"
                                />
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                ...
                                :title="trans('superadmin::app.sales.orders.create.cart.summary.apply-coupon')"
                                ::loading="isLoading"
                                ::disabled="isLoading"
                            />
                        </x-slot>
    ...
    <script type="module">
        window.app.component('v-cart-summary', {
            ...
            methods: {
                applyCoupon(params, { resetForm }) {
                    ...
                    this.$axios.post("{{ route('superadmin.sales.cart.store_coupon', $cart->id) }}", params)
                        .then((response) => {
                ...
                destroyCoupon() {
                    this.$axios.delete("{{ route('superadmin.sales.cart.remove_coupon', $cart->id) }}", {
                            '_token': "{{ csrf_token() }}"
                        })
                        .then((response) => {
                ...
                placeOrder() {
                    ...
                    this.$axios.post('{{ route('superadmin.sales.orders.store', $cart->id) }}')
                        .then(response => {
