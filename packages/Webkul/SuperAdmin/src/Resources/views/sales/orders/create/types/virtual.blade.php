            ...
            <div class="p-4">
                <div class="my-5 flex items-center justify-between">
                    <p class="text-sm dark:text-white">
                        @lang('superadmin::app.sales.orders.create.types.virtual.total-amount')
                    </p>
    ...
    >
        <div class="border-b border-[#E9E9E9] p-4">
            <x-superadmin::form.control-group>
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            <label
                                ...
                                :for="'customizable_options[' + option.id + '][' + index + ']'"
                            >
                                @lang('superadmin::app.sales.orders.create.types.virtual.none')
                            </label>
                        </div>
                ...
                <x-superadmin::form.control-group.error ::name="'customizable_options[' + option.id + '][]'" />
            </x-superadmin::form.control-group>
        </div>
    </script>

    <script type="module">
        window.app.component('v-virtual-product-customizable-options', {
            ...
            methods: {
                getCustomizableOptions() {
                    ...
                    this.$axios.get("{{ route('superadmin.catalog.products.virtual.customizable-options', ':replace') }}".replace(':replace', this.productOptions.product.id))
                        .then(response => {
        ...
        window.app.component('v-virtual-product-customizable-option-item', {
