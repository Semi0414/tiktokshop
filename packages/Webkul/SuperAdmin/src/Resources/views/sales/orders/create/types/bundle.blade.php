...
@pushOnce('scripts')
            ...
            <div class="p-4">
                <div class="my-5 flex items-center justify-between">
                    <p class="text-sm dark:text-white">
                        @lang('superadmin::app.sales.orders.create.types.bundle.total-amount')
                    </p>
            ...
            <x-superadmin::form.control-group>
                ...
                <template v-if="option.type == 'select'">
                    ...
                    >
                        ...
                        >
                            @lang('superadmin::app.sales.orders.create.types.bundle.none')
                        </option>
                ...
                <x-superadmin::form.control-group.error ::name="'bundle_options[' + option.id + '][]'" />
            </x-superadmin::form.control-group>
    ...
    <script type="module">
        window.app.component('v-product-bundle-options', {
            ...
            methods: {
                getOptions() {
                    ...
                    this.$axios.get("{{ route('superadmin.catalog.products.bundle.options', ':replace') }}".replace(':replace', this.productOptions.product.id))
                        .then(response => {
        ...
        window.app.component('v-product-bundle-option-item', {
