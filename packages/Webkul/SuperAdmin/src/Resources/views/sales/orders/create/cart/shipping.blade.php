...
>
    ...
    <x-superadmin::shimmer.sales.orders.create.cart.shipping />
</v-cart-shipping-methods>
...
@pushOnce('scripts')
        ...
        >
            <div class="flex items-center border-b p-4 dark:border-gray-800">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('superadmin::app.sales.orders.create.cart.shipping.title')
                </p>
            </div>
    ...
    <script type="module">
        window.app.component('v-cart-shipping-methods', {
            ...
            methods: {
                store(selectedMethod) {
                    ...
                    this.$axios.post("{{ route('superadmin.sales.cart.shipping_methods.store', $cart->id) }}", {    
