...
@pushOnce('scripts')
            ...
            >
                <div class="grid gap-1.5">
                    <p class="text-sm font-medium dark:text-white">
                        @lang('superadmin::app.sales.orders.create.types.grouped.name')
                    </p>
    ...
    <script type="module">
        window.app.component('v-product-grouped-options', {
            ...
            methods: {
                getOptions() {
                    ...
                    this.$axios.get("{{ route('superadmin.catalog.products.grouped.options', ':replace') }}".replace(':replace', this.productOptions.product.id))
                        .then(response => {
