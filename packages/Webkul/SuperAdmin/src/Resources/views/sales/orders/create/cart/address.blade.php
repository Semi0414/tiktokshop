...
@include('superadmin::sales.orders.create.cart.address.form')
...
@pushOnce('scripts')
        ...
        >
            <div class="flex items-center border-b p-4 dark:border-gray-800">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('superadmin::app.sales.orders.create.cart.address.title')
                </p>
            </div>
                    ...
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.sales.orders.create.cart.address.billing-address')
                            </p>
                            ...
                            >
                                @lang('superadmin::app.sales.orders.create.cart.address.add-btn')
                            </p>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-8">
                            ...
                            >
                                <x-superadmin::form.control-group class="!mb-0 flex items-center gap-2.5 self-start">
                                    <x-superadmin::form.control-group.control
                                        ...
                                        rules="required"
                                        label="{{ trans('superadmin::app.sales.orders.create.cart.address.billing-address') }}"
                                    />
                                ...
                                <div class="grid gap-3">
                                    ...
                                    <p
                                        ...
                                        "
                                    >
                                        @lang('superadmin::app.sales.orders.create.cart.address.edit-btn')
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Error Message Block -->
                        <x-superadmin::form.control-group.error name="billing.id" />

                        <!-- Shipping Address Block if have stockable items -->
                        <template v-if="cart.have_stockable_items">
                            <!-- Use for Shipping Checkbox -->
                            <x-superadmin::form.control-group class="!mb-0 mt-5 flex items-center gap-2.5">
                                <x-superadmin::form.control-group.control
                                    type="checkbox"
                                ...
                                <label
                                    ...
                                    for="use_for_shipping"
                                >
                                    @lang('superadmin::app.sales.orders.create.cart.address.same-as-billing')
                                </label>
                            </x-superadmin::form.control-group>
                            ...
                            >
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                        @lang('superadmin::app.sales.orders.create.cart.address.shipping-address')
                                    </p>
                                    ...
                                    >
                                        <x-superadmin::form.control-group class="!mb-0 flex items-center gap-2.5 self-start">
                                            <x-superadmin::form.control-group.control
                                                ...
                                                rules="required"
                                                label="{{ trans('superadmin::app.sales.orders.create.cart.address.shipping-address') }}"
                                            />
                                        </x-superadmin::form.control-group>
                                ...
                                <!-- Error Message Block -->
                                <x-superadmin::form.control-group.error name="shipping.id" />
                            </div>
                        </template>
                ...
                <form @submit="handleSubmit($event, updateOrCreateAddress)">
                    ...
                    >
                        ...
                        <x-slot:content>
                            ...
                            <x-superadmin::form.control-group class="flex items-center gap-2.5">
                                <x-superadmin::form.control-group.control
                                    type="checkbox"
    ...
    <script type="module">
        window.app.component('v-cart-addresses', {
            ...
            methods: {
                ...
                createCustomerAddress(params, { setErrors }) {
                    ...
                    return this.$axios.post('{{ route('superadmin.customers.customers.addresses.store', $cart->customer_id) }}', params)
                        .then((response) => {
                ...
                updateCustomerAddress(id, params, { setErrors }) {
                    ...
                    return this.$axios.put('{{ route('superadmin.customers.customers.addresses.update', ':id') }}'.replace(':id', id), params)
                        .then((response) => {
                            this.isStoring = false;
                ...
                addAddressToCart(params, { setErrors }) {
                    ...
                    this.$axios.post("{{ route('superadmin.sales.cart.addresses.store', $cart->id) }}", payload)
                        .then((response) => {
                            this.isStoring = false;
