...
>
    ...
    <x-superadmin::shimmer.sales.orders.create.items />
</v-previous-cart-items>
...
@pushOnce('scripts')
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <div class="mt-2 flex gap-2.5">
                                ...
                                >
                                    @lang('superadmin::app.sales.orders.create.cart-items.add-to-cart')
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <script type="module">
        window.app.component('v-previous-cart-items', {
            ...
            methods: {
                get() {
                    ...
                    this.$axios.get("{{ route('superadmin.customers.customers.cart.items', $cart->customer_id) }}")
                        .then(response => {
                ...
                removeItem(item) {
                    this.$emitter.emit('open-confirm-modal', {
                        agree: () => {
                            this.$axios.delete("{{ route('superadmin.customers.customers.cart.items.delete', $cart->customer_id) }}", {
                                data: {
                                    item_id: item.id
                                }
                            })
