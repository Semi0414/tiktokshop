...
@pushOnce('scripts')
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.sales.orders.create.recent-order-items.title')
                    </p>
                </div>
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                @{{ "@lang('superadmin::app.sales.orders.create.recent-order-items.sku', ['sku' => ':replace'])".replace(':replace', item.product.sku) }}
                            </p>
                            ...
                            >
                                ...
                                >
                                    @lang('superadmin::app.sales.orders.create.recent-order-items.see-details')
                            ...
                            <div class="mt-2 flex items-center gap-2.5">
                                <a
                                    :href="'{{ route('superadmin.sales.orders.view', '') }}/' + item.order_id"
                                    class="cursor-pointer text-sm text-blue-600 transition-all hover:underline"
                                    target="_blank"
                                >
                                    @lang('superadmin::app.sales.orders.create.recent-order-items.view')
                                </a>
                                ...
                                >
                                    @lang('superadmin::app.sales.orders.create.recent-order-items.add-to-cart')
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <script type="module">
        window.app.component('v-recent-order-items', {
            ...
            methods: {
                get() {
                    ...
                    this.$axios.get("{{ route('superadmin.customers.customers.orders.recent_items', $cart->customer_id) }}")
                        .then(response => {
