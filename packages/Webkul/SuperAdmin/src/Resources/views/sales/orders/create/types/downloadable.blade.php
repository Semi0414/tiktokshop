...
@pushOnce('scripts')
    ...
    >
        <x-superadmin::form.control-group class="p-4">
            <x-superadmin::form.control-group.label class="!mt-0 dark:text-white">
                @lang('superadmin::app.sales.orders.create.types.downloadable.title')
            ...
            <div class="grid gap-2">
                ...
                >
                    <x-superadmin::form.control-group.control
                        ...
                        ::value="link.id"
                        rules="required"
                        :label="trans('superadmin::app.sales.orders.create.types.downloadable.title')"
                    />
            ...
            <x-superadmin::form.control-group.error name="links[]" />
        </x-superadmin::form.control-group>
    </script>

    <script type="module">
        window.app.component('v-product-downloadable-options', {
            ...
            methods: {
                getOptions() {
                    ...
                    this.$axios.get("{{ route('superadmin.catalog.products.downloadable.options', ':replace') }}".replace(':replace', this.productOptions.product.id))
                        .then(response => {
