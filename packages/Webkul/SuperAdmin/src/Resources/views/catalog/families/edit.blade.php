<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.catalog.families.edit.title')
    </x-slot>

    <!-- Input Form -->
    <x-superadmin::form
        method="PUT"
        :action="route('superadmin.catalog.families.update', $attributeFamily->id)"
    >
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.catalog.families.edit.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.catalog.families.edit.save-btn')
                </button>
            </div>
        </div>
                ...
                <x-superadmin::accordion>
                    ...
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.catalog.families.edit.general')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="!text-gray-800 dark:!text-white">
                                @lang('superadmin::app.catalog.families.edit.code')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :placeholder="trans('superadmin::app.catalog.families.edit.enter-code')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label class="!text-gray-800 dark:!text-white">
                                @lang('superadmin::app.catalog.families.edit.name')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :placeholder="trans('superadmin::app.catalog.families.edit.enter-name')"
                            />
            ...
            <div class="">
                ...
                <div class="mb-2.5 flex flex-wrap justify-between gap-2.5 p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.catalog.families.edit.groups')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.catalog.families.edit.groups-info')
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-x-1">
                        ...
                        <div
                            ...
                            @click="deleteGroup"
                        >
                            @lang('superadmin::app.catalog.families.edit.delete-group-btn')
                        </div>
                        ...
                        >
                            @lang('superadmin::app.catalog.families.edit.add-group-btn')
                        </div>
                    </div>
                </div>
                ...
                <div class="flex [&>*]:flex-1 gap-5 justify-between px-4">
                    ...
                    <div v-for="(groups, column) in columnGroups">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @{{
                                    column == 1
                                    ? "@lang('superadmin::app.catalog.families.edit.main-column')"
                                    : "@lang('superadmin::app.catalog.families.edit.right-column')"
                                }}
                            </p>
                            
                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.families.edit.edit-group-info')
                            </p>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.catalog.families.edit.unassigned-attributes')
                            </p>

                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.families.edit.unassigned-attributes-info')
                            </p>
                        </div>
                        ...
                        <x-superadmin::modal ref="addGroupModal">
                            ...
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.catalog.families.edit.add-group-title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                <x-superadmin::form.control-group>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="code"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.families.edit.code')"
                                        :placeholder="trans('superadmin::app.catalog.families.edit.code')"
                                    />
                                ...
                                <x-superadmin::form.control-group>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="name"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.families.edit.name')"
                                        :placeholder="trans('superadmin::app.catalog.families.edit.name')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="mb-4">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.families.edit.column')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="column"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.families.edit.column')"
                                    >
                                        <!-- Default Option -->
                                        <option value="">
                            ...
                            <x-slot:footer>
                                ...
                                <x-superadmin::button
                                    button-type="button"
                                    class="primary-button"
                                    :title="trans('superadmin::app.catalog.families.edit.add-group-btn')"
                                />
                            </x-slot>
                        </x-superadmin::modal>
                    </form>
                ...
                methods: {
                    ...
                    addGroup(params, { resetForm, setErrors }) {
                        ...
                        if (isGroupCodeAlreadyExists || isGroupCodeAlreadyExists) {
                            if (isGroupCodeAlreadyExists) {
                                setErrors({'code': ["@lang('superadmin::app.catalog.families.edit.group-code-already-exists')"]});
                            }

                            if (isGroupNameAlreadyExists) {
                                setErrors({'name': ["@lang('superadmin::app.catalog.families.edit.group-name-already-exists')"]});
                            }
                    ...
                    deleteGroup() {
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                if (! this.selectedGroup.id) {
                                    this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('superadmin::app.catalog.families.edit.select-group')" });

                                    return;
                                }

                                if (this.isGroupContainsSystemAttributes(this.selectedGroup)) {
                                    this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('superadmin::app.catalog.families.edit.group-contains-system-attributes')" });
