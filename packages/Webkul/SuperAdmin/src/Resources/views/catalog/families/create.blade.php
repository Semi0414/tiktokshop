<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.catalog.families.create.title')
    </x-slot>

    <!-- Input Form -->
    <x-superadmin::form :action="route('superadmin.catalog.families.store')">
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                <a
                    href="{{ route('superadmin.catalog.families.index') }}"
                    class="transparent-button hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800"
                >
                    @lang('superadmin::app.catalog.families.create.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.catalog.families.create.save-btn')
                </button>
            </div>
        </div>
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="box-shadow flex flex-1 flex-col gap-2 rounded bg-white dark:bg-gray-900 max-xl:flex-auto">
                <v-family-attributes>
                    <x-superadmin::shimmer.catalog.families.attributes-panel />
                </v-family-attributes>
            </div>
                ...
                <x-superadmin::accordion>
                    ...
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.catalog.families.create.general')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required !text-gray-800 dark:!text-white">
                                @lang('superadmin::app.catalog.families.create.code')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                :value="old('code')"
                                :label="trans('superadmin::app.catalog.families.create.code')"
                                :placeholder="trans('superadmin::app.catalog.families.create.enter-code')"
                            />
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label class="required !text-gray-800 dark:!text-white">
                                @lang('superadmin::app.catalog.families.create.name')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                :value="old('name')"
                                :label="trans('superadmin::app.catalog.families.create.name')"
                                :placeholder="trans('superadmin::app.catalog.families.create.enter-name')"
                            />
    ...
    @pushOnce('scripts')
            ...
            <div>
                ...
                <div class="mb-2.5 flex flex-wrap justify-between gap-2.5 p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.catalog.families.create.groups')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('superadmin::app.catalog.families.create.groups-info')
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-x-1">
                        ...
                        <div
                            ...
                            @click="deleteGroup"
                        >
                            @lang('superadmin::app.catalog.families.create.delete-group-btn')
                        </div>
                        ...
                        >
                            @lang('superadmin::app.catalog.families.create.add-group-btn')
                        </div>
                    </div>
                </div>
                ...
                <div class="flex [&>*]:flex-1 gap-5 justify-between px-4">
                    ...
                    <div v-for="(groups, column) in columnGroups">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @{{
                                    column == 1
                                    ? "@lang('superadmin::app.catalog.families.create.main-column')"
                                    : "@lang('superadmin::app.catalog.families.create.right-column')"
                                }}
                            </p>
                            
                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.families.create.edit-group-info')
                            </p>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.catalog.families.create.unassigned-attributes')
                            </p>

                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.families.create.unassigned-attributes-info')
                            </p>
                        </div>
                ...
                >
                    <form @submit="handleSubmit($event, addGroup)">
                        <!-- Model Form -->
                        <x-superadmin::modal ref="addGroupModal">
                            <!-- Model Header -->
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.catalog.families.create.add-group-title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                ...
                                <x-superadmin::form.control-group>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.families.create.code')"
                                        :placeholder="trans('superadmin::app.catalog.families.create.code')"
                                    />
                                ...
                                <x-superadmin::form.control-group>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.families.create.name')"
                                        :placeholder="trans('superadmin::app.catalog.families.create.name')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="mb-4">
                                    <x-superadmin::form.control-group.label class="required font-medium !text-gray-800">
                                        @lang('superadmin::app.catalog.families.create.column')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="column"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.families.create.column')"
                                    >
                                        <!-- Default Option -->
                                        <option value="">
                                            @lang('superadmin::app.catalog.families.create.select-group')
                                        </option>
                                    ...
                                    <x-superadmin::form.control-group.error control-name="column" /> 
                                </x-superadmin::form.control-group>
                            </x-slot>
                            ...
                            <x-slot:footer>
                                ...
                                <x-superadmin::button
                                    button-type="button"
                                    class="primary-button"
                                    :title="trans('superadmin::app.catalog.families.create.add-group-btn')"
                                />
                            </x-slot>
                        </x-superadmin::modal>
                    </form>
        ...
        <script type="module">
            window.app.component('v-family-attributes', {
                ...
                methods: {
                    ...
                    onEnd: function(e) {
                        if (this.dropReverted) {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('superadmin::app.catalog.families.create.removal-not-possible')" });
                        }
                    },
                    ...
                    addGroup(params, { resetForm, setErrors }) {
                        ...
                        if (isGroupCodeAlreadyExists || isGroupCodeAlreadyExists) {
                            if (isGroupCodeAlreadyExists) {
                                setErrors({'code': ["@lang('superadmin::app.catalog.families.create.group-code-already-exists')"]});
                            }

                            if (isGroupNameAlreadyExists) {
                                setErrors({'name': ["@lang('superadmin::app.catalog.families.create.group-name-already-exists')"]});
                            }
                    ...
                    deleteGroup() {
                        if (! this.selectedGroup.id) {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('superadmin::app.catalog.families.create.select-group')" });

                            return;
                        }

                        if (this.isGroupContainsSystemAttributes(this.selectedGroup)) {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('superadmin::app.catalog.families.create.group-contains-system-attributes')" });
