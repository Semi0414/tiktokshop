<x-superadmin::layouts>
    <x-slot:title>
        @lang('superadmin::app.catalog.categories.edit.title')
    </x-slot>
    ...
    <!-- Category Edit Form -->
    <x-superadmin::form
        :action="route('superadmin.catalog.categories.update', $category->id)"
    ...
    >
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('superadmin::app.catalog.categories.edit.back-btn')
                </a>
                ...
                >
                    @lang('superadmin::app.catalog.categories.edit.save-btn')
                </button>
            </div>
        </div>
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.catalog.categories.edit.general')
                    </p>

                    <!-- Name -->
                    <x-superadmin::form.control-group>
                        <x-superadmin::form.control-group.label class="required">
                            @lang('superadmin::app.catalog.categories.edit.name')
                        ...
                        <v-field
                            ...
                            label="{{ trans('superadmin::app.catalog.categories.edit.name') }}"
                            rules="required"
                            v-slot="{ field }"
                        >
                            <input
                                ...
                                placeholder="{{ trans('superadmin::app.catalog.categories.edit.name') }}"
                                v-slugify-target:{{$currentLocale->code.'[slug]'}}="setValues"
                            />
                        </v-field>

                        <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code}}[name]" />
                    </x-superadmin::form.control-group>
                    ...
                    @if ($categories->count())
                        <div>
                            ...
                            <label class="mb-2.5 block text-xs font-medium leading-6 text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.categories.edit.select-parent-category')
                            </label>
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.catalog.categories.edit.description-and-images')
                    </p>
                    ...
                    <v-description v-slot="{ isDescriptionRequired }">
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label ::class="{ 'required' : isDescriptionRequired}">
                                @lang('superadmin::app.catalog.categories.edit.description')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.catalog.categories.edit.description')"
                                :tinymce="true"
                                :prompt="core()->getConfigData('general.magic_ai.content_generation.category_description_prompt')"
                            />

                            <x-superadmin::form.control-group.error control-name="{{ $currentLocale->code }}[description]" />
                        </x-superadmin::form.control-group>
                    </v-description>
                    ...
                    <div class="flex pt-5">
                        ...
                        <div class="flex w-2/5 flex-col gap-2">
                            <p class="font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.categories.edit.logo')
                            </p>

                            <p class="text-xs text-gray-500">
                                @lang('superadmin::app.catalog.categories.edit.logo-size')
                            </p>
                        ...
                        <div class="flex w-3/5 flex-col gap-2">
                            <p class="font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.categories.edit.banner')
                            </p>

                            <p class="text-xs text-gray-500">
                                @lang('superadmin::app.catalog.categories.edit.banner-size')
                            </p>
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.catalog.categories.edit.seo-details')
                    </p>
                    ...
                    <div class="mt-8">
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.catalog.categories.edit.meta-title')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.catalog.categories.edit.meta-title')"
                                :placeholder="trans('superadmin::app.catalog.categories.edit.meta-title')"
                            />
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.catalog.categories.edit.slug')
                            </x-superadmin::form.control-group.label>
                            ...
                            <v-field
                                ...
                                label="{{ trans('superadmin::app.catalog.categories.edit.slug') }}"
                                v-slot="{ field }"
                            >
                                <input
                                    type="text"
                                    ...
                                    class="flex min-h-[39px] w-full rounded-md border px-3 py-2 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400"
                                    v-bind="field"
                                    placeholder="{{ trans('superadmin::app.catalog.categories.edit.slug') }}"
                                    v-slugify-target:{{$currentLocale->code.'[slug]'}}
                                />
                            </v-field>

                            <x-superadmin::form.control-group.error control-name="{{$currentLocale->code}}[slug]" />
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.catalog.categories.edit.meta-keywords')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.catalog.categories.edit.meta-keywords')"
                                :placeholder="trans('superadmin::app.catalog.categories.edit.meta-keywords')"
                            />
                        </x-superadmin::form.control-group>
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.catalog.categories.edit.meta-description')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.catalog.categories.edit.meta-description')"
                                :placeholder="trans('superadmin::app.catalog.categories.edit.meta-description')"
                            />
                        </x-superadmin::form.control-group>
                    </div>
                </div>
                ...
                <x-superadmin::accordion>
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.catalog.categories.edit.settings')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.catalog.categories.edit.position')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                :label="trans('superadmin::app.catalog.categories.edit.position')"
                                :placeholder="trans('superadmin::app.catalog.categories.edit.enter-position')"
                            />
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required font-medium text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.categories.edit.display-mode')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                :value="$selectedValue"
                                :label="trans('superadmin::app.catalog.categories.edit.display-mode')"
                            >
                                <option value="products_and_description" {{ $selectedValue == 'products_and_description' ? 'selected' : '' }}>
                                    @lang('superadmin::app.catalog.categories.edit.products-and-description')
                                </option>

                                <option value="products_only" {{ $selectedValue == 'products_only' ? 'selected' : '' }}>
                                    @lang('superadmin::app.catalog.categories.edit.products-only')
                                </option>

                                <option value="description_only" {{ $selectedValue == 'description_only' ? 'selected' : '' }}>
                                    @lang('superadmin::app.catalog.categories.edit.description-only')
                                </option>
                            </x-superadmin::form.control-group.control>
                        ...
                        <x-superadmin::form.control-group class="!mb-0">
                            <x-superadmin::form.control-group.label>
                                @lang('superadmin::app.catalog.categories.edit.visible-in-menu')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                name="status"
                                value="1"
                                :label="trans('superadmin::app.catalog.categories.edit.visible-in-menu')"
                                :checked="(boolean) $selectedValue"
                            />
                        </x-superadmin::form.control-group>
                    </x-slot>
                ...
                <x-superadmin::accordion>
                    <x-slot:header>
                        <p class="required p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('superadmin::app.catalog.categories.edit.filterable-attributes')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        @foreach ($attributes as $attribute)
                            <x-superadmin::form.control-group class="!mb-2 flex items-center gap-2.5 last:!mb-0">
                                <x-superadmin::form.control-group.control
                                    type="checkbox"
                                    ...
                                    :label="trans('superadmin::app.catalog.categories.edit.filterable-attributes')"
