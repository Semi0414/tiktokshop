    ...
    @pushOnce('scripts')
            ...
            <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
                    ...
                    <div class="flex justify-between gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            <p class="text-base font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.title')
                            </p>

                            <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.info')
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-x-1">
                            ...
                            >
                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.add-btn')
                            </div>
                        </div>
                    </div>

                    <!-- Backend Validations -->
                    <x-superadmin::form.control-group.error control-name="customizable_options" />
                </div>
                                ...
                                >
                                    ...
                                    <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            >
                                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.edit-btn')
                                            </p>
                                            ...
                                            >
                                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.delete-btn')
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.empty-info')
                        </p>
                    </div>
                ...
                >
                    <form @submit="handleSubmit($event, updateOrCreate)">
                        <x-superadmin::modal ref="updateCreateOptionModal">
                            <!-- Option Form Modal Header -->
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.name')
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.name')"
                                    />

                                    <x-superadmin::form.control-group.error control-name="label" />
                                </x-superadmin::form.control-group>

                                <div class="flex gap-4">
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.type')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.type')"
                                        >
                                            <option
                                                :value="type.key"
                                                :key="key"
                                    ...
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.is-required')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.is-required')"
                                        >
                                            <option value="1">
                                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.yes')
                                            </option>

                                            <option value="0">
                                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.no')
                                            </option>
                                        </x-superadmin::form.control-group.control>

                                        <x-superadmin::form.control-group.error control-name="is_required" />
                                    </x-superadmin::form.control-group>
                                </div>

                                <template v-if="! canHaveMultiplePrices(selectedOption.type)">
                                    <x-superadmin::form.control-group v-if="['text', 'textarea'].includes(selectedOption.type)">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.max-characters')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.max-characters')"
                                        />

                                        <x-superadmin::form.control-group.error control-name="max_characters" />
                                    </x-superadmin::form.control-group>

                                    <x-superadmin::form.control-group v-else-if="selectedOption.type == 'file'">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.supported-file-extensions')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.supported-file-extensions')"
                                        />

                                        <x-superadmin::form.control-group.error control-name="supported_file_extensions" />
                                    </x-superadmin::form.control-group>

                                    <x-superadmin::form.control-group>
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.price')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.price')"
                                        />
                            ...
                            <x-slot:footer>
                                ...
                                <x-superadmin::button
                                    ...
                                    :title="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.update-create.save-btn')"
                                />
                            </x-slot>
                        </x-superadmin::modal>
                    </form>
        ...
        >
            ...
            <div>
                ...
                <div class="mb-2.5 flex justify-between gap-5 p-4">
                    ...
                    <div class="flex items-center gap-x-5">
                        ...
                        >
                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.add-btn')
                        </p>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.empty-info')
                        </p>
                    </div>
            ...
            >
                ...
                >
                    <x-superadmin::modal ref="updateCreateOptionItemModal">
                        <!-- Option Item Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="flex gap-2">
                                ...
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.label')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.label')"
                                    />
                                ...
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.price')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        rules="required|decimal|min_value:0"
                                        :label="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.price')"
                                    />
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                button-type="button"
                                class="primary-button"
                                :title="trans('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.save-btn')"
                            />
                        </x-slot>
                    </x-superadmin::modal>
                </form>
                    ...
                    return {
                        types: {
                            text: {
                                ...
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.text.title')",
                            },

                            textarea: {
                                key: 'textarea',
                                canHaveMultiplePrices: false,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.textarea.title')",
                            },

                            checkbox: {
                                key: 'checkbox',
                                canHaveMultiplePrices: true,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.checkbox.title')",
                            },

                            radio: {
                                key: 'radio',
                                canHaveMultiplePrices: true,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.radio.title')",
                            },

                            select: {
                                key: 'select',
                                canHaveMultiplePrices: true,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.select.title')",
                            },

                            multiselect: {
                                key: 'multiselect',
                                canHaveMultiplePrices: true,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.multiselect.title')",
                            },

                            date: {
                                key: 'date',
                                canHaveMultiplePrices: false,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.date.title')",
                            },

                            datetime: {
                                key: 'datetime',
                                canHaveMultiplePrices: false,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.datetime.title')",
                            },

                            time: {
                                key: 'time',
                                canHaveMultiplePrices: false,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.time.title')",
                            },

                            file: {
                                key: 'file',
                                canHaveMultiplePrices: false,
                                title: "@lang('superadmin::app.catalog.products.edit.types.simple.customizable-options.option.types.file.title')",
                            },
                        },
