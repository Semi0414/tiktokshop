...
@pushOnce('scripts')
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.catalog.products.edit.types.bundle.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('superadmin::app.catalog.products.edit.types.bundle.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('superadmin::app.catalog.products.edit.types.bundle.add-btn')
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.bundle.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.bundle.empty-info')
                    </p>
                </div>
                    ...
                    <x-superadmin::modal ref="updateCreateOptionModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <x-superadmin::form.control-group>
                                <x-superadmin::form.control-group.label class="required">
                                    @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.name')
                                ...
                                <x-superadmin::form.control-group.control
                                    ...
                                    :label="trans('superadmin::app.catalog.products.edit.types.bundle.update-create.name')"
                                />
                            ...
                            <div class="flex gap-4">
                                ...
                                <x-superadmin::form.control-group class="flex-1">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.type')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.bundle.update-create.type')"
                                    >
                                        <option value="select">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.select')
                                        </option>

                                        <option value="radio">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.radio')
                                        </option>

                                        <option value="checkbox">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.checkbox')
                                        </option>

                                        <option value="multiselect">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.multiselect')
                                        </option>
                                    </x-superadmin::form.control-group.control>
                                ...
                                <x-superadmin::form.control-group class="flex-1">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.is-required')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.bundle.update-create.is-required')"
                                    >
                                        <option value="1">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.yes')
                                        </option>

                                        <option value="0">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.update-create.no')
                                        </option>
                                    </x-superadmin::form.control-group.control>
                        ...
                        <x-slot:footer>
                            ...
                            <x-superadmin::button
                                ...
                                :title="trans('superadmin::app.catalog.products.edit.types.bundle.update-create.save-btn')"
                            />
                        </x-slot>
                    </x-superadmin::modal>
                </form>
        ...
        <div>
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                ...
                <div class="flex items-center gap-x-5">
                    ...
                    >
                        @lang('superadmin::app.catalog.products.edit.types.bundle.option.add-btn')
                    </p>
                    ...
                    <p
                        ...
                        @click="edit"
                    >
                        @lang('superadmin::app.catalog.products.edit.types.bundle.option.edit-btn')
                    </p>
                    ...
                    <p
                        ...
                        @click="remove"
                    >
                        @lang('superadmin::app.catalog.products.edit.types.bundle.option.delete-btn')
                    </p>
                </div>
            </div>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    <template v-if="! element.product.images.length">
                                        ...
                                        <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                            @lang('superadmin::app.catalog.products.edit.types.bundle.image-placeholder')
                                        </p>
                                    </template>
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @{{ `@lang('superadmin::app.catalog.products.edit.types.bundle.option.sku')`.replace(':sku', element.product.sku) }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                ...
                                <x-superadmin::form.control-group class="!mb-0">
                                    <x-superadmin::form.control-group.label class="required !block">
                                        @lang('superadmin::app.catalog.products.edit.types.bundle.option.default-qty')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <v-field
                                        ...
                                        label="@lang('superadmin::app.catalog.products.edit.types.bundle.option.default-qty')"
                                    ></v-field>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.bundle.option.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.bundle.option.empty-info')
                    </p>
                </div>
    ...
    <script type="module">
        window.app.component('v-bundle-options', {
        ...
        window.app.component('v-bundle-option-item', {
            ...
            data() {
                return {
                    types: {
                        select: {
                            key: 'select',
                            title: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.select.title')`,
                            info: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.select.info')`
                        },

                        radio: {
                            key: 'radio',
                            title: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.radio.title')`,
                            info: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.radio.info')`
                        },

                        multiselect: {
                            key: 'multiselect',
                            title: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.multiselect.title')`,
                            info: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.multiselect.info')`
                        },

                        checkbox: {
                            key: 'checkbox',
                            title: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.checkbox.title')`,
                            info: `@lang('superadmin::app.catalog.products.edit.types.bundle.option.types.checkbox.info')`
                        }
                    },
                }
            },
