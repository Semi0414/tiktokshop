...
@pushOnce('scripts')
        ...
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.add-btn')
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <template v-if="element.type == 'file'">
                                            <div>
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.file')
                                        ...
                                        <template v-else>
                                            <div>
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.url')
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <template v-if="element.sample_type == 'file'">
                                            <div v-if="element.sample_file_url">
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.sample-file')
                                        ...
                                        <template v-else>
                                            <div v-if="element.sample_url">
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.sample-url')
                            ...
                            <div class="grid place-content-start gap-1 text-right">
                                ...
                                <div class="flex items-center gap-x-5">
                                    ...
                                    >
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.delete-btn')
                                    </p>
                                    ...
                                    >
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.edit-btn')
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.empty-info')
                    </p>
                </div>
            ...
            >
                <form @submit="handleSubmit($event, updateOrCreate)">
                    <!-- Search Drawer -->
                    <x-superadmin::drawer ref="updateCreateLinkDrawer">
                        <!-- Drawer Header -->
                        <x-slot:header>
                            <div class="grid gap-3">
                                <div class="flex items-center justify-between">
                                    <p class="text-xl font-medium dark:text-white">
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.title')
                                    </p>

                                    <button class="primary-button ltr:mr-11 rtl:ml-11">
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.save-btn')
                                    </button>
                                </div>
                            </div>
                        </x-slot>
                            ...
                            <div class="px-4 py-2.5">
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.name')
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.name')"
                                    />
            
                                    <x-superadmin::form.control-group.error control-name="title" />
                                </x-superadmin::form.control-group>

                                <div class="flex gap-4">
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.price')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.price')"
                                        />
                                    ...
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.downloads')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.downloads')"
                                        />
                
                                        <x-superadmin::form.control-group.error control-name="downloads" />
                                    </x-superadmin::form.control-group>
                                </div>
                                ...
                                <div class="flex gap-4">
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.file-type')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            :label="trans('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.file-type')"
                                        >
                                            <option value="file">
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.file')
                                            </option>

                                            <option value="url">
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.url')
                                            </option>
                                        </x-superadmin::form.control-group.control>
                                    ...
                                    <template v-if="selectedLink.type == 'file'">
                                        <x-superadmin::form.control-group class="flex-1">
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                :label="trans('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.file')"
                                            />
                                    ...
                                    <template v-else>
                                        <x-superadmin::form.control-group class="flex-1">
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                :label="trans('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.url')"
                                            />
                    
                                            <x-superadmin::form.control-group.error control-name="url" />
                                        </x-superadmin::form.control-group>
                                    </template>
                                </div>
                                ...
                                <div class="flex gap-4">
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label>
                                            @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.sample-type')
                                        </x-superadmin::form.control-group.label>
                                    ...
                                    <template v-if="selectedLink.sample_type == 'file'">
                                        <x-superadmin::form.control-group class="flex-1">
                                            <x-superadmin::form.control-group.label>
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.links.update-create.sample')
                                            </x-superadmin::form.control-group.label>
                                    ...
                                    <template v-else>
                                        <x-superadmin::form.control-group class="flex-1">
                                            ...
                                            <x-superadmin::form.control-group.error control-name="sample_url" />
                                        </x-superadmin::form.control-group>
                                    </template>
                                </div>
                            </div>
    ...
    >
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.add-btn')
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <template v-if="element.type == 'file'">
                                            <div>
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.file')
                                        ...
                                        <template v-else>
                                            <div>
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.url')
                            ...
                            <div class="grid place-content-start gap-1 text-right">
                                <div class="flex items-center gap-x-5">
                                    <p
                                        ...
                                        @click="remove(element)"
                                    >
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.delete-btn')
                                    </p>
                                    ...
                                    >
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.edit-btn')
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.empty-info')
                    </p>
                </div>
            ...
            >
                <form @submit="handleSubmit($event, updateOrCreate)">
                    <!-- Search Drawer -->
                    <x-superadmin::drawer ref="updateCreateSampleDrawer">
                        <!-- Drawer Header -->
                        <x-slot:header>
                            <div class="grid gap-3">
                                <div class="flex items-center justify-between">
                                    <p class="text-xl font-medium dark:text-white">
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.title')
                                    </p>

                                    <button class="primary-button ltr:mr-11 rtl:ml-11">
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.save-btn')
                                    </button>
                                </div>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content class="!p-0">
                            ...
                            <div class="px-4 py-2.5">
                                <x-superadmin::form.control-group>
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.name')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.name')"
                                    />
                                ...
                                <div class="flex gap-4">
                                    <x-superadmin::form.control-group class="flex-1">
                                        <x-superadmin::form.control-group.label class="required">
                                            @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.file-type')
                                        </x-superadmin::form.control-group.label>
                                        ...
                                        <x-superadmin::form.control-group.control
                                            ...
                                            rules="required"
                                            :label="trans('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.file-type')"
                                        >
                                            <option value="file">
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.file')
                                            </option>

                                            <option value="url">
                                                @lang('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.url')
                                            </option>
                                        </x-superadmin::form.control-group.control>
                                    ...
                                    <template v-if="selectedSample.type == 'file'">
                                        <x-superadmin::form.control-group class="flex-1">
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                :label="trans('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.file')"
                                            />
                                    ...
                                    <template v-else>
                                        <x-superadmin::form.control-group class="flex-1">
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                :label="trans('superadmin::app.catalog.products.edit.types.downloadable.samples.update-create.url')"
                                            />
    ...
    <script type="module">
        window.app.component('v-downloadable-links', {
            ...
            methods: {
                ...
                uploadFile(type) {
                    ...
                    this.$axios.post("{{ route('superadmin.catalog.products.upload_link', $product->id) }}", formData, {
                            headers: {
        ...
        window.app.component('v-downloadable-samples', {
            ...
            methods: {
                ...
                uploadFile(type) {
                    ...
                    this.$axios.post("{{ route('superadmin.catalog.products.upload_sample', $product->id) }}", formData, {
                            headers: {
                                'Content-Type': 'multipart/form-data'
                            }
                        })
