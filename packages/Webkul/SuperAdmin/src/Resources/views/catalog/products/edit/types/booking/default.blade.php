...
@pushOnce('scripts')
    ...
    >
        ...
        <x-superadmin::form.control-group class="w-full">
            <x-superadmin::form.control-group.label class="required">
                @lang('superadmin::app.catalog.products.edit.types.booking.default.description')
            ...
            <x-superadmin::form.control-group.control
                ...
                :label="trans('superadmin::app.catalog.products.edit.types.booking.default.description')"
                @slotType="slotType"
            >
                @foreach (['one', 'many'] as $item)
                    <option value="{{ $item }}">
                        @lang('superadmin::app.catalog.products.edit.types.booking.default.' . $item)
                    </option>
                @endforeach
            </x-superadmin::form.control-group.control>

            <x-superadmin::form.control-group.error control-name="booking[booking_type]" />
        ...
        <template v-if="default_booking.booking_type == 'many'">
            ...
            <x-superadmin::form.control-group class="w-full">
                <x-superadmin::form.control-group.label class="required">
                    @lang('superadmin::app.catalog.products.edit.types.booking.default.slot-duration')
                </x-superadmin::form.control-group.label>
                ...
                <x-superadmin::form.control-group.control
                    ...
                    :label="trans('superadmin::app.catalog.products.edit.types.booking.default.slot-duration')"
                />
            ...
            <x-superadmin::form.control-group class="w-full">
                <x-superadmin::form.control-group.label class="required">
                    @lang('superadmin::app.catalog.products.edit.types.booking.default.break-duration')
                </x-superadmin::form.control-group.label>
                ...
                <x-superadmin::form.control-group.control
                    ...
                    :label="trans('superadmin::app.catalog.products.edit.types.booking.default.break-duration')"
                />
        ...
        <div class="flex items-center justify-between gap-5 py-2">
            <div class="flex flex-col gap-2">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('superadmin::app.catalog.products.edit.types.booking.default.slot-title')
                </p>

                <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                    @lang('superadmin::app.catalog.products.edit.types.booking.default.description-info')
                 </p>
            </div>
            ...
            >
                ...
                >
                    @lang('superadmin::app.catalog.products.edit.types.booking.default.slot-add')
                </div>
            </div>
        </div>
             ...
             <template v-else>
                ...
                >
                        ...
                        <template v-for="(slot, slotIndex) in slots['many'][dayIndex]">
                            <p
                                ...
                                v-text="parseInt(slot.status) 
                                    ? '@lang('superadmin::app.catalog.products.edit.types.booking.default.open')'
                                    : '@lang('superadmin::app.catalog.products.edit.types.booking.default.close')'"
                            >
                            </p>
                        </template>
                    </div>
                    ...
                    <div class="flex items-center justify-between grid-cols-2">
                        <div class="flex min-h-[38px] flex-wrap items-center gap-1 dark:border-gray-800">
                            ...
                            <template v-else>
                                <p class="text-gray-500">
                                    @lang('superadmin::app.catalog.products.edit.types.booking.default.unavailable')
                                </p>
                            </template>
                        </div>
                        ...
                        >
                            @lang('superadmin::app.catalog.products.edit.types.booking.default.add')
                        </p>
                        ...
                        >
                            @lang('superadmin::app.catalog.products.edit.types.booking.default.edit')
                        </p>    
                    </div>
                </div>
            </template>
                        ...
                        <div class="flex items-center justify-between">
                            <p
                                ...
                                v-text="slots['many'][currentIndex]?.length 
                                    ? '@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.edit-title')'
                                    : '@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.add-title')'"
                            >
                            </p>
                            ...
                            <div class="ltr:mr-11 rtl:ml-11">
                                ...
                                >
                                    @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.save')
                                </button>
                            </div>
                        </div>
                    </x-slot:header>
                       ...
                       <!-- Booking Type One -->
                        <template v-if="default_booking.booking_type == 'one'">
                            <div class="mb-2.5 grid grid-cols-2 gap-4 border-b dark:border-gray-800">
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from-day')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="from_day"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from-day')"
                                    >
                                        <option
                                            value=""
                                            selected
                                        >
                                            @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.select')
                                        </option>

                                        <option
                                            v-for="(day, index) in week_days"
                                            :value="index"
                                            v-text="'@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.week')'.replace(':day', day)"
                                        >
                                        </option>
                                    </x-superadmin::form.control-group.control>
                    
                                    <x-superadmin::form.control-group.error control-name="from_day" />
                                </x-superadmin::form.control-group>
                    
                                <!-- From -->
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from-time')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="from"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from-time')"
                                        :placeholder="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from-time')"
                                    />
                    
                                    <x-superadmin::form.control-group.error control-name="from" />
                                </x-superadmin::form.control-group>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to-day')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="to_day"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to-day')"
                                    >
                                        <option
                                            value=""
                                            selected
                                    ...
                                    <x-superadmin::form.control-group.error control-name="to_day" />
                                </x-superadmin::form.control-group>
                    
                                <!-- To Time -->
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="required">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to-time')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="to"
                                        rules="required"
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to-time')"
                                        :placeholder="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to-time')"
                                    />
                    
                                    <x-superadmin::form.control-group.error control-name="to" />
                                </x-superadmin::form.control-group>
                            </div>
                        </template>
                        ...
                        <template v-if="default_booking.booking_type == 'many'">
                            <div class="grid grid-cols-3 gap-2.5 pb-3">
                                ...
                                <!-- Slots From -->
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="hidden">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from')"
                                        :placeholder="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.from')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="hidden">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        name="to"
                                        ::rules="selectedStatus[currentIndex] ? 'required' : ''"
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to')"
                                        :placeholder="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.to')"
                                    />
                                ...
                                <x-superadmin::form.control-group class="w-full">
                                    <x-superadmin::form.control-group.label class="hidden">
                                        @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.status')
                                    </x-superadmin::form.control-group.label>
                                    ...
                                    <x-superadmin::form.control-group.control
                                        ...
                                        :label="trans('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.status')"
                                    >
                                        <option value="1">
                                            @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.open')
                                        </option>

                                        <option value="0">
                                            @lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.close')
                                        </option>
                                    </x-superadmin::form.control-group.control>
    ...
    <script type="module">
        window.app.component('v-default-booking', {
            ...
            data() {
                return {
                    ...
                    week_days: [
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.sunday')",
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.monday')",
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.tuesday')",
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.wednesday')",
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.thursday')",
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.friday')",
                        "@lang('superadmin::app.catalog.products.edit.types.booking.default.modal.slot.saturday')",
                    ],
                    ...
                    if (params.booking_type === 'one') {
                        ...
                        if (
                            ...
                            this.$emitter.emit('add-flash', {
                                type: 'error',
                                message: "@lang('superadmin::app.catalog.products.edit.types.booking.validations.time-validation')"
                            });
                        ...
                        if (! isOverlapping) {
                            ...
                            this.$emitter.emit('add-flash', {
                                type: 'error',
                                message: "@lang('superadmin::app.catalog.products.edit.types.booking.validations.overlap-validation')",
                            });
