...
@pushOnce('scripts')
    ...
    >
        <x-superadmin::form.control-group class="last:!mb-0">
            ...
            >
                <x-superadmin::form.control-group.label ::for="name">
            ...
            <template v-if="field.type == 'image' && field.is_visible">
                ...
                <template v-if="value">
                    <x-superadmin::form.control-group class="mt-1.5 flex w-max cursor-pointer select-none items-center gap-1.5">
                        <x-superadmin::form.control-group.control
                            type="checkbox"
                            ::id="`${name}[delete]`"
                            ::name="`${name}[delete]`"
                        ...
                        >
                            @lang('superadmin::app.configuration.index.delete')
                        </label>
            ...
            <template v-if="field.type == 'file' && field.is_visible">
                <a
                    v-if="value"
                    :href="`{{ route('superadmin.configuration.download', [request()->route('slug'), request()->route('slug2'), '']) }}/${value.split('/')[1]}`"
                >
            ...
            <template v-if="field.type == 'country' && field.is_visible">
                <v-country :selected-country="value">
                    <template v-slot:default="{ changeCountry }">
                        <x-superadmin::form.control-group class="flex">
                            <x-superadmin::form.control-group.control
                                type="select"
                                ::id="name"
                                ::name="name"
                            ...
                            >
                                <option value="">
                                    @lang('superadmin::app.configuration.index.select-country')
                                </option>
                        ...
                        <div v-if="isStateComponenetLoaded">
                            <template v-if="haveStates()">
                                <x-superadmin::form.control-group class="flex">
                                    ...
                                    >
                                        <option value="">
                                            @lang('superadmin::app.configuration.index.select-state')
                                        </option>
    ...
    <script type="module">
        window.app.component('v-configurable', {
        ...
        window.app.component('v-country', {
