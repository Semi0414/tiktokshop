    ...
    >
        ...
        <div class="flex gap-x-1">
            ...
            <template v-if="applied.massActions.indices.length">
                <x-superadmin::datagrid.toolbar.mass-action>
            ...
            <!-- Search Panel -->
            <template v-else>
                <x-superadmin::datagrid.toolbar.search>
                    <template #search="{
                        available,
                        applied,
                        search,
        ...
        <div class="flex gap-x-4">                   
            <!-- Filter Panel -->
            <x-superadmin::datagrid.toolbar.filter>
                <template #filter="{
                    available,
                    applied,
                    filters,
            ...
            <!-- Pagination Panel -->
            <x-superadmin::datagrid.toolbar.pagination>
                <template #pagination="{
                    available,
                    applied,
                    changePage,
