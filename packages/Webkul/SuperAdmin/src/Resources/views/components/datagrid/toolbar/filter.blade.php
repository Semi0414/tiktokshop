    ...
    >
        ...
        >
            <template v-if="isLoading">
                <x-superadmin::shimmer.datagrid.toolbar.filter />
            </template>
                ...
                >
                    <x-slot:toggle>
                        <div>
                            ...
                            >
                                ...
                                <span>
                                    @lang('superadmin::app.components.datagrid.toolbar.filter.title')
                                </span>
                    ...
                    <x-slot:header>
                        ...
                        >
                            <p class="text-xl font-semibold text-gray-800 dark:text-white">
                                @lang('superadmin::app.components.datagrid.filters.title')
                            </p>
                        </div>
                        ...
                        <div v-else class="flex items-center gap-x-2">
                            ...
                            <p class="text-xl font-semibold text-gray-800 dark:text-white">
                                @{{ applied.savedFilterId ? '@lang('superadmin::app.components.datagrid.toolbar.filter.update-filter')' : '@lang('superadmin::app.components.datagrid.toolbar.filter.save-filter')' }}
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content class="!p-0">
                        <template v-if="! isShowSavedFilters">
                            ...
                            >
                                <x-slot:header class="px-4">
                                    <p class="w-full text-base font-semibold text-gray-800 dark:text-white">
                                        @lang('superadmin::app.components.datagrid.toolbar.filter.quick-filters')
                                    </p>
                                </x-slot>
                            ...
                            <!-- Filters Accordion -->
                            <x-superadmin::accordion class="select-none !rounded-none !border-none !shadow-none">
                                <x-slot:header class="px-4">
                                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                                        @lang('superadmin::app.components.datagrid.toolbar.filter.custom-filters')
                                    </p>
                                    ...
                                    >
                                        @lang('superadmin::app.components.datagrid.filters.custom-filters.clear-all')
                                    </div>
                                </x-slot>
                                ...
                                <x-slot:content class="!p-4">
                                                            ...
                                                            <x-slot:toggle>
                                                                ...
                                                                >
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        v-text="'@lang('superadmin::app.components.datagrid.filters.select')'"
                                                                    ...
                                                                    <span
                                                                        class="text-sm text-gray-400 dark:text-gray-400"
                                                                        v-text="column.filterable_options.find((option => option.value === getAppliedColumnValues(column.index)))?.label ?? '@lang('superadmin::app.components.datagrid.filters.select')'"
                                                                        v-else
                                                                    >
                                                                    </span>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        >
                                            @lang('superadmin::app.components.datagrid.toolbar.filter.apply-filters-btn')
                                        </button>
                        ...
                        <template v-else>
                            <div class="flex items-center justify-between px-4 py-4">
                                <p class="text-base font-semibold text-gray-800 dark:text-white">
                                    @{{ applied.savedFilterId ? '@lang('superadmin::app.components.datagrid.toolbar.filter.update-filter')' : '@lang('superadmin::app.components.datagrid.toolbar.filter.create-new-filter')' }}
                                </p>
                            </div>
                                    ...
                                    <form @submit="handleSubmit($event, createOrUpdateFilter)">
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-2 border-b px-4 dark:border-gray-800">
                                                <x-superadmin::form.control-group>
                                                    <x-superadmin::form.control-group.label class="required">
                                                        @lang('superadmin::app.components.datagrid.toolbar.filter.name')
                                                    ...
                                                    <x-superadmin::form.control-group.control
                                                        ...
                                                        rules="required"
                                                        :label="trans('superadmin::app.components.datagrid.toolbar.filter.name')"
                                                        :placeholder="trans('superadmin::app.components.datagrid.toolbar.filter.name')"
                                                    />
                                                ...
                                                <div class="mb-4 flex content-end items-center justify-end">
                                                    <button
                                                        ...
                                                        aria-label="@lang('superadmin::app.components.datagrid.toolbar.filter.save-btn')"
                                            ...
                                            <div class="flex flex-col gap-4 px-4">
                                                <p class="text-base font-semibold text-gray-800 dark:text-white">
                                                    @lang('superadmin::app.components.datagrid.toolbar.filter.selected-filters')
                                                </p>
                                                            ...
                                                            <div class="flex items-center gap-5 py-2.5">
                                                                ...
                                                                <div class="flex flex-col gap-1.5">
                                                                    <p class="text-base font-semibold text-gray-400">
                                                                        @lang('superadmin::app.components.datagrid.toolbar.filter.empty-title')
                                                                    </p>

                                                                    <p class="text-gray-400">
                                                                        @lang('superadmin::app.components.datagrid.toolbar.filter.empty-description')
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        window.app.component('v-datagrid-filter', {
            ...
            methods: {
                ...
                async createOrUpdateFilter(params, { setErrors }) {
                    ...
                    const url = params.id ? `{{ route('superadmin.datagrid.saved_filters.update', '') }}/${params.id}` : "{{ route('superadmin.datagrid.saved_filters.store') }}";
                ...
                async getSavedFilters() {
                    try {
                        const url = new URL('{{ route('superadmin.datagrid.saved_filters.index') }}', window.location.origin);
                ...
                deleteSavedFilter(filter) {
                    this.$emitter.emit('open-confirm-modal', {
                        agree: async () => {
                            try {
                                const response = await fetch(`{{ route('superadmin.datagrid.saved_filters.destroy', '') }}/${filter.id}`, {
                                    method: 'DELETE',
                                    headers: {
                                        'Accept': 'application/json',
                                        'X-Requested-With': 'XMLHttpRequest',
