@pushOnce('scripts', 'superadmin:v-datagrid-register')
    <script
    ...
    >
        <div>
            <!-- Toolbar -->
            <x-superadmin::datagrid.toolbar />

            <div class="mt-4 flex">
                <template v-if="! tableless">
                    <x-superadmin::datagrid.table :isMultiRow="$isMultiRow">
                        <template #header="{
                            isLoading,
                            available,
                            applied,
