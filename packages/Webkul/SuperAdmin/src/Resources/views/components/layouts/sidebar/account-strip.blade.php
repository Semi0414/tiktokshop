        ...
        >
            ...
            >
                ...
                <div class="min-w-0 flex-1 text-left group-[.sidebar-collapsed]/container:hidden">
                    ...
                    <p class="text-xs leading-relaxed text-gray-500 dark:text-gray-400">
                        @lang('superadmin::app.components.layouts.sidebar.referral-code'):
                        <span
                        ...
                        >{{ $adminReferralCode }}</span>
                    </p>
                    <p class="truncate text-xs text-gray-500 dark:text-gray-400" title="{{ $adminUser->email }}">
                        {{ $adminUser->email }}
                    </p>
                </div>
            </div>
            ...
            <div class="mt-3 flex flex-col gap-2">
                ...
                <a
                    ...
                    title="@lang('superadmin::app.components.layouts.sidebar.my-shop')"
                    style="
    background-color: chartreuse;
    color: white;
">
                    <span class="group-[.sidebar-collapsed]/container:hidden">
                        @lang('superadmin::app.components.layouts.sidebar.my-shop')
                    </span>
