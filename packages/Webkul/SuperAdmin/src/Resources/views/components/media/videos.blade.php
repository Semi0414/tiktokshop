...
@pushOnce('scripts')
                ...
                >
                    <div class="flex flex-col items-center">
                        ...
                        <p class="grid text-center text-sm font-semibold text-gray-600 dark:text-gray-300">
                            @lang('superadmin::app.components.media.videos.add-video-btn')
                            
                            <span class="text-xs">
                                @lang('superadmin::app.components.media.videos.allowed-types')
                            </span>
                        </p>
    ...
    <script type="module">
        window.app.component('v-media-videos', {
                ...
                add() {
                    ...
                    if (! validFiles) {
                        this.$emitter.emit('add-flash', {
                            type: 'warning',
                            message: "@lang('superadmin::app.components.media.videos.not-allowed-error')"
                        });
        ...
        window.app.component('v-media-video-item', {
