...
<v-media-images
    ...
    :errors="errors"
>
    <x-superadmin::shimmer.image class="h-[110px] w-[110px] rounded" />
</v-media-images>
                    ...
                    >
                        <div class="flex flex-col items-center">
                            ...
                            <p class="grid text-center text-sm font-semibold text-blue-600">
                                @lang('superadmin::app.components.media.images.ai-add-image-btn')
                                
                                <span class="text-xs">
                                    @lang('superadmin::app.components.media.images.ai-btn-info')
                                </span>
                            </p>
                        </div>
                    </label>
                    ...
                    >
                        <div class="flex flex-col items-center">
                            ...
                            <p class="grid text-center text-sm font-semibold text-gray-600 dark:text-gray-300">
                                @lang('superadmin::app.components.media.images.add-image-btn')
                                
                                <span class="text-xs">
                                    @lang('superadmin::app.components.media.images.allowed-types')
                                </span>
                            </p>
                                ...
                                <x-slot:header>
                                    <template v-if="! ai.images.length">
                                        <p class="flex items-center gap-2.5 text-lg font-bold text-gray-800 dark:text-white">
                                            ...
                                            @lang('superadmin::app.components.media.images.ai-generation.title')
                                        </p>
                                    </template>
                                    ...
                                    <div v-show="! ai.images.length">
                                        ...
                                        <x-superadmin::form.control-group>
                                            <x-superadmin::form.control-group.label class="required">
                                                @lang('superadmin::app.components.media.images.ai-generation.prompt')
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.prompt"
                                                :label="trans('superadmin::app.components.media.images.ai-generation.prompt')"
                                            />
                                        ...
                                        <x-superadmin::form.control-group>
                                            <x-superadmin::form.control-group.label class="required">
                                                @lang('superadmin::app.components.media.images.ai-generation.model')
                                            </x-superadmin::form.control-group.label>
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.model"
                                                :label="trans('superadmin::app.components.media.images.ai-generation.model')"
                                            >
                                                <option value="dall-e-2">
                                                    @lang('superadmin::app.components.media.images.ai-generation.dall-e-2')
                                                </option>

                                                <option value="dall-e-3">
                                                    @lang('superadmin::app.components.media.images.ai-generation.dall-e-3')
                                                </option>
                                            </x-superadmin::form.control-group.control>

                                            <x-superadmin::form.control-group.error control-name="model" />
                                        </x-superadmin::form.control-group>

                                        <x-superadmin::form.control-group v-if="ai.model == 'dall-e-2'">
                                            <x-superadmin::form.control-group.label class="required">
                                                @lang('superadmin::app.components.media.images.ai-generation.number-of-images')
                                            </x-superadmin::form.control-group.label>
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.n"
                                                :label="trans('superadmin::app.components.media.images.ai-generation.number-of-images')"
                                            />

                                            <x-superadmin::form.control-group.error control-name="n" />
                                        </x-superadmin::form.control-group>

                                        <x-superadmin::form.control-group>
                                            <x-superadmin::form.control-group.label class="required">
                                                @lang('superadmin::app.components.media.images.ai-generation.size')
                                            </x-superadmin::form.control-group.label>
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.size"
                                                :label="trans('superadmin::app.components.media.images.ai-generation.size')"
                                            >
                                                <option value="1024x1024">
                                                    @lang('superadmin::app.components.media.images.ai-generation.1024x1024')
                                                </option>

                                                <option value="1024x1792">
                                                    @lang('superadmin::app.components.media.images.ai-generation.1024x1792')
                                                </option>

                                                <option value="1792x1024">
                                                    @lang('superadmin::app.components.media.images.ai-generation.1792x1024')
                                                </option>
                                            </x-superadmin::form.control-group.control>

                                            <x-superadmin::form.control-group.error control-name="size" />
                                        </x-superadmin::form.control-group>

                                        <x-superadmin::form.control-group v-if="ai.model == 'dall-e-3'">
                                            <x-superadmin::form.control-group.label class="required">
                                                @lang('superadmin::app.components.media.images.ai-generation.quality')
                                            </x-superadmin::form.control-group.label>
                                            ...
                                            <x-superadmin::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.quality"
                                                :label="trans('superadmin::app.components.media.images.ai-generation.quality')"
                                            >
                                                <option value="standard">
                                                    @lang('superadmin::app.components.media.images.ai-generation.standard')
                                                </option>

                                                <option value="hd">
                                                    @lang('superadmin::app.components.media.images.ai-generation.hd')
                                                </option>
                                            </x-superadmin::form.control-group.control>

                                            <x-superadmin::form.control-group.error control-name="quality" />
                                        </x-superadmin::form.control-group>
                                    </div>
                                        ...
                                        <template v-if="! ai.images.length">
                                            <button class="secondary-button">
                                                ...
                                                <template v-if="isLoading">
                                                    ...
                                                    @lang('superadmin::app.components.media.images.ai-generation.generating')
                                                </template>

                                                <template v-else>
                                                    <span class="icon-magic text-blue-600"></span>
                                                    
                                                    @lang('superadmin::app.components.media.images.ai-generation.generate')
                                                </template>
                                            </button>
                                        </template>
                                        ...
                                        <template v-else>
                                            <button class="secondary-button">
                                                ...
                                                <template v-if="isLoading">
                                                    ...
                                                    @lang('superadmin::app.components.media.images.ai-generation.regenerating')
                                                </template>

                                                <template v-else>
                                                    <span class="icon-magic text-2xl text-blue-600"></span>
                                                    
                                                    @lang('superadmin::app.components.media.images.ai-generation.regenerate')
                                                </template>
                                            </button>
        ...
        window.app.component('v-media-images', {
            ...
            data() {
                return {
                    ...
                    placeholders: [
                        {
                            label: "@lang('superadmin::app.components.media.images.placeholders.front')",
                            image: "{{ bagisto_asset('images/product-placeholders/front.svg') }}"
                        }, {
                            label: "@lang('superadmin::app.components.media.images.placeholders.next')",
                            image: "{{ bagisto_asset('images/product-placeholders/next-1.svg') }}"
                        }, {
                            label: "@lang('superadmin::app.components.media.images.placeholders.next')",
                            image: "{{ bagisto_asset('images/product-placeholders/next-2.svg') }}"
                        }, {
                            label: "@lang('superadmin::app.components.media.images.placeholders.zoom')",
                            image: "{{ bagisto_asset('images/product-placeholders/zoom.svg') }}"
                        }, {
                            label: "@lang('superadmin::app.components.media.images.placeholders.use-cases')",
                            image: "{{ bagisto_asset('images/product-placeholders/use-cases.svg') }}"
                        }, {
                            label: "@lang('superadmin::app.components.media.images.placeholders.size')",
            ...
            methods: {
                add() {
                    ...
                    if (! validFiles) {
                        this.$emitter.emit('add-flash', {
                            type: 'warning',
                            message: "@lang('superadmin::app.components.media.images.not-allowed-error')"
                        });
                ...
                generate(params, { setErrors }) {
                    ...
                    this.$axios.post("{{ route('superadmin.magic_ai.image') }}", params)
                        .then(response => {
