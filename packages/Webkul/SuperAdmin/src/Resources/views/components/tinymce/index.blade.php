    ...
    >
        ...
        >
            <form @submit="handleSubmit($event, generate)">
                ...
                <x-superadmin::modal ref="magicAIModal">
                    <!-- Modal Header -->
                    <x-slot:header>
                        <p class="flex items-center gap-2.5 text-lg font-bold text-gray-800 dark:text-white">
                            ...
                            @lang('superadmin::app.components.tinymce.ai-generation.title')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.components.tinymce.ai-generation.model')
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                v-model="ai.model"
                                :label="trans('superadmin::app.components.tinymce.ai-generation.model')"
                            >
                                <option value="gpt-4-turbo">
                                    @lang('superadmin::app.components.tinymce.ai-generation.gpt-4-turbo')
                                </option>

                                <option value="gpt-4o">
                                    @lang('superadmin::app.components.tinymce.ai-generation.gpt-4o')
                                </option>

                                <option value="gpt-4o-mini">
                                    @lang('superadmin::app.components.tinymce.ai-generation.gpt-4o-mini')
                                </option>

                                <option value="gemini-2.0-flash">
                                    @lang('superadmin::app.components.tinymce.ai-generation.gemini-2-0-flash')
                                </option>

                                <option value="deepseek-r1:8b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.deepseek-r1-8b')
                                </option>

                                <option value="llama3-8b-8192">
                                    @lang('superadmin::app.components.tinymce.ai-generation.llama-groq')
                                </option>

                                <option value="llama3.2:3b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.llama3-2-3b')
                                </option>

                                <option value="llama3.2:1b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.llama3-2-1b')
                                </option>

                                <option value="llama3.1:8b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.llama3-1-8b')
                                </option>

                                <option value="llama3:8b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.llama3-8b')
                                </option>

                                <option value="llava:7b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.llava-7b')
                                </option>

                                <option value="vicuna:13b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.vicuna-13b')
                                </option>

                                <option value="vicuna:7b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.vicuna-7b')
                                </option>

                                <option value="qwen2.5:14b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.qwen2-5-14b')
                                </option>

                                <option value="qwen2.5:7b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.qwen2-5-7b')
                                </option>

                                <option value="qwen2.5:3b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.qwen2-5-3b')
                                </option>

                                <option value="qwen2.5:1.5b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.qwen2-5-1-5b')
                                </option>

                                <option value="qwen2.5:0.5b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.qwen2-5-0-5b')
                                </option>

                                <option value="mistral:7b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.mistral-7b')
                                </option>

                                <option value="starling-lm:7b">
                                    @lang('superadmin::app.components.tinymce.ai-generation.starling-lm-7b')
                                </option>

                                <option value="phi3.5">
                                    @lang('superadmin::app.components.tinymce.ai-generation.phi3-5')
                                </option>

                                <option value="orca-mini">
                                    @lang('superadmin::app.components.tinymce.ai-generation.orca-mini')
                                </option>
                            </x-superadmin::form.control-group.control>

                            <x-superadmin::form.control-group.error control-name="model"></x-superadmin::form.control-group.error>
                        </x-superadmin::form.control-group>

                        <!-- Prompt -->
                        <x-superadmin::form.control-group>
                            <x-superadmin::form.control-group.label class="required">
                                @lang('superadmin::app.components.tinymce.ai-generation.prompt')
                            </x-superadmin::form.control-group.label>
                            ...
                            <x-superadmin::form.control-group.control
                                ...
                                rules="required"
                                v-model="ai.prompt"
                                :label="trans('superadmin::app.components.tinymce.ai-generation.prompt')"
                            />

                            <x-superadmin::form.control-group.error control-name="prompt" />
                        </x-superadmin::form.control-group>
                        ...
                        <div class="flex items-center gap-x-2.5">
                            ...
                            >
                                ...
                                <template v-if="isLoading">
                                    ...
                                    @lang('superadmin::app.components.tinymce.ai-generation.generating')
                                </template>

                                <template v-else>
                                    <span class="icon-magic text-2xl text-blue-600"></span>

                                    @lang('superadmin::app.components.tinymce.ai-generation.generate')
                                </template>
                            </button>
                        </div>

                        <!-- Generated Content -->
                        <x-superadmin::form.control-group class="mt-5">
                            <x-superadmin::form.control-group.label class="text-left">
                                @lang('superadmin::app.components.tinymce.ai-generation.generated-content')
                            </x-superadmin::form.control-group.label>
                            ...
                            <span class="text-xs text-gray-500">
                                @lang('superadmin::app.components.tinymce.ai-generation.generated-content-info')
                            </span>
                        </x-superadmin::form.control-group>
                    </x-slot>
                    ...
                    <x-slot:footer>
                        ...
                        <x-superadmin::button
                            ...
                            :title="trans('superadmin::app.components.media.images.ai-generation.apply')"
                            ::disabled="! ai.content"
                            @click="apply"
                        />
                    </x-slot>
        ...
        window.app.component('v-tinymce', {
            ...
            methods: {
                    ...
                    let tinyMCEHelper = {
                        initTinyMCE: function(extraConfiguration) {
                            ...
                            let config = {  
                                ...
                                uploadRoute: '{{ route('superadmin.tinymce.upload') }}',
                        ...
                        uploadImageHandler: function(config, blobInfo, resolve, reject, progress) {
                            ...
                            xhr.onload = function() {
                                ...
                                if (xhr.status === 403) {
                                    reject("@lang('superadmin::app.components.tinymce.errors.http-error')", {
                                        remove: true
                                    });
                                ...
                                if (! json || typeof json.location != 'string') {
                                    reject("@lang('superadmin::app.components.tinymce.errors.invalid-json')" + xhr.responseText);
                            ...
                            xhr.onerror = (()=>reject("@lang('superadmin::app.components.tinymce.errors.upload-failed')"));
                    ...
                    tinyMCEHelper.initTinyMCE({
                        ...
                        setup: editor => {
                            ...
                            editor.ui.registry.addButton('aibutton', {
                                text: "@lang('superadmin::app.components.tinymce.ai-btn-tile')",
                                icon: 'magic',
                ...
                generate(params, { resetForm, resetField, setErrors }) {
                    ...
                    this.$axios.post("{{ route('superadmin.magic_ai.content') }}", {
