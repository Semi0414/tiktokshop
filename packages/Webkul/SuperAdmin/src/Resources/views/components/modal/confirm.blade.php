...
@pushOnce('scripts')
    ...
    <script type="module">
        window.app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "@lang('superadmin::app.components.modal.confirm.title')",
                    message = "@lang('superadmin::app.components.modal.confirm.message')",
                    options = {
                        btnDisagree: "@lang('superadmin::app.components.modal.confirm.disagree-btn')",
                        btnAgree: "@lang('superadmin::app.components.modal.confirm.agree-btn')",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
