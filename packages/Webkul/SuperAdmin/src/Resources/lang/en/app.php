...
return [
    ...
    'email-management' => [
        ...
        'open-compose-btn' => 'Compose email',
        'compose-title' => 'Compose & send',
        'recipient-type' => 'Recipient',
        'type-custom' => 'Custom email address',
        'type-seller' => 'Seller',
        'type-customer' => 'Buyer / customer',
        'to-email-custom' => 'Email address',
        'hint-custom' => 'Required when “Custom email address” is selected.',
        'seller-id' => 'Seller ID',
        'customer-id' => 'Customer ID',
        'seller-select' => 'Seller',
        'customer-select' => 'Buyer / customer',
        'select-option-placeholder' => '— Select —',
        'select-list-truncated-sellers' => 'Only the first :count sellers (by ID) appear in this list. Use “Custom email address” if yours is missing.',
        'select-list-truncated-customers' => 'Only the first :count customers (by ID) appear in this list. Use “Custom email address” if yours is missing.',
        'subject' => 'Subject',
        'body-html' => 'HTML body',
        'send-btn' => 'Send email',
        'send-sending' => 'Sending…',
        'cancel-btn' => 'Cancel',
        'logs-title' => 'Sent mail log',
        'send-success-sync' => 'Your email has been sent successfully. If you do not see it within a few minutes, please check the recipient’s spam or junk folder.',
        'send-success-async' => 'Your email is being sent. The status in the log below will change to “Sent” when delivery has finished.',
        'log-deleted' => 'The log entry has been removed.',
        'send-failed' => 'Send failed: :message',
        'error-missing-email' => 'Enter a recipient email.',
        'error-invalid-seller' => 'Seller not found.',
        'error-invalid-customer' => 'Customer not found.',
        'migration-hint' => 'Run database migrations to enable the email log table.',
        'validation-summary' => 'Please fix the following:',
        'datagrid' => [
            'id' => 'ID',
            'to' => 'To',
            'recipient-type' => 'Recipient',
    ...
    'dashboard' => [
        'index' => [
            ...
            'apply-filters' => 'Apply',
            'catalog-snapshot' => 'Catalog & revenue',
            'platform-overview' => 'Platform overview',
            'platform-period' => 'Reporting period: :from – :to',
            'today-activity' => 'Today’s activity',
            'visitor-statistics' => 'Visitor Statistics',
            'todays-visitors' => 'Today’s visitors',
            'last-7-days' => 'Last 7 days',
            'last-30-days' => 'Last 30 days',
            'catalog-products-total' => 'Products in catalog',
            'order-statistics' => 'Order statistics',
            'top-10-selling' => 'TOP 10 products by orders',
            'sales-volume' => 'Orders',
            'price' => 'Price',
            ...
            'completed' => 'Completed',
            'verified' => 'Verified',
            'pending-orders-total' => 'Pending orders (amount)',
            'orders-count-column' => 'Orders',
    ...
    'sellers' => [
        'index' => [
            ...
            'login-message' => 'You are now logged in as seller :seller_name.',

            'datagrid' => [
                'login-as-seller' => 'Login as Seller',
                'delete-has-orders' => 'Cannot delete sellers that have orders assigned to them.',
        ...
        'edit' => [
            ...
            'save' => 'Save',
            'referral-code' => 'Referral code',
            'referral-code-hint' => 'Unique code buyers must enter at signup to link to this seller. You can change it anytime.',
            'max-visible' => 'Product limit (storefront & seller panel)',
            'max-visible-hint' => '0 = no products visible in seller preview / limited catalog. A positive number = first N products (by lowest product ID). If you leave the field empty, it is saved as 0 (not the full catalog).',
        ],

        'view' => [
            'title' => 'View Seller',
            'page-title' => 'View Seller',
            'visit-store' => 'Visit store',
            'visit-store-hint' => 'Opens the storefront with a secure preview link (seller ID is not shown in the URL).',
            'seller' => 'Seller',
            'seller-accordion' => 'Seller',
            'edit-btn' => 'Edit Seller',
            'email' => 'Email — :email',
            'role' => 'Role — :role',
            'seller-id' => 'Seller ID — :id',
            'wallet' => 'Wallet balance — :amount',
            'credit' => 'Credit score — :score%',
            'max-visible-value' => 'Max visible products — :value',
            'not-set' => 'Not set',
            'full-catalog' => 'All products (no limit)',
            'catalog-settings-link' => 'Catalog product limit',
            'delete-account-confirmation' => 'Are you sure you want to delete this seller account?',
            'welcome-email-btn' => 'Welcome email',
            'welcome-email-modal-title' => 'Send welcome email',
            'welcome-email-subject-label' => 'Subject',
            'welcome-email-message-label' => 'Message',
            'welcome-email-message-hint' => 'Plain text or HTML. Use HTML for custom layout; plain text is escaped and line breaks are preserved. The branded header and login button are always included.',
            'welcome-email-default-message' => "Thank you for joining our marketplace. Your seller account is ready.\n\nUse the button below to sign in to your dashboard, manage products, track orders, and grow your store.",
            'welcome-email-heading' => 'Welcome, :name!',
            'welcome-email-cta' => 'Seller login',
            'welcome-email-link-hint' => 'If the button does not work, copy and paste this link into your browser:',
            'welcome-email-footer' => 'This message was sent by TikStore. Please do not reply to this automated email.',
            'welcome-email-send' => 'Send email',
            'welcome-email-sending' => 'Sending…',
            'welcome-email-cancel' => 'Cancel',
            'welcome-email-default-subject' => 'Welcome to TikStore — your seller account is ready',
            'welcome-email-sent' => 'Welcome email sent successfully.',
            'welcome-email-failed' => 'Could not send email: :message',
            'notes' => [
        ...
        'orders' => [
            'index' => [
                'title' => 'Seller orders',
                'hint' => 'Orders assigned to a seller from the main order screen appear here. Completed status credits product total plus commission (from each line’s seller store settings) to the wallet; rejected refunds the seller’s purchase hold back to their wallet when applicable.',
                'bulk-select-hint' => 'Select orders with the checkboxes: the toolbar sticks to the top of the grid — open “Update status” and choose completed, rejected, or pending.',
                ...
                'approve-success' => 'Seller order approved. The seller can now see this order in their panel.',
                'reject-success' => 'Seller order rejected.',
                'wallet-revenue-desc' => 'Order #:increment — purchase :purchase + commission :commission (approved release).',
                'wallet-revenue-complete-desc' => 'Order #:increment: product total :purchase plus :commission commission (credited to your wallet).',
                'wallet-rejection-refund-desc' => 'Order #:increment: purchase hold refunded after rejection.',
                'invalid-state' => 'This action is only available while seller approval is pending.',
                'bulk-approve-result' => ':count order(s) approved for the seller.',
                'bulk-reject-result' => ':count order(s) rejected.',
                'bulk-complete-result' => ':count order(s) marked as completed.',
                'bulk-status-result' => ':count order(s) updated — :status.',
                'bulk-status-none-updated' => 'No orders could be updated for the selected action (they may already be in that state or are not eligible).',
                'bulk-status-select-placeholder' => 'Choose status…',
                'bulk-status-apply' => 'Apply',
                'bulk-status-open-modal-btn' => 'Bulk update selected',
                'bulk-status-modal-title' => 'Update selected seller orders',
                'bulk-status-modal-hint' => 'Totals below match the rows you checked on this page. Choose a status and apply.',
                'bulk-status-selection-heading' => 'Selected orders',
                'bulk-status-total-amount' => 'Total amount',
                'bulk-status-total-commission' => 'Total commission',
                'bulk-status-count' => ':count selected',
                'bulk-status-labels' => [
                    'completed' => 'completed (wallet credited where applicable)',
                    'rejected' => 'rejected (purchase refunded where applicable)',
                ...
                'datagrid' => [
                    'order-id' => 'Order ID',
                    'seller' => 'Seller',
                    'seller-name-column' => 'Seller name',
                    'buyer' => 'Buyer',
                    'seller-store' => 'Seller store',
                    'approval' => 'Seller action',
                    'customer' => 'Customer',
                    'grand-total' => 'Grand Total',
                    'date' => 'Date',
                    'view' => 'View',
                    'approve' => 'Approve for seller',
                    'reject' => 'Reject',
                    'bulk-approve' => 'Bulk approve for seller',
                    'bulk-reject' => 'Bulk reject',
                    'bulk-complete' => 'Mark selected as completed',
                    'bulk-update-status' => 'Update status',
                    'bulk-option-completed' => 'Completed — credit wallet',
                    'bulk-option-rejected' => 'Rejected — refund purchase hold',
                    'bulk-option-pending' => 'Pending — reopen for review',
                    'actions' => 'Actions',
                    'pending' => 'Pending',
                    'approved' => 'Approved',
                    'rejected' => 'Rejected',
    ...
    'sales' => [
        'orders' => [
            'landing' => [
                'badge' => 'Sales hub',
                'title' => 'Orders',
                'description' => 'Choose whether to open store orders placed by customers, or orders that are assigned to sellers.',
                'customer-orders' => 'Customer orders',
                'customer-orders-hint' => 'All storefront orders (same grid as before).',
                'seller-orders' => 'Seller orders',
                'seller-orders-hint' => 'Orders linked to a seller, with approval actions.',
                'open' => 'Open',
                'customer-cta' => 'Browse customer orders',
                'seller-cta' => 'Browse seller orders',
            ],
            ...
            'view' => [
                ...
                'assign-seller' => 'Assign to seller',
                'no-seller' => 'No seller (order stays super-admin only)',
                'save-seller' => 'Save assignment',
                'seller-approval-status' => 'Seller approval status',
                'seller-assigned-success' => 'Seller assignment updated.',
            ],
        ],
        ...
        'wallet-requests' => [
            'index' => [
                'title' => 'Seller wallet requests',
                'subtitle' => 'Review deposit and withdrawal requests: pending, approved, and rejected.',
                'filter-type-label' => 'Type',
                'filter-all' => 'All',
                'filter-deposit' => 'Deposits',
                'filter-withdraw' => 'Withdrawals',
                ...
                'modal-title-deposit' => 'Approve deposit',
                'modal-title-withdraw' => 'Approve withdrawal',
                'modal-amount-label' => 'Amount (USDT)',
                'modal-amount-help' => 'You can adjust the amount before confirming. The seller wallet will be updated.',
                'modal-amount-help-withdraw' => 'The seller wallet was already reduced when they submitted this request. Confirm the payout amount. If you pay less than requested, the difference is returned to their wallet; if more, the extra is taken from their wallet.',
                'modal-cancel' => 'Cancel',
                'modal-submit' => 'Confirm approval',
                'view-receipt' => 'View receipt',
                'action-view' => 'View',
                'view-modal-title' => 'Request details',
                'view-field-id' => 'Request ID',
                'view-field-amount' => 'Amount',
                'view-field-method' => 'Method code',
                'view-field-description' => 'Description',
                'view-field-created' => 'Requested at',
                'view-field-meta' => 'Details',
                'view-meta-bank-name' => 'Bank name',
                'view-meta-account' => 'Account number',
                'view-meta-destination' => 'Destination address',
                'view-meta-address-label' => 'Address label',
                'view-meta-network' => 'Network',
            ],
            'approved-success' => 'Request approved and wallet updated.',
            'rejected-success' => 'Request rejected.',
            'confirm-reject' => 'Reject this request? The seller wallet will not be changed.',
            'confirm-reject-deposit' => 'Reject this deposit request? No money will be added to the seller.',
            'confirm-reject-withdraw' => 'Reject this withdrawal? The withheld amount will be returned to the seller wallet.',
            'withdraw-rejection-remark' => 'Withdraw rejection — amount returned to wallet',
            'invalid-request' => 'This request cannot be processed.',
            'already-processed' => 'This request was already processed.',
            'insufficient-seller-balance' => 'The seller does not have enough wallet balance for this withdrawal amount.',
        ],
        ...
        'customers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'seller-referral-code' => 'Seller referral code',
            ...
            'view' => [
                ...
                'edit' => [
                    ...
                    'referral-code-hint' => 'Enter the seller’s unique referral code to attach this buyer to that seller’s store. Leave empty to remove.',
                    'referral-code-placeholder' => 'e.g. ABC12XYZ',
                    'referral-invalid' => 'No seller has this referral code.',
                    'edit-btn' => 'Edit',
                    'email' => 'Email',
                    'female' => 'Female',
                    'first-name' => 'First Name',
    ...
    'home-page-media' => [
        ...
        'description' => 'Upload images or short videos for the TikTok-style hero phone on the public landing page. Only items marked active are shown; order follows sort order (lowest first).',
        'add-title' => 'Add image or video',
        'saved-title' => 'Uploaded media',
        'file' => 'File',
        'file-hint' => 'Images: JPG, PNG, GIF, WebP. Video: MP4, WebM, MOV. Max 50 MB.',
        ...
        'edit' => 'Edit',
        'delete' => 'Delete',
        'delete-confirm' => 'Delete this media file?',
        'empty' => 'No media uploaded yet.',
        'created' => 'Media uploaded.',
        'updated' => 'Media updated.',
        'deleted' => 'Media removed.',
        'edit-title' => 'Edit home page media',
        'back' => 'Back to list',
        'replace-file' => 'Replace file (optional)',
        'replace-hint' => 'Leave file empty to keep the current image or video.',
    ],

    'settings' => [
        'crypto-addresses' => [
            'title' => 'Crypto payout addresses',
            'description' => 'Save wallet addresses, network IDs, or Binance identifiers for your records. This is storage only — it does not connect to exchanges.',
            ...
            'address' => 'Address or ID',
            'address-placeholder' => 'Wallet address, memo, or platform ID',
            'label-optional' => 'Label (optional)',
            'save' => 'Save address',
            'saved-title' => 'Saved addresses',
            'actions' => 'Actions',
            'empty' => 'No addresses saved yet.',
            'delete' => 'Delete',
            'delete-confirm' => 'Delete this saved address?',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'cms' => 'CMS',
                'collapse' => 'Collapse',
                'account-email' => 'Signed-in email',
                'referral-code' => 'Referral code',
                'my-shop' => 'My Shop',
                'admin-id' => 'ID :id',
                'visit-store' => 'Visit Store',
                'visit-tik-store' => 'Visit TikStore',
                'admin-referral-code' => 'Admin referral code',
                'referral-hint' => 'Use this code on seller join and buyer signup.',
                ...
                'groups' => 'Groups',
                'home-page-media' => 'Home page media',
                'imports' => 'Imports',
                'inventory-sources' => 'Inventory Sources',
                'invoices' => 'Invoices',
                'locales' => 'Locales',
                'marketing' => 'Marketing',
                'seller-programs' => 'Seller programs',
                'seller-tools' => 'Seller Tools',
                'store-upgrade' => 'Store Upgrade',
                ...
                'users' => 'Users',
                'crypto-payout-addresses' => 'Crypto addresses',
            ],
    ...
    'acl' => [
        ...
        'copy' => 'Copy',
        'create' => 'Create',
        'crypto-payout-addresses' => 'Crypto payout addresses',
        'currencies' => 'Currencies',
        'customers' => 'Customers',
        'dashboard' => 'Dashboard',
        'data-transfer' => 'Data Transfer',
