...
class Configurable extends AbstractType
{
    ...
    public function prepareForCart($data)
    {
        ...
        if (! ShopCheckoutInventory::shouldSkipInventoryChecks() && ! $childProduct->haveSufficientQuantity($data['quantity'])) {
    ...
    public function validateCartItem(CartItemModel $item): CartItemValidationResult
    {
        ...
        $basePrice = $item->child->getTypeInstance()->getFinalPrice();
