...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Application Super Admin URL
    |--------------------------------------------------------------------------
    |
    | This URL suffix is used to define the super admin url for example
    | super-admin/ or backend/super-admin/
    |
    */
    'super_admin_url' => env('APP_SUPER_ADMIN_URL', 'super-admin'),

    /*
    |--------------------------------------------------------------------------
    | Application installed (skip web installer)
    |--------------------------------------------------------------------------
    |
    | Set APP_INSTALLED=true on servers where you deploy this project with an
    | existing .env and database. The marker file storage/installed is not
    | committed (gitignored), so without this flag Bagisto may redirect to /install.
    |
    */
